...
e = function () {
  ...
  var n = {
    ...
    render: function (t, e) {
      ...
      for (
        ...
        l && (l.routerView && f++, l.keepAlive && i._inactive && (h = true))
        i = i.$parent
      }
      ...
      a.hook.init = function (t) {
        t.data.keepAlive &&
          t.componentInstance &&
          t.componentInstance !== d.instances[u] &&
  ...
  function s(t) {
    var e = {
      resolved: 'function' == typeof t ? t : B.extend(t),
      _route: t,
    }
          ...
          if (Array.isArray(r)) {
            ...
            return (
              r.forEach(function (t) {
                void 0 !== t &&
                  (null === t ? n.push(c(e)) : n.push(c(e) + '=' + c(t)))
              }),
              n.join('&')
            )
          }
  ...
  function j(t, e) {
    for (
      ...
      var u = r[0],
        s = r[1],
        p = r.index
      if (((a += t.slice(i, p)), (i = p + u.length), s)) {
        a += s[1]
      } else {
        var f = t[i],
          h = r[2],
  ...
  function S(t) {
    ...
    return function (r, n) {
      for (
        var o = '',
        i = r || {},
        a = (n || {}).pretty ? C : encodeURIComponent,
        c = 0;
        c < t.length;
        c++
      ) {
  ...
  function q(t, e, r) {
    x(e) || ((r = e || r), (e = []))
    for (
      var n = (r = r || {}).strict, o = false !== r.end, i = '', a = 0;
      a < t.length;
      a++
    ) {
      var c = t[a]
  ...
  function M(t, e, r) {
    ...
    try {
      ...
      return e.pathMatch && (e[0] = e.pathMatch), n(e, { pretty: true })
    } catch (t) {
      return ''
    } finally {
      delete e[0]
    ...
    F = {
      ...
      render: function (t) {
        var e = this,
          ...
          b = c.redirectedFrom ? h(null, V(c.redirectedFrom), null, n) : c
        var w = function (t) {
  ...
  function X(t, e) {
      ...
      if (s) {
        ...
        if (
          ...
          for (var h in r.params)
            !(h in c.params) && f.indexOf(h) > -1 && (c.params[h] = r.params[h])
        }
    ...
    function c(t, r) {
      ...
      if (
        ('string' == typeof o && (o = { path: o }), !o || 'object' != typeof o)
      ) {
        return u(null, r)
      }
      var c = o,
            ...
            ? a(
              {
                ...
                path: M(
                  (function (t, e) {
                    return b(t, e.parent ? e.parent.path : '/', true)
                  })(p, t),
                  d
                ),
                query: f,
  ...
  function nt() {
    ...
    window.history.replaceState({ key: tt() }, '', e)
  ...
  var ft,
    ht =
      K &&
      ((-1 === (ft = window.navigator.userAgent).indexOf('Android 2.') &&
        -1 === ft.indexOf('Android 4.0')) ||
        -1 === ft.indexOf('Mobile Safari') ||
        -1 !== ft.indexOf('Chrome') ||
        -1 !== ft.indexOf('Windows Phone')) &&
      window.history &&
  ...
  function lt(t, e) {
    ...
    try {
      e
        ? r.replaceState({ key: tt() }, '', t)
        : r.pushState({ key: et(G()) }, '', t)
    } catch (r) {
        ...
        if ('function' == typeof e && void 0 === e.cid) {
          ...
          var s,
            p = wt(function (t) {
              var r
                ; ((r = t).__esModule ||
                  (bt && 'Module' === r[Symbol.toStringTag])) &&
                  (t = t.default)
              n.components[u] = t
              --a <= 0 && o()
            }),
  ...
  kt.prototype.confirmTransition = function (r, n, o) {
    ...
    if (m(r, a) && r.matched.length === a.matched.length) {
      return this.ensureURL(), c(new xt(r))
    }
    var u = (function (t, e) {
      var r,
      ...
      h = [].concat(
        (function (t) {
          return Rt(t, 'beforeRouteLeave', Et, true)
        })(p),
    ...
    return (
      ...
      (e.prototype.push = function (t, e, r) {
        ...
        this.transitionTo(
          t,
          function (t) {
            lt(w(n.base + t.fullPath))
            ot(n.router, t, o, false)
            e && e(t)
          },
          r
        )
      ...
      t.call(this, e, r)
        ; (n &&
          (function (t) {
            var e = _t(t)
            if (!/^\/#/.test(e)) {
              return window.location.replace(w(t + '/#' + e)), true
            }
          })(this.base)) ||
          jt()
    }
  ...
  var Pt = (function (t) {
    ...
    Lt = function (t) {
      ...
      var e = t.mode || 'hash'
      switch (
      ((this.fallback = 'history' === e && !ht && false !== t.fallback),
    ...
    qt = { currentRoute: { configurable: true } }
  function Ut(t, e) {
    return (
      t.push(e),
      function () {
  ...
  return (
    ...
    (Lt.prototype.addRoutes = function (t) {
      ...
      this.history.current !== d &&
        this.history.transitionTo(this.history.getCurrentLocation())
    }),
    Object.defineProperties(Lt.prototype, qt),
    ...
    (Lt.version = '3.1.3'),
    K && window.Vue && window.Vue.use(Lt),
    Lt
  )
}
