; (function (e, t) {
    ...
    function H(e, n, r) {
        if (r === t && e.nodeType === 1) {
            var i = 'data-' + n.replace(/([A-Z])/g, '-$1').toLowerCase()
            r = e.getAttribute(i)
            if (typeof r == 'string') {
                try {
                    r =
    ...
    function Ot(e, t) {
        ...
        n === 'object'
            ...
            : n === 'input' && /^(?:checkbox|radio)$/.test(e.type)
    ...
    function _t(e) {
        ; /^(?:checkbox|radio)$/.test(e.type) && (e.defaultChecked = e.checked)
    }
    function Qt(e, t) {
        if (t in e) {
            return t
        ...
        var r,
            ...
            a = function () {
                ...
                return (
                    ...
                    i < 1 && o ? n : (u.resolveWith(e, [f]), false)
                )
            },
            f = u.promise({
                elem: e,
    ...
    var n,
        ...
        A = function () {
            i.addEventListener
                ? (i.removeEventListener('DOMContentLoaded', A, false), v.ready())
    ...
    v.extend({
        ...
        camelCase: function (e) {
            return e.replace(/^-ms-/, 'ms-').replace(/-([\da-z])/gi, L)
        },
    ...
    v.extend({
        Deferred: function (e) {
            var t = [
                ...
                i = {
                    s: v._data(n, 'olddisplay'),
                    className: e,
                    className: v.trim(s),
                    className: e ? v.trim(r) : '',
                    guid: n,
                    filters: (mt.prototype = i.pseudos),
                    setFilters: new mt(),
                    unit: r,
                    start: u,
                    end: s[1] ? u + (s[1] + 1) * n : n,
    ...
    v.support = (function () {
        ...
        t = {
            ...
            html5Clone:
                i.createElement('nav').cloneNode(true).outerHTML !== '<:nav></:nav>',
    ...
    v.extend({
        ...
        attr: function (e, n, r, i) {
            ...
            u &&
                ((n = n.toLowerCase()),
                    (o =
                        v.attrHooks[n] ||
                        (/^(?:autofocus|autoplay|async|checked|controls|defer|disabled|hidden|loop|multiple|open|readonly|required|scoped|selected)$/i.test(
                            n
                        )
                            ? F
                            : j)))
        ...
        attrHooks: {
            type: {
                set: function (e, t) {
                    if (/^(?:button|input)$/i.test(e.nodeName) && e.parentNode) {
            ...
            tabIndex: {
                get: function (e) {
                    ...
                    return n && n.specified
                        ? parseInt(n.value, 10)
                        : /^(?:button|input|object|select|textarea)$/i.test(e.nodeName) ||
                            (/^a(?:rea|)$/i.test(e.nodeName) && e.href)
                            ? 0
                            : t
                },
            },
    ...
    var Z = function (e) {
        return v.event.special.hover
            ? e
            : e.replace(/(?:^|\s)hover(\.\S+|)\b/, 'mouseenter$1 mouseleave$1')
    }
    v.event = {
        ...
        remove: function (e, t, n, r, i) {
            ...
            for (s = 0; s < t.length; s++) {
                ...
                f = o[2]
                if (!u) {
                    for (u in h) v.event.remove(e, u + t[s], n, r, true)
                    continue
                }
                p = v.event.special[u] || {}
                ...
                d.length === 0 &&
                    l !== d.length &&
                    ((!p.teardown || p.teardown.call(e, f, g.handle) === false) &&
                        v.removeEvent(e, u, g.handle),
                        delete h[u])
            }
            v.isEmptyObject(h) && (delete g.handle, v.removeData(e, 'events', true))
        },
        customEvent: {
            getData: true,
            setData: true,
        ...
        trigger: function (n, r, s, o) {
            if (!s || (s.nodeType !== 3 && s.nodeType !== 8)) {
                var u,
                    ...
                    y = n.type || n,
                    b = []
                if (/^(?:focusinfocus|focusoutblur)$/.test(y + v.event.triggered)) {
                    return
                }
                y.indexOf('!') >= 0 && ((y = y.slice(0, -1)), (a = true))
                ...
                if (!o && !p.noBubble && !v.isWindow(s)) {
                    g = p.delegateType || y
                    l = /^(?:focusinfocus|focusoutblur)$/.test(g + y) ? s : s.parentNode
                ...
                return (
                    ...
                    (!p._default || p._default.apply(s.ownerDocument, r) === false) &&
            ...
            for (r = 0; r < w.length && !n.isPropagationStopped(); r++) {
                ...
                for (
                    ...
                    if (
                        ...
                        n.data = c.data
                        n.handleObj = c
                        o = ((v.event.special[c.origType] || {}).handle || c.handler).apply(
                            a.elem,
                            g
                        )
                        o !== t &&
                            ((n.result = o),
                                o === false && (n.preventDefault(), n.stopPropagation()))
                    }
                }
            }
    ...
    v.support.changeBubbles ||
        (v.event.special.change = {
            setup: function () {
                if (/^(?:textarea|input|select)$/i.test(this.nodeName)) {
                    if (this.type === 'checkbox' || this.type === 'radio') {
                        ...
                        v.event.add(this, 'click._change', function (e) {
                            this._just_changed && !e.isTrigger && (this._just_changed = false)
                ...
                v.event.add(this, 'beforeactivate._change', function (e) {
                    var t = e.target
                        ; /^(?:textarea|input|select)$/i.test(t.nodeName) &&
            ...
            teardown: function () {
                return (
                    ...
                    !/^(?:textarea|input|select)$/i.test(this.nodeName)
                )
            },
        })
    v.support.focusinBubbles ||
        v.each(
            ...
            function (e, t) {
                ...
                v.event.special[t] = {
                    setup: function () {
                        n++ === 0 && i.addEventListener(e, r, true)
                    },
                    teardown: function () {
                        --n === 0 && i.removeEventListener(e, r, true)
                    },
                }
            }
        )
            ...
            var t = arguments,
                ...
                i = function (n) {
                    ...
                    return (
                        ...
                        n.preventDefault(),
                        t[i].apply(this, arguments) || false
                    )
                }
            while (r < t.length) {
                t[r++].guid = n
    ...
    v.each(
        ...
        function (e, t) {
            v.fn[t] = function (e, n) {
                ...
                ; /^key/.test(t) && (v.event.fixHooks[t] = v.event.keyHooks)
                ; /^(?:mouse|contextmenu)|click/.test(t) &&
            ...
            function vt(e, t, n, r, s) {
                ...
                if (!r && h.length === 1) {
                    ...
                    if (
                        ...
                        t = i.find.ID(f.matches[0].replace(/\\(?!\\)/g, ''), t, s)[0]
                        if (!t) {
                            return n
                        }
                    ...
                    for (o = J.POS.test(e) ? -1 : u.length - 1; o >= 0; o--) {
                        ...
                        if ((c = i.find[l])) {
                            if (
                                (r = c(
                                    f.matches[0].replace(/\\(?!\\)/g, ''),
                                    (/[\x20\t\r\n\f]*[+~]/.test(u[0].type) && t.parentNode) || t,
                                    s
                                ))
                            ) {
                                u.splice(o, 1)
            ...
            var n,
                ...
                C = function () {
                    var e = {
                        ...
                        id: d + 0,
                        innerHTML: "<a name='" + d + "'></a><div name='" + d + "'></div>",
                        i: !(n[i] = s[o]),
                        u: !(t[u] = s),
                        innerHTML: "<select><option selected=''></option></select>",
                        innerHTML: "<p test=''></p>",
                ...
                H =
                    ...
                    ')|[^:]|\\\\.)*|.*))\\)|)',
                B =
                    ':(even|odd|eq|gt|lt|nth|first|last)(?:\\([\\x20\\t\\r\\n\\f]*((?:-\\d)?\\d*)[\\x20\\t\\r\\n\\f]*\\)|)(?=[^-]|$)',
                j = new RegExp(
                    '^[\\x20\\t\\r\\n\\f]+|((?:^|[^\\\\])(?:\\\\.)*)[\\x20\\t\\r\\n\\f]+$',
                    'g'
                ),
                ...
                q = new RegExp(H),
                J = {
                    ID: new RegExp('^#((?:\\\\.|[-\\w]|[^\\x00-\\xa0])+)'),
                    CLASS: new RegExp('^\\.((?:\\\\.|[-\\w]|[^\\x00-\\xa0])+)'),
                    NAME: new RegExp(
                        '^\\[name=[\'"]?((?:\\\\.|[-\\w]|[^\\x00-\\xa0])+)[\'"]?\\]'
                    ),
                    TAG: new RegExp(
            ...
            u = nt.contains = y.contains
                ? function (e, t) {
                    var n = e.nodeType === 9 ? e.documentElement : e,
                        r = t && t.parentNode
                    return (
                        e === r || !!(r && r.nodeType === 1 && n.contains && n.contains(r))
                    )
                }
    ...
    var wt = new RegExp(
        '<(?:abbr|article|aside|audio|bdi|canvas|data|datalist|details|figcaption|figure|footer|header|hgroup|mark|meter|nav|output|progress|section|summary|time|video)[\\s/>]',
        'i'
    ),
        Nt = {
        ...
        html: function (e) {
            return v.access(
                ...
                function (e) {
                    ...
                    if (e === t) {
                        return n.nodeType === 1
                            ? n.innerHTML.replace(/ jQuery\d+="(?:null|\d+)"/g, '')
                            : t
                    }
                    if (
                        typeof e == 'string' &&
                        ...
                        (v.support.leadingWhitespace || !/^\s+/.test(e)) &&
                        !Nt[(/<([\w:]+)/.exec(e) || ['', ''])[1].toLowerCase()]
                    ) {
                        e = e.replace(
    ...
    v.buildFragment = function (e, n, r) {
        ...
        return (
            ...
            n === i &&
            a.charAt(0) === '<' &&
            !/<(?:script|object|embed|option|style)/i.test(a) &&
            (v.support.checkClone ||
                !/checked\s*(?:[^=]|=\s*.checked.)/i.test(a)) &&
            (v.support.html5Clone || !wt.test(a)) &&
            ((o = true), (s = v.fragments[a]), (u = s !== t)),
            s ||
    ...
    v.extend({
        ...
        clean: function (e, t, n, r) {
                ...
                if (typeof u == 'string') {
                    if (!/<|&#?\w+;/.test(u)) {
                        ...
                        !v.support.leadingWhitespace &&
                            /^\s+/.test(u) &&
                            c.insertBefore(t.createTextNode(/^\s+/.exec(u)[0]), c.firstChild)
                        u = c.childNodes
            ...
            if (n) {
                m = function (e) {
                    if (!e.type || /\/(java|ecma)script/i.test(e.type)) {
                        return r
        ...
        ; (function () {
            ...
            t = {}
            e.browser && ((t[e.browser] = true), (t.version = e.version))
            t.chrome ? (t.webkit = true) : t.webkit && (t.safari = true)
            v.browser = t
            v.sub = function () {
                function e(t, n) {
            ...
            get: function (e, n, r) {
                if (n) {
                    return e.offsetWidth === 0 &&
                        /^(none|table(?!-c[ea]).+)/.test(Dt(e, 'display'))
    ...
    v.each(
        ...
        function (e, t) {
            v.cssHooks[e + t] = {
                ...
                ; /^margin/.test(e) || (v.cssHooks[e + t].set = Zt)
        }
    )
    v.fn.extend({
        serialize: function () {
                ...
                .filter(function () {
                    return (
                        ...
                        (this.checked ||
                            ...
                            /^(?:color|date|datetime|datetime-local|email|hidden|month|number|password|range|search|tel|text|time|url|week)$/i.test(
                                this.type
                            ))
                    )
                })
    ...
    v.extend({
        ...
        ajaxSetup: function (e, t) {
            return (
                t ? Ln(e, v.ajaxSettings) : ((t = e), (e = v.ajaxSettings)), Ln(e, t), e
            )
        },
        ajaxSettings: {
            url: cn,
        ...
        ajax: function (e, n) {
            ...
            c.hasContent = !/^(?:GET|HEAD)$/.test(c.type)
            f && v.active++ === 0 && v.event.trigger('ajaxStart')
            if (!c.hasContent) {
                c.data &&
                    ((c.url += (/\?/.test(c.url) ? '&' : '?') + c.data), delete c.data)
                r = c.url
                if (c.cache === false) {
                    var N = v.now(),
                        C = c.url.replace(/([?&])_=[^&]*/, '$1_=' + N)
                    c.url =
                        C + (C === c.url ? (/\?/.test(c.url) ? '&' : '?') + '_=' + N : '')
                }
            }
            ; ((c.data && c.hasContent && c.contentType !== false) || n.contentType) &&
        ...
        if (n.dataTypes[0] === 'jsonp' || c || h) {
            return (
                ...
                c
                    ? (n.url = f.replace(/(=)\?(?=&|$)|\?\?/, '$1' + s))
                    : h
                        ? (n.data = a.replace(/(=)\?(?=&|$)|\?\?/, '$1' + s))
                        : l && (n.url += (/\?/.test(f) ? '&' : '?') + n.jsonp + '=' + s),
        ...
        _default: {
            get: function (e) {
                ...
                return e.elem[e.prop] == null ||
                    ...
                    ? ((t = v.css(e.elem, e.prop, false, '')), !t || t === 'auto' ? 0 : t)
                    : e.elem[e.prop]
            },
            set: function (e) {
                v.fx.step[e.prop]
            ...
            return (
                ...
                this.each(function () {
                    ...
                    if (n) {
                        ...
                        for (n in o) o[n] && o[n].stop && /queueHooks$/.test(n) && i(o[n])
                    }
                    for (n = s.length; n--;) {
                        s[n].elem === this &&
                            (e == null || s[n].queue === e) &&
                            (s[n].anim.stop(r), (t = false), s.splice(n, 1))
                    }
    ...
    v.offset = {
        ...
        setOffset: function (e, t, n) {
            ...
            var i = v(e),
                ...
                u = v.css(e, 'left'),
                a =
                    (r === 'absolute' || r === 'fixed') && v.inArray('auto', [o, u]) > -1,
                f = { n: r },
                l = {},
                c,
                h
