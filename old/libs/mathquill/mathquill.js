/**
 * MathQuillTal v0.10.1               http://mathquill.com
...
;(function () {
  ...
  /**
   * MathQuillTal virtual-DOM tree-node abstract base class
   */
  var Node = P(function (_) {
    ...
    _.toString = function () {
      return '{{ MathQuillTal Node #' + this.id + ' }}'
    }
...
JS environment could actually contain many instances. */
  ...
  /*********************************************
   * Controller for a MathQuillTal instance,
  ...
  /*********************************************************
   * The publicly exposed MathQuillTal API.
   ********************************************************/
  ...
  function insistOnInterVer () {
    if (window.console)
      console.warn(
        'You are using the MathQuillTal API without specifying an interface version, ' +
          'which will fail in v1.0.0. Easiest fix is to do the following before ' +
          'doing anything else:\n' +
          '\n' +
          '    MathQuillTal = MathQuillTal.getInterface(1);\n' +
          '    // now MathQuillTal.MathField() works like it used to\n' +
          '\n' +
  ...
  function MathQuillTal (el) {
    insistOnInterVer()
    return MQ1(el)
  }
  MathQuillTal.prototype = Progenote.p
  MathQuillTal.interfaceVersion = function (v) {
    // shim for #459-era interface versioning (ended with #495)
    if (v !== 1) throw 'Only interface version 1 supported. You specified: ' + v
    insistOnInterVer = function () {
      if (window.console)
        console.warn(
          'You called MathQuillTal.interfaceVersion(1); to specify the interface ' +
  ...
  MathQuillTal.getInterface = getInterface
  ...
  function getInterface (v) {
    ...
    /**
     * Export the API functions that MathQuillTal-ify an HTML element into API objects
     * of each class. If the element had already been MathQuillTal-ified but into a
  ...
  MathQuillTal.noConflict = function () {
    window.MathQuillTal = origMathQuill
    return MathQuillTal
  }
  var origMathQuill = window.MathQuillTal
  window.MathQuillTal = MathQuillTal
  ...
  Controller.open(function (_) {
    ...
    _.delegateMouseEvents = function () {
      ...
      this.container.bind('mousedown.mathquill', function (e) {
        ...
        // outside rootjQ, the MathQuillTal node corresponding to the target (if any)
  ...
  /*********************************************
   * Manage the MathQuillTal instance's textarea
  ...
  var MathCommand = P(MathElement, function (_, super_) {
    ...
    // and selection of the MathQuillTal tree, these all take in a direction and
    // the cursor
  ...
  */
  ...
  LatexCmds['.'] = bind(VanillaSymbol, '\\.', '.')  // 新增‘.’的设置，使分式中不能输入该字符
  //spacing
...
*/
  ...
  // MathQuillTal auto-unitalicizes some operator names not in that set, like 'hcf'
  // and 'arsinh', which must be exported as \operatorname{hcf} and
  // \operatorname{arsinh}. Note: over/under line/arrow \lim variants like
  // \varlimsup are not supported
  var AutoOpNames = (Options.p.autoOperatorNames = { _maxLength: 9 }) // the set
  // of operator names that MathQuillTal auto-unitalicizes by default; overridable
  ...
  ;(function () {
    ...
    // compat with some of the nonstandard LaTeX exported by MathQuillTal
  ...
  // and they get copy-pasted into MathQuillTal.
  //
  ...
  LatexCmds['\u222b'] = LatexCmds['int'] = LatexCmds.integral = P(
    SummationNotation,
    function (_, super_) {
      _.init = function () {
        var htmlTemplate =
  ...
  var Fraction = (LatexCmds.frac = LatexCmds.dfrac = LatexCmds.cfrac = LatexCmds.fraction = P(
    ...
    function (_, super_) {
      ...
      _.htmlTemplate =
        ...
        '<hr class="mq-line"></hr>' +
        '<div class="mq-denominator"><span class="content">&1</span></div>' +
        '<span style="display:inline-block;width:0">&#8203;</span>' +
        '</span>'
      _.textTemplate = ['(', ')/(', ')']
      _.finalizeTree = function () {
  ...
  // From MathQuillTal's perspective, it's a Symbol, it can be
  ...
  for (var key in MQ1)
    (function (key, val) {
      if (typeof val === 'function') {
        MathQuillTal[key] = function () {
          insistOnInterVer()
          return val.apply(this, arguments)
        }
        MathQuillTal[key].prototype = val.prototype
      } else MathQuillTal[key] = val
    })(key, MQ1[key])
})()
