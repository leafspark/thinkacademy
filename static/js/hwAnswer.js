;(window.webpackJsonp = window.webpackJsonp || []).push([
  ['chunk-ea59be38'],
  {
    ...
    '1d5b': function (e, t, a) {
      e.exports = a.p + 'static/img/no-answer-banner.adf5eac8.png'
    },
    '22de': function (e, t, a) {
      'use strict'
      a.d(t, 'd', function () {
      ...
      var n = a('c7eb'),
        ...
        o = (function () {
          var e = Object(s.a)(
            Object(n.a)().mark(function e(t, a, s) {
              var o, c, u
              ...
              return Object(n.a)().wrap(function (e) {
                while (1) {
                  switch ((e.prev = e.next)) {
                    case 0:
                      return (
                        (s = '/homework-api/student/neirongyun/jumpUrl'),
                        (e.next = 3),
                        o(t, s, a)
                      )
                    case 3:
              ...
              return Object(n.a)().wrap(function (e) {
                while (1) {
                  switch ((e.prev = e.next)) {
                    case 0:
                      return (
                        (s = '/homework-api/student/paperDetail'),
                        (e.next = 3),
                        o(t, s, a)
                      )
                    case 3:
              ...
              return Object(n.a)().wrap(function (e) {
                while (1) {
                  switch ((e.prev = e.next)) {
                    case 0:
                      return (
                        (s = '/homework-api/student/paperOverview'),
                        (e.next = 3),
                        o(t, s, a)
                      )
                    case 3:
    ...
    8994: function (e, t, a) {
      ...
      var n = function () {
                      ...
                      : [
                          t('section', { staticClass: 'section-container' }, [
                            t('div', { staticClass: 'preview-class' }, [
                              6 == e.courseDetailParams.status
                                ? t('div', { staticClass: 'deadline-banner' }, [
                                    t('img', {
                                      attrs: {
                                        src: a('1d5b'),
                                        alt: '',
                                    ...
                                    t('span', [
                                      e._v(
                                        e._s(
                                          e.$t(
                                            'courses.previewQuestion.deadlineBannerTips'
                                          )
                                        ) + ' '
                                      ),
                                    ]),
                              ...
                              t('div', { staticClass: 'syllabus-card' }, [
                                t('div', { staticClass: 'syllabus-info' }, [
                                  t('div', { staticClass: 'title' }, [
                                    t('span'),
                                    t('span', [
                                      e._v(e._s(e.previewData.title || '')),
                                    ]),
                                  ]),
                                ]),
                              ]),
                              t('div', { staticClass: 'time-card' }, [
                                t('div', { staticClass: 'left' }, [
                                    ...
                                    t('span', { staticClass: 'btn' }, [
                                      e._v(
                                        ' ' +
                                          e._s(
                                            e.$t(
                                              'courses.previewQuestion.deadlineName'
                                            )
                                          )
                                      ),
                                    ]),
                                  ...
                                  t('span', { staticClass: 'time' }, [
                                    e._v(e._s(e.previewData.deadline || '')),
                                  ]),
                                ]),
                                ...
                                t('div', { staticClass: 'right' }, [
                                  ...
                                  t('span', { staticClass: 'time' }, [
                                    e._v(e._s(e.previewData.duration || '')),
                                  ]),
                                ]),
                              ]),
                ...
                [
                  t('div', { staticClass: 'content' }, [
                    t('span', { staticClass: 'title' }, [
                      e._v(
                        ' ' +
                          e._s(e.$t('courses.previewQuestion.confirmTitle')) +
                          ' '
                      ),
                    ]),
                    t('span', { staticClass: 'sub-title' }, [
                      e._v(
                        ' ' +
                          e._s(
                            e.$t('courses.previewQuestion.confirmSubtitle', {
                              duration: e.previewData.duration,
                            })
                          ) +
                          ' '
                      ),
                    ...
                    t('div', { staticClass: 'btn' }, [
                      t(
                        ...
                        {
                          staticClass: 'no',
                          on: { click: e.handleCancelPreview },
                        },
                        [e._v(' ' + e._s(e.$t('common.no')) + ' ')]
                      ),
                      t(
                        'div',
                        {
                          staticClass: 'yes',
                          on: { click: e.handleJumpPreview },
                        },
                        [e._v(' ' + e._s(e.$t('common.yes')) + ' ')]
                      ),
                    ]),
                  ]),
                ]
        ...
        u = {
          ...
          components: { Loading: c.a },
          computed: {
            btnDesc: function () {
              console.info(
                '对象函数 btnDesc,filePath:renderer/views/PreviewQuestion.vue'
              )
              var e = this.courseDetailParams.status
              return 4 == e || 5 == e || 6 == e
                ? (console.info(
                    'if(status == 4 || status == 5 || status == 6)为true触发return,path: /renderer/views/PreviewQuestion.vue'
                  ),
                  this.$t('courses.previewQuestion.solutions'))
                : (console.info(
                    'if(status == 4 || status == 5 || status == 6)为false,触发return,path: /renderer/views/PreviewQuestion.vue'
                  ),
                  this.$t('courses.previewQuestion.start'))
            },
          },
          methods: {
            updateHeaderAttr: function () {
              console.info(
                '对象函数 updateHeaderAttr,filePath:renderer/views/PreviewQuestion.vue'
              )
              var e = '/courses-detail?classId='
                .concat(this.courseDetailParams.classId, '&planId=')
                .concat(
                  this.courseDetailParams.planId,
                  '&isNeedBackToCurrentTap=true'
                )
                    ...
                    while (1) {
                      switch ((t.prev = t.next)) {
                        case 0:
                          return (
                            console.info(
                              '对象函数 getPreviewData,filePath:renderer/views/PreviewQuestion.vue'
                            ),
                            (e.loading = true),
                            (t.next = 4),
                            Object(o.a)(e, {
                              planId: parseInt(e.courseDetailParams.lessonId),
                              paperId: e.courseDetailParams.homeworkId,
                            })
                          )
                        case 4:
                          if (
                          ...
                          return (
                            console.info(
                              'if(!res || !res.code == 0)为true触发return,path: /renderer/views/PreviewQuestion.vue'
                            ),
                            (e.isError = true),
                            t.abrupt('return')
                          )
                        case 10:
                          ;(e.loading = false), (e.previewData = a.data)
                        case 12:
                        case 'end':
                          return t.stop()
                      }
            ...
            showModal: function (e) {
              console.info(
                ...
                e,
                'filePath:renderer/views/PreviewQuestion.vue'
              )
              4 == e || 5 == e || 6 == e
                ? this.handleJumpPreview()
                : (this.visible = true)
            },
            handleCancelPreview: function () {
              console.info(
                '对象函数 handleCancelPreview,filePath:renderer/views/PreviewQuestion.vue'
              )
              this.visible = false
            },
            handleJumpPreview: function () {
              var e = this
              console.info(
                '对象函数 handleJumpPreview,filePath:renderer/views/PreviewQuestion.vue'
              )
              var t = window.JSON.parse(
                window.localStorage.getItem('paperJumpUrlParam')
              )
              Object(o.d)(this, t).then(function (t) {
                if (
                  (console.info(
                    '箭头函数 queryHomeWorkUrl的then(res)',
                    t,
                    'filePath:renderer/views/PreviewQuestion.vue'
                  ),
                  t)
                  ...
                  var a = t.data
                  if (a) {
                    e.backUrlNext = e.$route.fullPath
                    window.localStorage.setItem('previewUrl', a)
                    window.localStorage.setItem(
                      'jumpPreviewQuestionUrl',
                      e.backUrlNext
                    )
                    var n = '/previewQuestionH5?previewUrl='
                      .concat(encodeURIComponent(a), '&backUrl=')
                      .concat(e.backUrlNext)
                    e.$router.push({ path: n })
                  }
                }
              })
            },
          ...
          mounted: function () {
            ...
            var t = window.localStorage.getItem('previewStatus')
            t && (this.courseDetailParams.status = t)
            this.getPreviewData()
            this.$bus.$on('reload', function () {
              console.info(
                '箭头函数 监听 reload,filePath:renderer/views/PreviewQuestion.vue'
              )
              e.getPreviewData()
            })
          ...
          destroyed: function () {
            console.info(
              '对象函数 destroyed,filePath:renderer/views/PreviewQuestion.vue'
            )
            this.$bus.$off('reload')
          },
        },
        l = u,
        d = (a('0194'), a('2877')),
        p = Object(d.a)(l, n, s, false, null, '29cd6512', null)
      t.default = p.exports
    },
    9204: function (e, t, a) {},
    bd12: function (e, t, a) {
      ...
      var n = function () {
        ...
        i = r,
        o = (a('f761'), a('2877')),
        c = Object(o.a)(i, n, s, false, null, '92d727e8', null)
      t.a = c.exports
    },
    c63e: function (e, t) {
      e.exports =
