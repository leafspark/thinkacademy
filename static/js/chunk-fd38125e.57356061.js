    ...
    '02615': function (e, t, n) {
      ...
      e.exports = function (e, t) {
        ...
        function p() {
          ...
          for (var t = c.offset, o = 0; o < n.length; o++) {
            var i = t,
              u = new r(e)
        ...
        function h(t) {
          ...
          c.loadFromBinary(e.slice(l, s))
          c.commentLength && (i = e.slice(u + a.Constants.ENDHDR))
          t && p()
        }
        function m() {
          n.length > 1 &&
        ...
        return (
          e ? h(u.readEntries) : (l = true),
          {
            ...
            set comment(e) {
              i = a.toBuffer(e)
              c.commentLength = i.length
            },
            getEntryCount: function () {
              return l ? n.length : c.diskEntries
            },
            forEach: function (e) {
              l ? n.forEach(e) : f(e)
            },
