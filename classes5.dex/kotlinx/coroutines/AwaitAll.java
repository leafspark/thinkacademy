...
final class AwaitAll<T> {
    ...
    private final class AwaitAllNode extends JobNode {
        ...
        public void invoke(Throwable th) {
            ...
            if (AwaitAll.notCompletedCount$FU.decrementAndGet(AwaitAll.this) == 0) {
                ...
                continuation2.resumeWith(Result.m320constructorimpl((List) arrayList));
            }
        }
    }
    ...
    public final Object await(Continuation<? super List<? extends T>> continuation) {
        ...
        for (int i = 0; i < length; i++) {
            ...
            deferred.start();
            Function1 awaitAllNode = new AwaitAllNode(cancellableContinuation);
            awaitAllNode.setHandle(deferred.invokeOnCompletion((CompletionHandlerBase) awaitAllNode));
            Unit unit = Unit.INSTANCE;
            awaitAllNodeArr[i] = awaitAllNode;
        }
        Function1 disposeHandlersOnCancel = new DisposeHandlersOnCancel(awaitAllNodeArr);
        ...
        if (cancellableContinuation.isCompleted()) {
            ...
            cancellableContinuation.invokeOnCancellation((CancelHandlerBase) disposeHandlersOnCancel);
        }
