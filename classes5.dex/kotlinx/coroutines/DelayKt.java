...
public final class DelayKt {
    ...
    public static final Object m861delayVtjQ1oo(long j, Continuation<? super Unit> continuation) {
        Object delay = delay(m862toDelayMillisLRDsOJo(j), continuation);
        return delay == IntrinsicsKt.getCOROUTINE_SUSPENDED() ? delay : Unit.INSTANCE;
    }

    public static final Delay getDelay(CoroutineContext coroutineContext) {
        Delay delay = coroutineContext.get(ContinuationInterceptor.Key);
        Delay delay2 = delay instanceof Delay ? delay : null;
        return delay2 == null ? DefaultExecutorKt.getDefaultDelay() : delay2;
    }

    /* renamed from: toDelayMillis-LRDsOJo  reason: not valid java name */
    public static final long m862toDelayMillisLRDsOJo(long j) {
        if (Duration.m696compareToLRDsOJo(j, Duration.Companion.m799getZEROUwyO8pc()) > 0) {
            return RangesKt.coerceAtLeast(Duration.m715getInWholeMillisecondsimpl(j), 1);
        }
        return 0;
    }
}
