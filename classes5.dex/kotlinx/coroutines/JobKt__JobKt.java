...
final /* synthetic */ class JobKt__JobKt {
    ...
    public static final DisposableHandle disposeOnCompletion(Job job, DisposableHandle disposableHandle) {
        return job.invokeOnCompletion((CompletionHandlerBase) new DisposeOnCompletion(disposableHandle));
    }
    ...
    public static final /* synthetic */ boolean cancel(CoroutineContext coroutineContext, Throwable th) {
        JobSupport jobSupport = coroutineContext.get(Job.Key);
        JobSupport jobSupport2 = jobSupport instanceof JobSupport ? jobSupport : null;
        if (jobSupport2 == null) {
            return false;
        }
        jobSupport2.cancelInternal(orCancellation$JobKt__JobKt(th, jobSupport2));
        return true;
    }
