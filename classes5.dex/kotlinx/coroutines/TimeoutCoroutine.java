...
final class TimeoutCoroutine<U, T extends U> extends ScopeCoroutine<T> implements Runnable {
    ...
    public void run() {
        cancelCoroutine(TimeoutKt.TimeoutCancellationException(this.time, (Job) this));
    }

    public String nameString$kotlinx_coroutines_core() {
        return TimeoutCoroutine.super.nameString$kotlinx_coroutines_core() + "(timeMillis=" + this.time + ')';
    }
}
