...
public class JobSupport implements Job, ChildJob, ParentJob, SelectClause0 {
    ...
    private final void notifyCancelling(NodeList nodeList, Throwable th) {
        onCancelling(th);
        LockFreeLinkedListHead lockFreeLinkedListHead = (LockFreeLinkedListHead) nodeList;
        CompletionHandlerException completionHandlerException = null;
        for (JobNode jobNode = (LockFreeLinkedListNode) lockFreeLinkedListHead.getNext(); !Intrinsics.areEqual(jobNode, lockFreeLinkedListHead); jobNode = jobNode.getNextNode()) {
            if (jobNode instanceof JobCancellingNode) {
                ...
                try {
                    ...
                    completionHandlerException = new CompletionHandlerException("Exception in completion handler " + jobNode2 + " for " + this, th2);
    ...
    private final /* synthetic */ <T extends JobNode> void notifyHandlers(NodeList nodeList, Throwable th) {
        ...
        for (JobNode jobNode = (LockFreeLinkedListNode) lockFreeLinkedListHead.getNext(); !Intrinsics.areEqual(jobNode, lockFreeLinkedListHead); jobNode = jobNode.getNextNode()) {
            ...
            if (jobNode instanceof LockFreeLinkedListNode) {
                JobNode jobNode2 = jobNode;
                try {
                    jobNode2.invoke(th);
                } catch (Throwable th2) {
                    ...
                    CompletionHandlerException completionHandlerException2 = new CompletionHandlerException("Exception in completion handler " + jobNode2 + " for " + this, th2);
                    Unit unit = Unit.INSTANCE;
    ...
    private final boolean addLastAtomic(Object obj, NodeList nodeList, JobNode jobNode) {
        int tryCondAddNext;
        LockFreeLinkedListNode lockFreeLinkedListNode = (LockFreeLinkedListNode) nodeList;
        LockFreeLinkedListNode lockFreeLinkedListNode2 = (LockFreeLinkedListNode) jobNode;
    ...
    private final ChildHandleNode firstChild(Incomplete incomplete) {
        ...
        LockFreeLinkedListNode list = incomplete.getList();
        if (list != null) {
    ...
    private final boolean tryWaitForChild(Finishing finishing, ChildHandleNode childHandleNode, Object obj) {
        while (Job.DefaultImpls.invokeOnCompletion$default(childHandleNode.childJob, false, false, (CompletionHandlerBase) new ChildCompletion(this, finishing, childHandleNode, obj), 1, (Object) null) == NonDisposableHandle.INSTANCE) {
    ...
    public final void continueCompleting(Finishing finishing, ChildHandleNode childHandleNode, Object obj) {
        ...
        ChildHandleNode nextChild = nextChild((LockFreeLinkedListNode) childHandleNode);
    ...
    public final ChildHandle attachChild(ChildJob childJob) {
        return (ChildHandle) Job.DefaultImpls.invokeOnCompletion$default(this, true, false, (CompletionHandlerBase) new ChildHandleNode(childJob), 2, (Object) null);
    }
    ...
    public final Object awaitSuspend(Continuation<Object> continuation) {
        ...
        CancellableContinuationKt.disposeOnCancellation(awaitContinuation, invokeOnCompletion((CompletionHandlerBase) new ResumeAwaitOnCompletion(awaitContinuation)));
    ...
    public final Object joinSuspend(Continuation<? super Unit> continuation) {
        ...
        CancellableContinuationKt.disposeOnCancellation(continuation2, invokeOnCompletion((CompletionHandlerBase) new ResumeOnCompletion(continuation2)));
    ...
    public final <R> void registerSelectClause0(SelectInstance<? super R> selectInstance, Function1<? super Continuation<? super R>, ? extends Object> function1) {
        ...
        selectInstance.disposeOnSelect(invokeOnCompletion((CompletionHandlerBase) new SelectJoinOnCompletion(selectInstance, function1)));
    }
    ...
    public final <T, R> void registerSelectClause1Internal$kotlinx_coroutines_core(SelectInstance<? super R> selectInstance, Function2<? super T, ? super Continuation<? super R>, ? extends Object> function2) {
        ...
        selectInstance.disposeOnSelect(invokeOnCompletion((CompletionHandlerBase) new SelectAwaitOnCompletion(selectInstance, function2)));
    }
}
