...
public final class YieldKt {
    public static final Object yield(Continuation<? super Unit> continuation) {
        ...
        DispatchedContinuation dispatchedContinuation = intercepted instanceof DispatchedContinuation ? intercepted : null;
        if (dispatchedContinuation == null) {
            ...
            if (dispatchedContinuation.dispatcher.isDispatchNeeded(context)) {
                ...
                CoroutineContext yieldContext = new YieldContext();
