...
public final class UShortArrayKt {
    ...
    private static final short[] m666ushortArrayOfrL5Bavg(short... sArr) {
    ...
    private static final short[] UShortArray(int i, Function1<? super Integer, UShort> function1) {
        ...
        for (int i2 = 0; i2 < i; i2++) {
            sArr[i2] = ((UShort) function1.invoke(Integer.valueOf(i2))).m647unboximpl();
        }
        return UShortArray.m650constructorimpl(sArr);
    }
}
