...
final class AdjustedTimeMark implements TimeMark {
    ...
    public TimeMark m691minusLRDsOJo(long j) {
        return TimeMark.DefaultImpls.m835minusLRDsOJo(this, j);
    }

    /* renamed from: getAdjustment-UwyO8pc  reason: not valid java name */
    public final long m690getAdjustmentUwyO8pc() {
    ...
    public long m689elapsedNowUwyO8pc() {
        return Duration.m732minusLRDsOJo(this.mark.m832elapsedNowUwyO8pc(), this.adjustment);
    }

    /* renamed from: plus-LRDsOJo  reason: not valid java name */
    public TimeMark m692plusLRDsOJo(long j) {
        return new AdjustedTimeMark(this.mark, Duration.m733plusLRDsOJo(this.adjustment, j), (DefaultConstructorMarker) null);
    }
}
