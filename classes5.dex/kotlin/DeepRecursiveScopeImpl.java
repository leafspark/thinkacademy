...
final class DeepRecursiveScopeImpl<T, R> extends DeepRecursiveScope<T, R> implements Continuation<R> {
    ...
    public Continuation<Object> cont = ((Continuation) this);
    /* access modifiers changed from: private */
    ...
    public <U, S> Object callRecursive(DeepRecursiveFunction<U, S> deepRecursiveFunction, U u, Continuation<? super S> continuation) {
        Function3<? super DeepRecursiveScope<?, ?>, Object, ? super Continuation<Object>, ? extends Object> block$kotlin_stdlib = deepRecursiveFunction.getBlock$kotlin_stdlib();
    ...
    private final Continuation<Object> crossFunctionCompletion(Function3<? super DeepRecursiveScope<?, ?>, Object, ? super Continuation<Object>, ? extends Object> function3, Continuation<Object> continuation) {
        return (Continuation) new DeepRecursiveScopeImpl$crossFunctionCompletion$$inlined$Continuation$1(EmptyCoroutineContext.INSTANCE, this, function3, continuation);
    }
    ...
    public final R runCallLoop() {
        while (true) {
            ...
            if (continuation == null) {
                ...
                return r;
            } else if (Result.m322equalsimpl0(DeepRecursiveKt.UNDEFINED_RESULT, r)) {
                try {
                    ...
                    if (invoke != IntrinsicsKt.getCOROUTINE_SUSPENDED()) {
                        ...
                        continuation.resumeWith(Result.m320constructorimpl(invoke));
                    }
                } catch (Throwable th) {
