...
public final class MatcherMatchResult$groupValues$1 extends AbstractList<String> {
    ...
    public /* bridge */ boolean contains(String str) {
        return MatcherMatchResult$groupValues$1.super.contains(str);
    }
    ...
    public /* bridge */ int indexOf(String str) {
        return MatcherMatchResult$groupValues$1.super.indexOf(str);
    }
    ...
    public /* bridge */ int lastIndexOf(String str) {
        return MatcherMatchResult$groupValues$1.super.lastIndexOf(str);
    }
