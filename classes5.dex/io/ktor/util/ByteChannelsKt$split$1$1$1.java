...
final class ByteChannelsKt$split$1$1$1 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
    ...
    public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
        return (Continuation) new ByteChannelsKt$split$1$1$1(this.$first, this.$chunk, continuation);
    }
    ...
    public final Object invokeSuspend(Object obj) {
        ...
        if (i == 0) {
            ...
            this.label = 1;
            if (this.$first.writePacket(this.$chunk.copy(), (Continuation) this) == coroutine_suspended) {
