...
public final class ServerResponseException extends ResponseException {
    ...
    public ServerResponseException(HttpResponse httpResponse, String str) {
        ...
        this.message = "Server error(" + httpResponse.getCall().getRequest().getMethod().getValue() + ' ' + httpResponse.getCall().getRequest().getUrl() + ": " + httpResponse.getStatus() + ". Text: \"" + str + Typography.quote;
    }
