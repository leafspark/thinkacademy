...
public final class FormDslKt$formData$1$part$3$invoke$$inlined$ByteReadPacket$default$1 extends Lambda implements Function1<ByteBuffer, Unit> {
    final /* synthetic */ byte[] $array;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    public FormDslKt$formData$1$part$3$invoke$$inlined$ByteReadPacket$default$1(byte[] bArr) {
        super(1);
        this.$array = bArr;
    }
