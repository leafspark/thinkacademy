...
public class ViEAndroidGLES20 extends GLSurfaceView implements GLSurfaceView.Renderer, GLRendererController {
    ...
    /* access modifiers changed from: private */
    public int nativeOesGLPragram = 0;
    ...
    private void onDrawFrameTexture(GL10 gl10) {
        if (this.textureRendererHelper.isTexture()) {
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:20:?, code lost:
        android.util.Log.w("AGORA_SDK", "Exception occurs when create RtcEngine");
     */
    ...
    public void onSurfaceChanged(javax.microedition.khronos.opengles.GL10 r4, int r5, int r6) {
        ...
        L_0x0060:
            ...
            throw r4
        */
        throw new UnsupportedOperationException("Method not decompiled: io.agora.rtc.video.ViEAndroidGLES20.onSurfaceChanged(javax.microedition.khronos.opengles.GL10, int, int):void");
    }
        ...
        queueEvent(new Runnable() {
            public void run() {
                synchronized (ViEAndroidGLES20.this) {
                    boolean unused = ViEAndroidGLES20.this.surfaceCreated = false;
    ...
    public void releaseOpenGLResource() {
        if (this.nativeGLResourceUpdated) {
            queueEvent(new Runnable() {
                public void run() {
                    String access$000 = ViEAndroidGLES20.TAG;
                    Logging.i(access$000, "releaseOpenGLResource, value = " + ViEAndroidGLES20.this.nativeGLPragram + " ," + ViEAndroidGLES20.this.nativeGLTextureId[0] + " ," + ViEAndroidGLES20.this.nativeGLTextureId[1] + " ," + ViEAndroidGLES20.this.nativeGLTextureId[2] + ", " + ViEAndroidGLES20.this.nativeOesGLPragram);
                    ...
                    if (glGetError != 0) {
                        String access$0002 = ViEAndroidGLES20.TAG;
