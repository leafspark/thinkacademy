...
public class ViETextureViewWrapper extends GLTextureViewWrapper implements GLTextureViewWrapper.Renderer, GLRendererController {
    ...
    public static String TAG = "ViETextureViewWrapper";
    ...
    private void init(boolean z, int i, int i2) {
        ...
        setEGLConfigChooser((GLTextureViewWrapper.EGLConfigChooser) configChooser);
        setRenderer(this);
        setRenderMode(0);
    }
    ...
    private static class ConfigChooser implements GLTextureViewWrapper.EGLConfigChooser {
        ...
        private void printConfigs(EGL10 egl10, EGLDisplay eGLDisplay, EGLConfig[] eGLConfigArr) {
            ...
            Logging.w(ViETextureViewWrapper.TAG, String.format("%d configurations", new Object[]{Integer.valueOf(length)}));
    ...
    public void onSurfaceChanged(javax.microedition.khronos.opengles.GL10 r4, int r5, int r6) {
        ...
        L_0x0060:
            ...
            throw r4
        */
        throw new UnsupportedOperationException("Method not decompiled: io.agora.rtc.video.ViETextureViewWrapper.onSurfaceChanged(javax.microedition.khronos.opengles.GL10, int, int):void");
    }
        ...
        queueEvent(new Runnable() {
            public void run() {
                synchronized (ViETextureViewWrapper.this) {
                    boolean unused = ViETextureViewWrapper.this.surfaceCreated = false;
    ...
    public void releaseOpenGLResource() {
        if (this.nativeGLResourceUpdated) {
            queueEvent(new Runnable() {
                public void run() {
                    String access$000 = ViETextureViewWrapper.TAG;
                    Logging.i(access$000, "releaseOpenGLResource, value = " + ViETextureViewWrapper.this.nativeGLPragram + " ," + ViETextureViewWrapper.this.nativeGLTextureId[0] + " ," + ViETextureViewWrapper.this.nativeGLTextureId[1] + " ," + ViETextureViewWrapper.this.nativeGLTextureId[2] + ", " + ViETextureViewWrapper.this.nativeOesGLProgram);
                    ...
                    if (glGetError != 0) {
                        String access$0002 = ViETextureViewWrapper.TAG;
