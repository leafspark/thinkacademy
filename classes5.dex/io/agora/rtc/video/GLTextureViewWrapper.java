...
public class GLTextureViewWrapper implements TextureView.SurfaceTextureListener, View.OnLayoutChangeListener {
    ...
    public void onLayoutChange(View view, int i, int i2, int i3, int i4, int i5, int i6, int i7, int i8) {
        surfaceChanged(this.mTextureView.getSurfaceTexture(), 0, i3 - i, i4 - i2);
    }
    ...
    private static class DefaultWindowSurfaceFactory implements EGLWindowSurfaceFactory {
        ...
        public EGLSurface createWindowSurface(EGL10 egl10, EGLDisplay eGLDisplay, EGLConfig eGLConfig, Object obj) {
            try {
                ...
                Logging.e(GLTextureViewWrapper.TAG, "eglCreateWindowSurface", e);
                return null;
            }
        }
    ...
    private static class EglHelper {
        ...
        public boolean createSurface() {
            if (this.mEgl == null) {
                ...
                GLTextureViewWrapper gLTextureViewWrapper = (GLTextureViewWrapper) this.mGLSurfaceViewWeakRef.get();
                if (gLTextureViewWrapper != null) {
                    this.mEglSurface = gLTextureViewWrapper.mEGLWindowSurfaceFactory.createWindowSurface(this.mEgl, this.mEglDisplay, this.mEglConfig, gLTextureViewWrapper.getTextureView().getSurfaceTexture());
                } else {
                    this.mEglSurface = null;
                }
    ...
    static class GLThread extends Thread {
        ...
        /* JADX WARNING: Code restructure failed: missing block: B:100:0x0160, code lost:
            r2 = io.agora.rtc.video.GLTextureViewWrapper.access$1000();
         */
        ...
        /* JADX WARNING: Code restructure failed: missing block: B:104:?, code lost:
            ...
            io.agora.rtc.video.GLTextureViewWrapper.access$1000().notifyAll();
         */
        ...
        /* JADX WARNING: Code restructure failed: missing block: B:113:0x0178, code lost:
            ...
            io.agora.rtc.video.GLTextureViewWrapper.access$1000().checkGLDriver(r6);
            r9 = r0;
         */
        ...
        /* JADX WARNING: Code restructure failed: missing block: B:115:0x018b, code lost:
            r2 = (io.agora.rtc.video.GLTextureViewWrapper) r1.mGLSurfaceViewWeakRef.get();
         */
        ...
        /* JADX WARNING: Code restructure failed: missing block: B:117:0x0195, code lost:
            io.agora.rtc.video.GLTextureViewWrapper.access$1200(r2).onSurfaceCreated(r6, r1.mEglHelper.mEglConfig);
         */
        ...
        /* JADX WARNING: Code restructure failed: missing block: B:122:0x01ad, code lost:
            io.agora.rtc.video.GLTextureViewWrapper.access$1200(r2).onSurfaceChanged(r6, r11, r12);
         */
        ...
        /* JADX WARNING: Code restructure failed: missing block: B:126:0x01bf, code lost:
            io.agora.rtc.video.GLTextureViewWrapper.access$1200(r2).onDrawFrame(r6);
         */
        ...
        /* JADX WARNING: Code restructure failed: missing block: B:131:0x01d4, code lost:
            io.agora.rtc.video.GLTextureViewWrapper.EglHelper.logEglErrorAsWarning("GLThread", "eglSwapBuffers", r2);
            r2 = io.agora.rtc.video.GLTextureViewWrapper.access$1000();
         */
        ...
        private void guardedRun() throws java.lang.InterruptedException {
            /*
                r16 = this;
                r1 = r16
                io.agora.rtc.video.GLTextureViewWrapper$EglHelper r0 = new io.agora.rtc.video.GLTextureViewWrapper$EglHelper
                java.lang.ref.WeakReference<io.agora.rtc.video.GLTextureViewWrapper> r2 = r1.mGLSurfaceViewWeakRef
                r0.<init>(r2)
                r1.mEglHelper = r0
                r0 = 0
            ...
            L_0x001b:
                r14 = 0
            L_0x001c:
                io.agora.rtc.video.GLTextureViewWrapper$GLThreadManager r15 = io.agora.rtc.video.GLTextureViewWrapper.sGLThreadManager     // Catch:{ all -> 0x0206 }
                monitor-enter(r15)     // Catch:{ all -> 0x0206 }
            L_0x0021:
                boolean r2 = r1.mShouldExit     // Catch:{ all -> 0x0203 }
                if (r2 == 0) goto L_0x0036
                monitor-exit(r15)     // Catch:{ all -> 0x0203 }
                io.agora.rtc.video.GLTextureViewWrapper$GLThreadManager r2 = io.agora.rtc.video.GLTextureViewWrapper.sGLThreadManager
                monitor-enter(r2)
            ...
            L_0x004b:
                ...
                io.agora.rtc.video.GLTextureViewWrapper$GLThreadManager r2 = io.agora.rtc.video.GLTextureViewWrapper.sGLThreadManager     // Catch:{ all -> 0x0203 }
            ...
            L_0x007c:
                ...
                java.lang.ref.WeakReference<io.agora.rtc.video.GLTextureViewWrapper> r2 = r1.mGLSurfaceViewWeakRef     // Catch:{ all -> 0x0203 }
                java.lang.Object r2 = r2.get()     // Catch:{ all -> 0x0203 }
                io.agora.rtc.video.GLTextureViewWrapper r2 = (io.agora.rtc.video.GLTextureViewWrapper) r2     // Catch:{ all -> 0x0203 }
            ...
            L_0x00a1:
                ...
                io.agora.rtc.video.GLTextureViewWrapper$GLThreadManager r0 = io.agora.rtc.video.GLTextureViewWrapper.sGLThreadManager     // Catch:{ all -> 0x0203 }
                boolean r0 = r0.shouldTerminateEGLWhenPausing()     // Catch:{ all -> 0x0203 }
                if (r0 == 0) goto L_0x00b2
                io.agora.rtc.video.GLTextureViewWrapper$EglHelper r0 = r1.mEglHelper     // Catch:{ all -> 0x0203 }
            ...
            L_0x00fc:
                ...
                if (r0 == 0) goto L_0x0120
                io.agora.rtc.video.GLTextureViewWrapper$EglHelper r0 = r1.mEglHelper     // Catch:{ RuntimeException -> 0x0117 }
            ...
            L_0x0156:
                ...
                io.agora.rtc.video.GLTextureViewWrapper$EglHelper r2 = r1.mEglHelper     // Catch:{ all -> 0x0206 }
                boolean r2 = r2.createSurface()     // Catch:{ all -> 0x0206 }
                if (r2 != 0) goto L_0x0175
                io.agora.rtc.video.GLTextureViewWrapper$GLThreadManager r2 = io.agora.rtc.video.GLTextureViewWrapper.sGLThreadManager     // Catch:{ all -> 0x0206 }
                monitor-enter(r2)     // Catch:{ all -> 0x0206 }
                r15 = 1
                r1.mSurfaceIsBad = r15     // Catch:{ all -> 0x0172 }
                io.agora.rtc.video.GLTextureViewWrapper$GLThreadManager r15 = io.agora.rtc.video.GLTextureViewWrapper.sGLThreadManager     // Catch:{ all -> 0x0172 }
            ...
            L_0x0189:
                ...
                java.lang.ref.WeakReference<io.agora.rtc.video.GLTextureViewWrapper> r2 = r1.mGLSurfaceViewWeakRef     // Catch:{ all -> 0x0206 }
                java.lang.Object r2 = r2.get()     // Catch:{ all -> 0x0206 }
                io.agora.rtc.video.GLTextureViewWrapper r2 = (io.agora.rtc.video.GLTextureViewWrapper) r2     // Catch:{ all -> 0x0206 }
                if (r2 == 0) goto L_0x01a0
                io.agora.rtc.video.GLTextureViewWrapper$Renderer r2 = r2.mRenderer     // Catch:{ all -> 0x0206 }
                io.agora.rtc.video.GLTextureViewWrapper$EglHelper r7 = r1.mEglHelper     // Catch:{ all -> 0x0206 }
            ...
            L_0x01c6:
                ...
                io.agora.rtc.video.GLTextureViewWrapper.EglHelper.logEglErrorAsWarning(r15, r0, r2)     // Catch:{ all -> 0x0206 }
                io.agora.rtc.video.GLTextureViewWrapper$GLThreadManager r2 = io.agora.rtc.video.GLTextureViewWrapper.sGLThreadManager     // Catch:{ all -> 0x0206 }
                monitor-enter(r2)     // Catch:{ all -> 0x0206 }
                r0 = 1
                r1.mSurfaceIsBad = r0     // Catch:{ all -> 0x01ec }
                io.agora.rtc.video.GLTextureViewWrapper$GLThreadManager r15 = io.agora.rtc.video.GLTextureViewWrapper.sGLThreadManager     // Catch:{ all -> 0x01ec }
        ...
        public void surfaceCreated() {
            /*
                r2 = this;
                io.agora.rtc.video.GLTextureViewWrapper$GLThreadManager r0 = io.agora.rtc.video.GLTextureViewWrapper.sGLThreadManager
                monitor-enter(r0)
                r1 = 1
                r2.mHasSurface = r1     // Catch:{ all -> 0x0029 }
                io.agora.rtc.video.GLTextureViewWrapper$GLThreadManager r1 = io.agora.rtc.video.GLTextureViewWrapper.sGLThreadManager     // Catch:{ all -> 0x0029 }
            ...
            L_0x000f:
                ...
                if (r1 != 0) goto L_0x0027
                io.agora.rtc.video.GLTextureViewWrapper$GLThreadManager r1 = io.agora.rtc.video.GLTextureViewWrapper.sGLThreadManager     // Catch:{ InterruptedException -> 0x001f }
            ...
            L_0x0029:
                ...
                throw r1
            */
            throw new UnsupportedOperationException("Method not decompiled: io.agora.rtc.video.GLTextureViewWrapper.GLThread.surfaceCreated():void");
        }
        ...
        public void surfaceDestroyed() {
            ...
            L_0x0029:
                ...
                throw r1
            */
            throw new UnsupportedOperationException("Method not decompiled: io.agora.rtc.video.GLTextureViewWrapper.GLThread.surfaceDestroyed():void");
        }
        ...
        public void onPause() {
            ...
            L_0x0029:
                ...
                throw r1
            */
            throw new UnsupportedOperationException("Method not decompiled: io.agora.rtc.video.GLTextureViewWrapper.GLThread.onPause():void");
        }
        ...
        public void onResume() {
            /*
                ...
                io.agora.rtc.video.GLTextureViewWrapper$GLThreadManager r1 = io.agora.rtc.video.GLTextureViewWrapper.sGLThreadManager     // Catch:{ all -> 0x0032 }
            ...
            L_0x0014:
                ...
                if (r1 != 0) goto L_0x0030
                io.agora.rtc.video.GLTextureViewWrapper$GLThreadManager r1 = io.agora.rtc.video.GLTextureViewWrapper.sGLThreadManager     // Catch:{ InterruptedException -> 0x0028 }
            ...
            L_0x0032:
                ...
                throw r1
            */
            throw new UnsupportedOperationException("Method not decompiled: io.agora.rtc.video.GLTextureViewWrapper.GLThread.onResume():void");
        }
        ...
        public void onWindowResize(int r2, int r3) {
            /*
                ...
                io.agora.rtc.video.GLTextureViewWrapper$GLThreadManager r2 = io.agora.rtc.video.GLTextureViewWrapper.sGLThreadManager     // Catch:{ all -> 0x003c }
            ...
            L_0x0018:
                ...
                if (r2 == 0) goto L_0x003a
                io.agora.rtc.video.GLTextureViewWrapper$GLThreadManager r2 = io.agora.rtc.video.GLTextureViewWrapper.sGLThreadManager     // Catch:{ InterruptedException -> 0x0032 }
            ...
            L_0x003c:
                ...
                throw r2
            */
            throw new UnsupportedOperationException("Method not decompiled: io.agora.rtc.video.GLTextureViewWrapper.GLThread.onWindowResize(int, int):void");
        }
        ...
        public void requestExitAndWait() {
            /*
                ...
                io.agora.rtc.video.GLTextureViewWrapper$GLThreadManager r1 = io.agora.rtc.video.GLTextureViewWrapper.sGLThreadManager     // Catch:{ all -> 0x0025 }
                r1.notifyAll()     // Catch:{ all -> 0x0025 }
            L_0x000f:
                boolean r1 = r2.mExited     // Catch:{ all -> 0x0025 }
                if (r1 != 0) goto L_0x0023
                io.agora.rtc.video.GLTextureViewWrapper$GLThreadManager r1 = io.agora.rtc.video.GLTextureViewWrapper.sGLThreadManager     // Catch:{ InterruptedException -> 0x001b }
            ...
            L_0x0025:
                ...
                throw r1
            */
            throw new UnsupportedOperationException("Method not decompiled: io.agora.rtc.video.GLTextureViewWrapper.GLThread.requestExitAndWait():void");
        }
