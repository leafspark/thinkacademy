...
public final class BehaviorSubject<T> extends Subject<T> {
    ...
    public BehaviorDisposable<T>[] terminate(Object obj) {
        ...
        if (!(behaviorDisposableArr == behaviorDisposableArr2 || (behaviorDisposableArr = (BehaviorDisposable[]) this.subscribers.getAndSet(behaviorDisposableArr2)) == behaviorDisposableArr2)) {
            setCurrent(obj);
        }
