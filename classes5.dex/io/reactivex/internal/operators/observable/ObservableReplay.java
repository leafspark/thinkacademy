...
public final class ObservableReplay<T> extends ConnectableObservable<T> implements HasUpstreamObservableSource<T>, Disposable {
    ...
    static final class MulticastReplay<R, U> extends Observable<R> {
        ...
        public void subscribeActual(Observer<? super R> observer) {
            try {
                ConnectableObservable connectableObservable = (ConnectableObservable) this.connectableFactory.call();
                ObservableSource observableSource = (ObservableSource) this.selector.apply(connectableObservable);
