    ...
    public void subscribeActual(Subscriber<? super R> subscriber) {
        if (this.source instanceof Supplier) {
            try {
                ...
                try {
                    FlowableFromIterable.subscribe(subscriber, ((Iterable) this.mapper.apply(obj)).iterator());
                } catch (Throwable th) {
    ...
    static final class FlattenIterableSubscriber<T, R> extends BasicIntQueueSubscription<R> implements FlowableSubscriber<T> {
        ...
        public void drain() {
            ...
            L_0x002e:
                ...
                io.reactivex.rxjava3.functions.Function<? super T, ? extends java.lang.Iterable<? extends R>> r6 = r1.mapper     // Catch:{ all -> 0x004a }
