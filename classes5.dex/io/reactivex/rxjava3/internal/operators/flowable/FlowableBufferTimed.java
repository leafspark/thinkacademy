...
public final class FlowableBufferTimed<T, U extends Collection<? super T>> extends AbstractFlowableWithUpstream<T, U> {
    ...
    static final class BufferExactUnboundedSubscriber<T, U extends Collection<? super T>> extends QueueDrainSubscriber<T, U, U> implements Subscription, Runnable, Disposable {
        ...
        BufferExactUnboundedSubscriber(Subscriber<? super U> subscriber, Supplier<U> supplier, long j, TimeUnit timeUnit, Scheduler scheduler2) {
        ...
        public void onComplete() {
            ...
            L_0x000c:
                ...
                monitor-exit(r4)     // Catch:{ all -> 0x0027 }
                io.reactivex.rxjava3.internal.fuseable.SimplePlainQueue r2 = r4.queue
                r2.offer(r0)
                r0 = 1
                r4.done = r0
                boolean r0 = r4.enter()
                if (r0 == 0) goto L_0x0026
                io.reactivex.rxjava3.internal.fuseable.SimplePlainQueue r0 = r4.queue
