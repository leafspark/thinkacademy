...
public final class ParallelFilterTry<T> extends ParallelFlowable<T> {
    ...
    static final class ParallelFilterSubscriber<T> extends BaseFilterSubscriber<T> {
        ...
        public boolean tryOnNext(T r10) {
            ...
            L_0x0007:
                r0 = 1
                io.reactivex.rxjava3.functions.Predicate r4 = r9.predicate     // Catch:{ all -> 0x0017 }
            ...
            L_0x0017:
                ...
                r5 = 2
                io.reactivex.rxjava3.functions.BiFunction r6 = r9.errorHandler     // Catch:{ all -> 0x004d }
                r7 = 1
                long r2 = r2 + r7
                ...
                int[] r7 = io.reactivex.rxjava3.internal.operators.parallel.ParallelFilterTry.AnonymousClass1.$SwitchMap$io$reactivex$rxjava3$parallel$ParallelFailureHandling
                int r6 = r6.ordinal()
                r6 = r7[r6]
    ...
    static final class ParallelFilterConditionalSubscriber<T> extends BaseFilterSubscriber<T> {
        ...
        public boolean tryOnNext(T r10) {
            ...
            L_0x0007:
                r0 = 1
                io.reactivex.rxjava3.functions.Predicate r4 = r9.predicate     // Catch:{ all -> 0x001a }
            ...
            L_0x001a:
                ...
                io.reactivex.rxjava3.exceptions.Exceptions.throwIfFatal(r4)
                r5 = 2
                io.reactivex.rxjava3.functions.BiFunction r6 = r9.errorHandler     // Catch:{ all -> 0x0050 }
                r7 = 1
                long r2 = r2 + r7
