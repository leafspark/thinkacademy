...
public final class ParallelDoOnNextTry<T> extends ParallelFlowable<T> {
    ...
    static final class ParallelDoOnNextSubscriber<T> implements ConditionalSubscriber<T>, Subscription {
        ...
        public boolean tryOnNext(T r10) {
            ...
            L_0x0008:
                r0 = 1
                io.reactivex.rxjava3.functions.Consumer<? super T> r4 = r9.onNext     // Catch:{ all -> 0x0014 }
            ...
            L_0x0014:
                ...
                r5 = 2
                io.reactivex.rxjava3.functions.BiFunction<? super java.lang.Long, ? super java.lang.Throwable, io.reactivex.rxjava3.parallel.ParallelFailureHandling> r6 = r9.errorHandler     // Catch:{ all -> 0x004a }
                r7 = 1
                long r2 = r2 + r7
                ...
                int[] r7 = io.reactivex.rxjava3.internal.operators.parallel.ParallelDoOnNextTry.AnonymousClass1.$SwitchMap$io$reactivex$rxjava3$parallel$ParallelFailureHandling
                int r6 = r6.ordinal()
                r6 = r7[r6]
    ...
    static final class ParallelDoOnNextConditionalSubscriber<T> implements ConditionalSubscriber<T>, Subscription {
        ...
        public boolean tryOnNext(T r10) {
            ...
            L_0x0006:
                r2 = 0
            L_0x0008:
                io.reactivex.rxjava3.functions.Consumer<? super T> r0 = r9.onNext     // Catch:{ all -> 0x0014 }
            ...
            L_0x0014:
                ...
                r4 = 1
                r5 = 2
                io.reactivex.rxjava3.functions.BiFunction<? super java.lang.Long, ? super java.lang.Throwable, io.reactivex.rxjava3.parallel.ParallelFailureHandling> r6 = r9.errorHandler     // Catch:{ all -> 0x004b }
                r7 = 1
                long r2 = r2 + r7
