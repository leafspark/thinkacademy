    ...
    public void onImageLaidOut() {
        ...
        if (drawable != null) {
            ...
            if (i > this.mThisHeight) {
                ...
                this.mCropRect.set((float) i3, DEFAULT_ASPECT_RATIO, (float) (i2 + i3), (float) this.mThisHeight);
            } else {
                int i4 = (this.mThisHeight - i) / 2;
                this.mCropRect.set(DEFAULT_ASPECT_RATIO, (float) i4, (float) this.mThisWidth, (float) (i + i4));
            }
