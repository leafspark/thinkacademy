    ...
    public static String autoSelectCamera2ID(Context context, int i) {
        if (Build.VERSION.SDK_INT > 21) {
            ...
            try {
                ...
                String str = TAG;
                Log.d(str, "Camera nums : " + cameraIdList.length);
                String str2 = null;
                for (int i2 = 0; i2 < cameraIdList.length; i2++) {
                    ...
                    String str3 = TAG;
                    Log.d(str3, "autoSelectCameraID -> camera2 list : " + cameraIdList[i2]);
                }
                return str2 == null ? cameraIdList[0] : str2;
            } catch (Exception e) {
                String str4 = TAG;
                Log.e(str4, "autoSelectCameraID -> CameraAccessException! " + e.getLocalizedMessage());
            }
        }
        return null;
    }
