...
public final class d extends AsyncTask<Void, Void, a> {
                            ...
                            if (string.length() != 0) {
                                ...
                                if (decode != null) {
                                    if (decode.length != 0) {
                                        ...
                                        aVar.o = string2;
                                        Log.d("MicroMsg.SDK.GetQRCodeResult", String.format("parse succ, save in memory, uuid = %s, appname = %s, imgBufLength = %d", new Object[]{aVar.n, string2, Integer.valueOf(aVar.s.length)}));
                                        return aVar;
                                    }
                                }
    ...
    public final /* synthetic */ Object doInBackground(Object[] objArr) {
        ...
        String format = String.format(h, new Object[]{this.appId, this.i, this.j, this.scope, this.signature});
    ...
    public final /* synthetic */ void onPostExecute(Object obj) {
        a aVar = (a) obj;
        if (aVar.m == OAuthErrCode.WechatAuth_Err_OK) {
            ...
            Log.e("MicroMsg.SDK.GetQRCodeTask", String.format("onPostExecute, get qrcode fail, OAuthErrCode = %s", new Object[]{aVar.m}));
            this.k.onAuthFinish(aVar.m, (String) null);
        }
    }
}
