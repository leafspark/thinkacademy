...
public class RectangularPyramid1 extends SketchSVGShape {
    ...
    public void buildPath(RectF rectF) {
        ...
        PointF pointF = new PointF(0.55f, CropImageView.DEFAULT_ASPECT_RATIO);
        PointF pointF2 = new PointF(0.5f, 0.69f);
        PointF pointF3 = new PointF(1.0f, 0.69f);
        PointF pointF4 = new PointF(0.79f, 1.0f);
    ...
    public static class Factory extends DrawableObject.Factory {
        public DrawableObject create() {
            return new RectangularPyramid1();
        }
    }
}
