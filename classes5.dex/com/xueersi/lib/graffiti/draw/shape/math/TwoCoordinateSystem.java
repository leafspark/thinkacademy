...
public class TwoCoordinateSystem extends SketchSVGShape {
    ...
    public void buildPath(RectF rectF) {
        ...
        vectorPath.moveTo(0.5f, CropImageView.DEFAULT_ASPECT_RATIO);
    ...
    public void updateActionData(WXWBAction wXWBAction) {
        ...
        this.arrowPath.moveTo((float) point.x, (float) point.y);
        point.offset(((int) (-this.mLineWidth)) * 2, ((int) this.mLineWidth) * 4);
        this.arrowPath.lineTo((float) point.x, (float) point.y);
    ...
    public static class Factory extends DrawableObject.Factory {
        public DrawableObject create() {
            return new TwoCoordinateSystem();
        }
    }
}
