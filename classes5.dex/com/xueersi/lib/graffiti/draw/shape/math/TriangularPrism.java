...
public class TriangularPrism extends SketchSVGShape {
    ...
    public void buildPath(RectF rectF) {
        ...
        PointF pointF3 = new PointF(0.41f, 0.27f);
        PointF pointF4 = new PointF(CropImageView.DEFAULT_ASPECT_RATIO, 0.76f);
        PointF pointF5 = new PointF(1.0f, 0.76f);
