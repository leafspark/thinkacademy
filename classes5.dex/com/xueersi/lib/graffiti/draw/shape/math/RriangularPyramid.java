...
public class RriangularPyramid extends SketchSVGShape {
    ...
    public void buildPath(RectF rectF) {
        ...
        PointF pointF = new PointF(0.5f, CropImageView.DEFAULT_ASPECT_RATIO);
        PointF pointF2 = new PointF(CropImageView.DEFAULT_ASPECT_RATIO, 0.76f);
        PointF pointF3 = new PointF(1.0f, 0.76f);
        PointF pointF4 = new PointF(0.44f, 1.0f);
