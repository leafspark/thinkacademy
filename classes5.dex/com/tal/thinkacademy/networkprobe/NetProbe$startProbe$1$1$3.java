...
final class NetProbe$startProbe$1$1$3 extends Lambda implements Function0<Unit> {
    final /* synthetic */ NetProbe this$0;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    NetProbe$startProbe$1$1$3(NetProbe netProbe) {
        super(0);
    ...
    public final void invoke() {
        ...
        if (!(access$getMHolder$p == null || (mCancelBlock$networkprobe_release = access$getMHolder$p.getMCancelBlock$networkprobe_release()) == null)) {
            mCancelBlock$networkprobe_release.invoke("执行结束");
        }
