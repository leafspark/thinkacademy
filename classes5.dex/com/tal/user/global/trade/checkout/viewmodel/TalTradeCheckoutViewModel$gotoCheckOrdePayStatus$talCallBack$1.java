...
@Metadata(bv = {1, 0, 3}, d1 = {"\u0000\u001d\n\u0000\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0000\n\u0002\u0010\u0002\n\u0000\n\u0002\u0018\u0002\n\u0002\b\u0003*\u0001\u0000\b\n\u0018\u00002\n\u0012\u0006\u0012\u0004\u0018\u00010\u00020\u0001J\u0012\u0010\u0003\u001a\u00020\u00042\b\u0010\u0005\u001a\u0004\u0018\u00010\u0006H\u0016J\u0012\u0010\u0007\u001a\u00020\u00042\b\u0010\b\u001a\u0004\u0018\u00010\u0002H\u0016¨\u0006\t"}, d2 = {"com/tal/user/global/trade/checkout/viewmodel/TalTradeCheckoutViewModel$gotoCheckOrdePayStatus$talCallBack$1", "Lcom/tal/user/global/trade/api/TalTradeApiCallBack;", "Lcom/tal/user/global/trade/entity/PayOrderStatusQueryEntity;", "onError", "", "errorMsg", "Lcom/tal/user/global/trade/entity/TalTradeErrorMsg;", "onSuccess", "data", "android_taltradeglobal_release"}, k = 1, mv = {1, 4, 2})
/* compiled from: TalTradeCheckoutViewModel.kt */
public final class TalTradeCheckoutViewModel$gotoCheckOrdePayStatus$talCallBack$1 extends TalTradeApiCallBack<PayOrderStatusQueryEntity> {
    final /* synthetic */ TalTradeCheckoutViewModel this$0;

    TalTradeCheckoutViewModel$gotoCheckOrdePayStatus$talCallBack$1(TalTradeCheckoutViewModel talTradeCheckoutViewModel) {
    ...
    public void onSuccess(PayOrderStatusQueryEntity payOrderStatusQueryEntity) {
        if (payOrderStatusQueryEntity != null) {
            this.this$0.getPayOrderStatus().setValue(Integer.valueOf(payOrderStatusQueryEntity.getStatus()));
        }
    }
}
