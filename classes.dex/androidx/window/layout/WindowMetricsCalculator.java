...
public interface WindowMetricsCalculator {
    ...
    public static final class Companion {
        ...
        private static Function1<? super WindowMetricsCalculator, ? extends WindowMetricsCalculator> decorator = ((Function1) WindowMetricsCalculator$Companion$decorator$1.INSTANCE);
        ...
        public final void overrideDecorator(WindowMetricsCalculatorDecorator windowMetricsCalculatorDecorator) {
            ...
            decorator = (Function1) new WindowMetricsCalculator$Companion$overrideDecorator$1(windowMetricsCalculatorDecorator);
        }

        @JvmStatic
        public final void reset() {
            decorator = (Function1) WindowMetricsCalculator$Companion$reset$1.INSTANCE;
        }
    }
}
