...
public final class HardwareFoldingFeature implements FoldingFeature {
    ...
    public HardwareFoldingFeature(Bounds bounds, Type type2, FoldingFeature.State state2) {
        ...
        Intrinsics.checkNotNullParameter(state2, TransferTable.COLUMN_STATE);
    ...
    public boolean isSeparating() {
        ...
        if (!Intrinsics.areEqual(this.type, Type.Companion.getFOLD()) || !Intrinsics.areEqual(getState(), FoldingFeature.State.HALF_OPENED)) {
            return false;
        }
        return true;
    }
