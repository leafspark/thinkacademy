    ...
    public void layoutChunk(RecyclerView.Recycler recycler, RecyclerView.State state, LinearLayoutManager.LayoutState layoutState, LinearLayoutManager.LayoutChunkResult layoutChunkResult) {
        ...
        for (int i18 = 0; i18 < i13; i18++) {
            ...
            if (this.mOrientationHelper.getDecoratedMeasurement(view3) != i16) {
                ...
                if (this.mOrientation == 1) {
                    i10 = getChildMeasureSpec(spaceForSpanRange, BasicMeasure.EXACTLY, i20, layoutParams.width, false);
                    ...
                    i9 = getChildMeasureSpec(spaceForSpanRange, BasicMeasure.EXACTLY, i19, layoutParams.height, false);
                    i10 = makeMeasureSpec;
                }
