...
public final class ViewModelLazy<VM extends ViewModel> implements Lazy<VM> {
    ...
    public VM getValue() {
        ...
        VM vm2 = new ViewModelProvider((ViewModelStore) this.storeProducer.invoke(), (ViewModelProvider.Factory) this.factoryProducer.invoke()).get(JvmClassMappingKt.getJavaClass(this.viewModelClass));
        this.cached = vm2;
