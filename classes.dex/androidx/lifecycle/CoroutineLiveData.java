...
public final class CoroutineLiveData<T> extends MediatorLiveData<T> {
    ...
    public CoroutineLiveData(CoroutineContext coroutineContext, long j, Function2<? super LiveDataScope<T>, ? super Continuation<? super Unit>, ? extends Object> function2) {
        ...
        long j2 = j;
        this.blockRunner = new BlockRunner(this, function22, j2, CoroutineScopeKt.CoroutineScope(Dispatchers.getMain().getImmediate().plus(coroutineContext).plus(SupervisorKt.SupervisorJob(coroutineContext.get(Job.Key)))), new Function0<Unit>(this) {
