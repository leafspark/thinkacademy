...
public abstract class AbstractResolvableFuture<V> implements ListenableFuture<V> {
    ...
    public final boolean cancel(boolean z) {
        ...
        while (true) {
            if (ATOMIC_HELPER.casValue(abstractResolvableFuture, obj, cancellation)) {
                ...
                AbstractResolvableFuture abstractResolvableFuture2 = ((SetFuture) obj).future;
                if (abstractResolvableFuture2 instanceof AbstractResolvableFuture) {
                    ...
                    abstractResolvableFuture2.cancel(z);
                    return true;
                }
            } else {
                obj = abstractResolvableFuture.value;
    ...
    /* JADX WARNING: type inference failed for: r3v0, types: [java.util.concurrent.Future, androidx.concurrent.futures.AbstractResolvableFuture] */
