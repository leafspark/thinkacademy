...
class MetadataImageReader implements ImageReaderProxy, ForwardingImageProxy.OnImageCloseListener {
    ...
    private void enqueueImageProxy(SettableImageProxy settableImageProxy) {
        ...
        if (executor != null) {
            executor.execute(new MetadataImageReader$$ExternalSyntheticLambda1(this, onImageAvailableListener));
        } else {
    ...
    public void lambda$new$0$MetadataImageReader(androidx.camera.core.impl.ImageReaderProxy r7) {
        /*
            r6 = this;
        ...
        L_0x0026:
            ...
            androidx.camera.core.Logger.d(r4, r5, r3)     // Catch:{ all -> 0x0024 }
        L_0x002e:
        ...
        L_0x0039:
            ...
            throw r7
        */
        throw new UnsupportedOperationException("Method not decompiled: androidx.camera.core.MetadataImageReader.lambda$new$0$MetadataImageReader(androidx.camera.core.impl.ImageReaderProxy):void");
    }
