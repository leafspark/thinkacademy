...
public final /* synthetic */ class Camera2CameraImpl$$ExternalSyntheticLambda5 implements Runnable {
    ...
    public /* synthetic */ Camera2CameraImpl$$ExternalSyntheticLambda5(Camera2CameraImpl camera2CameraImpl, Collection collection) {
        this.f$0 = camera2CameraImpl;
        this.f$1 = collection;
    }

    public final void run() {
        this.f$0.lambda$detachUseCases$12$Camera2CameraImpl(this.f$1);
    }
}
