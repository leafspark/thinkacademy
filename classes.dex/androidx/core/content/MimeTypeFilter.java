...
public final class MimeTypeFilter {
    ...
    public static boolean matches(String str, String str2) {
        ...
        return mimeTypeAgainstFilter(str.split(ExpiryDateInput.SEPARATOR), str2.split(ExpiryDateInput.SEPARATOR));
    }
    ...
    public static String matches(String str, String[] strArr) {
        ...
        for (String str2 : strArr) {
            if (mimeTypeAgainstFilter(split, str2.split(ExpiryDateInput.SEPARATOR))) {
                return str2;
            }
        }
        return null;
    ...
    public static String matches(String[] strArr, String str) {
        ...
        String[] split = str.split(ExpiryDateInput.SEPARATOR);
        for (String str2 : strArr) {
            if (mimeTypeAgainstFilter(str2.split(ExpiryDateInput.SEPARATOR), split)) {
                return str2;
            }
        }
        return null;
