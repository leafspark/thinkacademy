...
public final class BinLookupRepository$makeBinLookup$2$invokeSuspend$$inlined$suspendedCall$1 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super BinLookupResponse>, Object> {
    final /* synthetic */ Connection $this_suspendedCall;
    int label;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    public BinLookupRepository$makeBinLookup$2$invokeSuspend$$inlined$suspendedCall$1(Connection connection, Continuation continuation) {
        super(2, continuation);
        this.$this_suspendedCall = connection;
    }

    public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
        return (Continuation) new BinLookupRepository$makeBinLookup$2$invokeSuspend$$inlined$suspendedCall$1(this.$this_suspendedCall, continuation);
    }
