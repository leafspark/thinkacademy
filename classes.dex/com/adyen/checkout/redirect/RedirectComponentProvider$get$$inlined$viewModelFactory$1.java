...
public final class RedirectComponentProvider$get$$inlined$viewModelFactory$1 extends AbstractSavedStateViewModelFactory {
    ...
    public RedirectComponentProvider$get$$inlined$viewModelFactory$1(SavedStateRegistryOwner savedStateRegistryOwner, Bundle bundle, Application application, RedirectConfiguration redirectConfiguration, RedirectDelegate redirectDelegate) {
    ...
    public <T extends ViewModel> T create(String str, Class<T> cls, SavedStateHandle savedStateHandle) {
        ...
        return (ViewModel) new RedirectComponent(savedStateHandle, this.$application$inlined, this.$configuration$inlined, this.$redirectDelegate$inlined);
    }
}
