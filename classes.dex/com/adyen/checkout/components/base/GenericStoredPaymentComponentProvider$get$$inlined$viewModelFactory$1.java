...
public final class GenericStoredPaymentComponentProvider$get$$inlined$viewModelFactory$1 extends AbstractSavedStateViewModelFactory {
    ...
    public GenericStoredPaymentComponentProvider$get$$inlined$viewModelFactory$1(SavedStateRegistryOwner savedStateRegistryOwner, Bundle bundle, GenericStoredPaymentComponentProvider genericStoredPaymentComponentProvider, Configuration configuration, StoredPaymentMethod storedPaymentMethod) {
    ...
    public <T extends ViewModel> T create(String str, Class<T> cls, SavedStateHandle savedStateHandle) {
        ...
        return (ViewModel) ((BasePaymentComponent) this.this$0.componentClass.getConstructor(new Class[]{SavedStateHandle.class, GenericStoredPaymentDelegate.class, this.$configuration$inlined.getClass()}).newInstance(new Object[]{savedStateHandle, new GenericStoredPaymentDelegate(this.$storedPaymentMethod$inlined), this.$configuration$inlined}));
    }
}
