...
public final class OrderStatusRepository$getOrderStatus$$inlined$suspendedCall$1 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super OrderStatusResponse>, Object> {
    final /* synthetic */ Connection $this_suspendedCall;
    int label;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    public OrderStatusRepository$getOrderStatus$$inlined$suspendedCall$1(Connection connection, Continuation continuation) {
        super(2, continuation);
        this.$this_suspendedCall = connection;
    }

    public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
        return (Continuation) new OrderStatusRepository$getOrderStatus$$inlined$suspendedCall$1(this.$this_suspendedCall, continuation);
    }

    public final Object invoke(CoroutineScope coroutineScope, Continuation<? super OrderStatusResponse> continuation) {
