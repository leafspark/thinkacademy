...
public final class PaymentMethodTypes {
    ...
    public static final List<String> SUPPORTED_ACTION_ONLY_PAYMENT_METHODS = Collections.unmodifiableList(Arrays.asList(new String[]{WECHAT_PAY_SDK, PIX}));
    public static final List<String> SUPPORTED_PAYMENT_METHODS = Collections.unmodifiableList(Arrays.asList(new String[]{BCMC, "dotpay", "entercash", "eps", "giftcard", GOOGLE_PAY, GOOGLE_PAY_LEGACY, "ideal", "mbway", MOLPAY_MALAYSIA, MOLPAY_THAILAND, MOLPAY_VIETNAM, "openbanking_UK", "sepadirectdebit", "directdebit_GB", "scheme", "blik", WECHAT_PAY_SDK, PIX}));
    public static final String UNKNOWN = "unknown";
    public static final List<String> UNSUPPORTED_PAYMENT_METHODS = Collections.unmodifiableList(Arrays.asList(new String[]{BCMC_QR, AFTER_PAY, WECHAT_PAY_MINI_PROGRAM, WECHAT_PAY_QR, WECHAT_PAY_WEB, MULTIBANCO, OXXO, DOKU, DOKU_ALFMART, DOKU_PERMATA_LITE_ATM, DOKU_INDOMARET, DOKU_ATM_MANDIRI_VA, DOKU_SINARMAS_VA, DOKU_MANDIRI_VA, DOKU_CIMB_VA, DOKU_DANAMON_VA, DOKU_BRI_VA, DOKU_BNI_VA, DOKU_BCA_VA, DOKU_WALLET, BOLETOBANCARIO, BOLETOBANCARIO_BANCODOBRASIL, BOLETOBANCARIO_BRADESCO, BOLETOBANCARIO_HSBC, BOLETOBANCARIO_ITAU, BOLETOBANCARIO_SANTANDER, DRAGONPAY_EBANKING, DRAGONPAY_OTC_BANKING, DRAGONPAY_OTC_NON_BANKING, DRAGONPAY_OTC_PHILIPPINES, ECONTEXT_SEVEN_ELEVEN, ECONTEXT_ATM, ECONTEXT_STORES, ECONTEXT_ONLINE}));
