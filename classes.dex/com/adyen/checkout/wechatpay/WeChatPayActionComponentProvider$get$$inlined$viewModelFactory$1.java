...
public final class WeChatPayActionComponentProvider$get$$inlined$viewModelFactory$1 extends AbstractSavedStateViewModelFactory {
    ...
    public WeChatPayActionComponentProvider$get$$inlined$viewModelFactory$1(SavedStateRegistryOwner savedStateRegistryOwner, Bundle bundle, Application application, WeChatPayActionConfiguration weChatPayActionConfiguration) {
        super(savedStateRegistryOwner, bundle);
        this.$owner = savedStateRegistryOwner;
        this.$defaultArgs = bundle;
        this.$application$inlined = application;
        this.$configuration$inlined = weChatPayActionConfiguration;
    }
    ...
    public <T extends ViewModel> T create(String str, Class<T> cls, SavedStateHandle savedStateHandle) {
        ...
        return (ViewModel) new WeChatPayActionComponent(savedStateHandle, this.$application$inlined, this.$configuration$inlined);
    }
}
