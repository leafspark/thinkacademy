...
public class HSFJSONUtils {
    ...
    public static Object[] parseInvocationArguments(String str, MethodLocator methodLocator) {
        ...
        Object[] objArr = null;
        ParseContext context = defaultJSONParser.setContext((Object) null, (Object) null);
        ...
        if (i == 12) {
            ...
            if (jSONLexerBase.matchField2(fieldName_argsObjs)) {
                ...
                ParseContext context2 = defaultJSONParser.setContext(context, (Object) null, "argsObjs");
                Object[] parseArray = defaultJSONParser.parseArray(genericParameterTypes2);
                context2.object = parseArray;
                defaultJSONParser.accept(13);
                defaultJSONParser.handleResovleTask((Object) null);
                objArr = parseArray;
            }
            ...
            String[] scanFieldStringArray2 = jSONLexerBase.scanFieldStringArray((char[]) null, -1, typeSymbolTable);
            jSONLexerBase.skipWhitespace();
            char current = jSONLexerBase.getCurrent();
            if (current == ']') {
                Type[] genericParameterTypes3 = methodLocator.findMethod((String[]) null).getGenericParameterTypes();
                ...
                while (i2 < scanFieldStringArray2.length) {
                    ...
                    if (type != String.class) {
                        objArr3[i2] = TypeUtils.cast((Object) str2, type, defaultJSONParser.getConfig());
                    } else {
                        objArr3[i2] = str2;
                    }
                    i2++;
