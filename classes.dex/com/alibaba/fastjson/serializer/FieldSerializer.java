...
public class FieldSerializer implements Comparable<FieldSerializer> {
    ...
    public FieldSerializer(Class<?> cls, FieldInfo fieldInfo2) {
        ...
        if (cls != null && ((fieldInfo2.isEnum || fieldInfo2.fieldClass == Long.TYPE || fieldInfo2.fieldClass == Long.class || fieldInfo2.fieldClass == BigInteger.class || fieldInfo2.fieldClass == BigDecimal.class) && (jSONType = (JSONType) TypeUtils.getAnnotation(cls, JSONType.class)) != null)) {
