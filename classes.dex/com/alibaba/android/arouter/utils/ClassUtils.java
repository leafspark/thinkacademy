...
public class ClassUtils {
    ...
    private static SharedPreferences getMultiDexPreferences(Context context) {
        int i = Build.VERSION.SDK_INT < 11 ? 0 : 4;
        return !(context instanceof Context) ? context.getSharedPreferences(PREFS_FILE, i) : XMLParseInstrumentation.getSharedPreferences(context, PREFS_FILE, i);
    }
