...
final class _ARouter {
    ...
    private String extractGroup(String str) {
        if (TextUtils.isEmpty(str) || !str.startsWith(ExpiryDateInput.SEPARATOR)) {
            throw new HandlerException("ARouter::Extract the default group failed, the path must be start with '/' and contain more than 2 '/'!");
        }
        try {
            String substring = str.substring(1, str.indexOf(ExpiryDateInput.SEPARATOR, 1));
    ...
    static /* synthetic */ class AnonymousClass4 {
        ...
        static {
            ...
            L_0x0054:
                return
            */
            throw new UnsupportedOperationException("Method not decompiled: com.alibaba.android.arouter.launcher._ARouter.AnonymousClass4.<clinit>():void");
        }
    }
