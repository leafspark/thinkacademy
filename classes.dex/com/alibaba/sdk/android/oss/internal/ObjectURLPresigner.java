...
public class ObjectURLPresigner {
    ...
    public String presignConstrainedURL(GeneratePresignedUrlRequest generatePresignedUrlRequest) throws ClientException {
        ...
        return this.endpoint.getScheme() + "://" + host + ExpiryDateInput.SEPARATOR + HttpUtil.urlEncode(key, "utf-8") + "?" + HttpUtil.paramToQueryString(linkedHashMap, "utf-8");
    }
    ...
    public String presignPublicURL(String str, String str2) {
        ...
        return this.endpoint.getScheme() + "://" + host + ExpiryDateInput.SEPARATOR + HttpUtil.urlEncode(str2, "utf-8");
    }
}
