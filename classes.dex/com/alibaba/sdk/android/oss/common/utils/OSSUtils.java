...
public class OSSUtils {
    ...
    public static void populateCopyObjectHeaders(CopyObjectRequest copyObjectRequest, Map<String, String> map) {
        map.put(OSSHeaders.COPY_OBJECT_SOURCE, ExpiryDateInput.SEPARATOR + copyObjectRequest.getSourceBucketName() + ExpiryDateInput.SEPARATOR + HttpUtil.urlEncode(copyObjectRequest.getSourceKey(), "utf-8"));
    ...
    public static String buildCanonicalizedResource(String str, String str2, Map<String, String> map) {
        String str3 = ExpiryDateInput.SEPARATOR;
    ...
    public static String buildBaseLogInfo(Context context) {
        ...
        sb.append("[INFO]: network_state：" + str2 + NEW_LINE);
    ...
    public static String buildTriggerCallbackBody(Map<String, String> map, Map<String, String> map2) {
        ...
        if (map != null && map.size() > 0) {
            JSONObject jSONObject = new JSONObject(map);
            sb.append(Base64.encodeToString((!(jSONObject instanceof JSONObject) ? jSONObject.toString() : JSONObjectInstrumentation.toString(jSONObject)).getBytes(), 2));
        }
        sb.append(",callback-var_");
        if (map2 != null && map2.size() > 0) {
            JSONObject jSONObject2 = new JSONObject(map2);
            sb.append(Base64.encodeToString((!(jSONObject2 instanceof JSONObject) ? jSONObject2.toString() : JSONObjectInstrumentation.toString(jSONObject2)).getBytes(), 2));
        }
        return sb.toString();
    }
