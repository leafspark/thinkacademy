...
public class OSSSharedPreferences {
    ...
    private OSSSharedPreferences(Context context) {
        this.mSp = !(context instanceof Context) ? context.getSharedPreferences("oss_android_sdk_sp", 0) : XMLParseInstrumentation.getSharedPreferences(context, "oss_android_sdk_sp", 0);
    }
