        ...
        if (!fileName.startsWith("data:") || fileName.indexOf("base64,") <= 0) {
            try {
                if (!TextUtils.isEmpty(this.imagesFolder)) {
                    ...
                    try {
                        return putBitmap(str, Utils.resizeBitmapIfNeeded(BitmapFactoryInstrumentation.decodeStream(assets.open(this.imagesFolder + fileName), (Rect) null, options), lottieImageAsset.getWidth(), lottieImageAsset.getHeight()));
            ...
            try {
                ...
                return putBitmap(str, BitmapFactoryInstrumentation.decodeByteArray(decode, 0, decode.length, options));
