...
public class PathKeyframeAnimation extends KeyframeAnimation<PointF> {
    ...
    public PointF getValue(Keyframe<PointF> keyframe, float f) {
        ...
        if (this.valueCallback != null) {
            PointF pointF = (PointF) this.valueCallback.getValueInternal(pathKeyframe.startFrame, pathKeyframe.endFrame.floatValue(), (PointF) pathKeyframe.startValue, (PointF) pathKeyframe.endValue, getLinearCurrentKeyframeProgress(), f, getProgress());
            if (pointF != null) {
                return pointF;
            }
        }
