...
public class FloatKeyframeAnimation extends KeyframeAnimation<Float> {
    ...
    public float getFloatValue(Keyframe<Float> keyframe, float f) {
        ...
        if (this.valueCallback != null) {
            Float f2 = (Float) this.valueCallback.getValueInternal(keyframe.startFrame, keyframe.endFrame.floatValue(), (Float) keyframe.startValue, (Float) keyframe.endValue, f, getLinearCurrentKeyframeProgress(), getProgress());
            if (f2 != null) {
