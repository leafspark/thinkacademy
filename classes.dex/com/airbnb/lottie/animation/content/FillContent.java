...
public class FillContent implements DrawingContent, BaseKeyframeAnimation.AnimationListener, KeyPathElementContent {
    ...
    public void draw(Canvas canvas, Matrix matrix, int i) {
        if (!this.hidden) {
            ...
            this.paint.setColor((MiscUtils.clamp((int) ((((((float) i) / 255.0f) * ((float) this.opacityAnimation.getValue().intValue())) / 100.0f) * 255.0f), 0, 255) << 24) | (((ColorKeyframeAnimation) this.colorAnimation).getIntValue() & ViewCompat.MEASURED_SIZE_MASK));
