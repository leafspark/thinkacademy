...
public class RijndaelEngine implements BlockCipher {
    ...
    private void InvMixColumn() {
        ...
        for (int i = 0; i < this.BC; i += 8) {
            ...
            byte b = -1;
            byte b2 = i2 != 0 ? logtable[i2 & GF2Field.MASK] & 255 : -1;
            byte b3 = i3 != 0 ? logtable[i3 & GF2Field.MASK] & 255 : -1;
            byte b4 = i4 != 0 ? logtable[i4 & GF2Field.MASK] & 255 : -1;
            if (i5 != 0) {
                b = logtable[i5 & GF2Field.MASK] & 255;
            }
    ...
    private long[][] generateWorkingKey(byte[] bArr) {
        ...
        while (i8 < i && i9 < (this.ROUNDS + 1) * (this.BC / 8)) {
            ...
            while (i10 < i4) {
                ...
                jArr2[i10] = (((long) (bArr3[i10][i8] & 255)) << ((i9 * 8) % i11)) | jArr2[i10];
                i10++;
                i4 = 4;
            }
            i8++;
        ...
        while (i9 < (this.ROUNDS + 1) * (this.BC / i3)) {
            ...
            while (i21 < i && i9 < (this.ROUNDS + 1) * (this.BC / i3)) {
                for (int i22 = i5; i22 < 4; i22++) {
                    ...
                    jArr3[i22] = (((long) (bArr3[i22][i21] & 255)) << ((i9 * 8) % i23)) | jArr3[i22];
                }
                i21++;
                i9++;
                i5 = 0;
