...
public class CipherOutputStream extends FilterOutputStream {
    ...
    public void close() throws java.io.IOException {
        /*
            ...
            org.bouncycastle.crypto.BufferedBlockCipher r1 = r4.bufferedBlockCipher     // Catch:{ InvalidCipherTextException -> 0x003f, Exception -> 0x0036 }
            ...
            goto L_0x0034
        L_0x0019:
            org.bouncycastle.crypto.modes.AEADBlockCipher r1 = r4.aeadBlockCipher     // Catch:{ InvalidCipherTextException -> 0x003f, Exception -> 0x0036 }
