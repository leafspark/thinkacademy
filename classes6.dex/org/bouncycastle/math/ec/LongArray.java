...
class LongArray implements Cloneable {
    ...
    private static long interleave2_32to64(int i) {
        ...
        short s = sArr[i & GF2Field.MASK] | (sArr[(i >>> 8) & GF2Field.MASK] << 16);
        short s2 = sArr[(i >>> 16) & GF2Field.MASK];
    ...
    private static long interleave4_16to64(int i) {
        ...
        return (((long) iArr[i & GF2Field.MASK]) & 4294967295L) | ((((long) iArr[i >>> 8]) & 4294967295L) << 32);
    }
    ...
    public LongArray modMultiplyAlt(LongArray longArray, int i, int[] iArr) {
        ...
        if (i8 == 1) {
            ...
            multiplyWord(j, longArray2.m_ints, i9, jArr, 0);
            return reduceResult(jArr, 0, i10, i7, iArr2);
        }
        int i11 = 15;
        int i12 = ((i2 + 15) + 63) >>> 6;
        int i13 = i12 * 8;
        ...
        int[] iArr4 = iArr3;
        int i16 = i13;
        interleave(jArr3, 0, jArr2, 0, i8, 4);
        System.arraycopy(longArray2.m_ints, 0, jArr2, i8, i9);
        int i17 = i8;
        int i18 = 1;
        while (i18 < 8) {
            int i19 = i17 + i12;
            shiftUp(jArr2, i8, jArr2, i19, i12, i18);
            i18++;
            i17 = i19;
        }
        int i20 = 0;
        while (true) {
            ...
            do {
                int i22 = i8;
                long j2 = jArr2[i21] >>> i20;
                int i23 = 0;
                while (true) {
                    int i24 = ((int) j2) & i11;
                    if (i24 != 0) {
                        add(jArr2, iArr4[i24] + i21, jArr2, i22, i12);
                    }
                    i4 = 1;
                    i23++;
                    if (i23 == 8) {
        ...
        while (true) {
            int i27 = i26 - 1;
            if (i27 <= i4) {
                return reduceResult(jArr2, iArr4[i4], i10, i7, iArr2);
            }
            if ((((long) i27) & 1) == 0) {
                i6 = i4;
                addShiftedUp(jArr2, iArr4[i27 >>> 1], jArr2, iArr4[i27], i10, 16);
            } else {
                i6 = i4;
                distribute(jArr2, iArr4[i27], iArr4[i27 - 1], iArr4[i6], i10);
            }
            i26 = i27;
            i4 = i6;
        }
