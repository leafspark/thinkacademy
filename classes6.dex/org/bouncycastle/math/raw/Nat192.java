...
public abstract class Nat192 {
    ...
    public static void mul(int[] iArr, int[] iArr2, int[] iArr3) {
        ...
        for (int i2 = 6; i < i2; i2 = 6) {
            long j15 = ((long) iArr[i]) & M;
            int i3 = i + 0;
            long j16 = (j15 * j) + (((long) iArr3[i3]) & M) + 0;
            iArr3[i3] = (int) j16;
            int i4 = i + 1;
            long j17 = j2;
            long j18 = (j16 >>> 32) + (j15 * j2) + (((long) iArr3[i4]) & M);
            iArr3[i4] = (int) j18;
            int i5 = i + 2;
            long j19 = j7;
            long j20 = (j18 >>> 32) + (j15 * j6) + (((long) iArr3[i5]) & M);
            iArr3[i5] = (int) j20;
            int i6 = i + 3;
            long j21 = (j20 >>> 32) + (j15 * j4) + (((long) iArr3[i6]) & M);
            iArr3[i6] = (int) j21;
            int i7 = i + 4;
            long j22 = (j21 >>> 32) + (j15 * j5) + (((long) iArr3[i7]) & M);
            iArr3[i7] = (int) j22;
            int i8 = i + 5;
            long j23 = (j22 >>> 32) + (j15 * j19) + (((long) iArr3[i8]) & M);
            iArr3[i8] = (int) j23;
    ...
    public static void square(int[] iArr, int i, int[] iArr2, int i2) {
        ...
        while (true) {
            ...
            if (i6 <= 0) {
                ...
                int i36 = i35 >>> 31;
                int i37 = i2 + 11;
                iArr2[i37] = i36 | ((iArr2[i37] + ((int) (j55 >>> 32))) << 1);
                return;
            }
            i5 = i6;
        }
    ...
    public static void square(int[] iArr, int[] iArr2) {
        ...
        while (true) {
            ...
            if (i4 <= 0) {
                ...
                int i12 = i11 >>> 31;
                long j48 = j39 + (j47 >>> 32) + (j6 * j43);
                long j49 = j44 + (j48 >>> 32) + (j43 * j18);
                long j50 = (j40 & M) + (j49 >>> 32) + (j43 * j29);
                long j51 = j46 + (j50 >>> 32) + (j43 * j42);
                long j52 = (((long) iArr2[10]) & M) + (j45 >>> 32) + (j51 >>> 32);
                int i13 = (int) j48;
                iArr2[6] = i12 | (i13 << 1);
                int i14 = (int) j49;
