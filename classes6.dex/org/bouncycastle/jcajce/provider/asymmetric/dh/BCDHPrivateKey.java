...
public class BCDHPrivateKey implements DHPrivateKey, PKCS12BagAttributeCarrier {
    ...
    public DHPrivateKeyParameters engineGetKeyParameters() {
        ...
        return dHPrivateKeyParameters != null ? dHPrivateKeyParameters : this.dhSpec instanceof DHDomainParameterSpec ? new DHPrivateKeyParameters(this.x, ((DHDomainParameterSpec) this.dhSpec).getDomainParameters()) : new DHPrivateKeyParameters(this.x, new DHParameters(this.dhSpec.getP(), this.dhSpec.getG(), (BigInteger) null, this.dhSpec.getL()));
    }
