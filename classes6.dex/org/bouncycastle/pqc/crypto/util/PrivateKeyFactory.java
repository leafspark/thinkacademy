    ...
    public static AsymmetricKeyParameter createKey(PrivateKeyInfo privateKeyInfo) throws IOException {
        ...
        if (algorithm.on(BCObjectIdentifiers.qTESLA)) {
            ...
            if (algorithm.equals((ASN1Primitive) PKCSObjectIdentifiers.id_alg_hss_lms_hashsig)) {
                ...
                McElieceCCA2PrivateKey instance5 = McElieceCCA2PrivateKey.getInstance(privateKeyInfo.parsePrivateKey());
                return new McElieceCCA2PrivateKeyParameters(instance5.getN(), instance5.getK(), instance5.getField(), instance5.getGoppaPoly(), instance5.getP(), Utils.getDigestName(instance5.getDigest().getAlgorithm()));
            } else {
