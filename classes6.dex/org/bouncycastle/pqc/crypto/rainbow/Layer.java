        ...
        for (int i8 = 0; i8 < i7; i8++) {
            for (int i9 = 0; i9 < this.oi; i9++) {
                for (int i10 = 0; i10 < this.vi; i10++) {
                    this.coeff_alpha[i8][i9][i10] = (short) (secureRandom.nextInt() & GF2Field.MASK);
                }
            }
        }
        for (int i11 = 0; i11 < i7; i11++) {
            for (int i12 = 0; i12 < this.vi; i12++) {
                for (int i13 = 0; i13 < this.vi; i13++) {
                    this.coeff_beta[i11][i12][i13] = (short) (secureRandom.nextInt() & GF2Field.MASK);
                }
            }
        }
        for (int i14 = 0; i14 < i7; i14++) {
            for (int i15 = 0; i15 < this.viNext; i15++) {
                this.coeff_gamma[i14][i15] = (short) (secureRandom.nextInt() & GF2Field.MASK);
            }
        }
        for (int i16 = 0; i16 < i7; i16++) {
            this.coeff_eta[i16] = (short) (secureRandom.nextInt() & GF2Field.MASK);
        }
    }
