...
public class ASN1StreamParser {
    ...
    public ASN1Encodable readObject() throws IOException {
        ...
        if (readLength >= 0) {
            ...
            return (read & BERTags.PRIVATE) == 192 ? new BERPrivateParser(readTagNumber, aSN1StreamParser) : (read & 64) != 0 ? new BERApplicationSpecificParser(readTagNumber, aSN1StreamParser) : (read & 128) != 0 ? new BERTaggedObjectParser(true, readTagNumber, aSN1StreamParser) : aSN1StreamParser.readIndef(readTagNumber);
        } else {
            throw new IOException("indefinite-length primitive encoding encountered");
        }
    }
