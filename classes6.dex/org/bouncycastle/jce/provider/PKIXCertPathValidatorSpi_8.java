                            ...
                            if (build.getTargetConstraints() == null || build.getTargetConstraints().match((Certificate) (X509Certificate) certificates.get(0))) {
                                ...
                                while (size2 >= 0) {
                                    ...
                                    try {
                                        ...
                                        int i16 = i10;
                                        boolean z4 = z;
                                        RFC3280CertPathUtilities.processCertA(certPath, build, date, pKIXCertRevocationChecker2, i14, publicKey, z3, x500Name, trustedCert);
                                        int i17 = i14;
                                        ...
                                        if (i12 != i18) {
                                            ...
                                            } else if (i12 != z4 || !x509Certificate2.equals(trustAnchor.getTrustedCert())) {
