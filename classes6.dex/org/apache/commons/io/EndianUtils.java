...
public class EndianUtils {
    public static int swapInteger(int i) {
        return (((i >> 0) & GF2Field.MASK) << 24) + (((i >> 8) & GF2Field.MASK) << 16) + (((i >> 16) & GF2Field.MASK) << 8) + (((i >> 24) & GF2Field.MASK) << 0);
    }
    ...
    public static short swapShort(short s) {
        return (short) ((((s >> 0) & GF2Field.MASK) << 8) + (((s >> 8) & GF2Field.MASK) << 0));
    }
    ...
    public static void writeSwappedShort(byte[] bArr, int i, short s) {
        bArr[i + 0] = (byte) ((s >> 0) & GF2Field.MASK);
        bArr[i + 1] = (byte) ((s >> 8) & GF2Field.MASK);
    }
    ...
    public static void writeSwappedInteger(byte[] bArr, int i, int i2) {
        bArr[i + 0] = (byte) ((i2 >> 0) & GF2Field.MASK);
        bArr[i + 1] = (byte) ((i2 >> 8) & GF2Field.MASK);
        bArr[i + 2] = (byte) ((i2 >> 16) & GF2Field.MASK);
        bArr[i + 3] = (byte) ((i2 >> 24) & GF2Field.MASK);
    }
    ...
    public static long readSwappedUnsignedInteger(byte[] bArr, int i) {
        return (((long) (bArr[i + 3] & 255)) << 24) + (((long) (((bArr[i + 0] & 255) << 0) + ((bArr[i + 1] & 255) << 8) + ((bArr[i + 2] & 255) << Tnaf.POW_2_WIDTH))) & 4294967295L);
    }
    ...
    public static void writeSwappedShort(OutputStream outputStream, short s) throws IOException {
        outputStream.write((byte) ((s >> 0) & GF2Field.MASK));
        outputStream.write((byte) ((s >> 8) & GF2Field.MASK));
    }

    public static short readSwappedShort(InputStream inputStream) throws IOException {
        return (short) (((read(inputStream) & GF2Field.MASK) << 0) + ((read(inputStream) & GF2Field.MASK) << 8));
    }

    public static int readSwappedUnsignedShort(InputStream inputStream) throws IOException {
        return ((read(inputStream) & GF2Field.MASK) << 0) + ((read(inputStream) & GF2Field.MASK) << 8);
    }

    public static void writeSwappedInteger(OutputStream outputStream, int i) throws IOException {
        outputStream.write((byte) ((i >> 0) & GF2Field.MASK));
        outputStream.write((byte) ((i >> 8) & GF2Field.MASK));
        outputStream.write((byte) ((i >> 16) & GF2Field.MASK));
        outputStream.write((byte) ((i >> 24) & GF2Field.MASK));
    }

    public static int readSwappedInteger(InputStream inputStream) throws IOException {
        return ((read(inputStream) & GF2Field.MASK) << 0) + ((read(inputStream) & GF2Field.MASK) << 8) + ((read(inputStream) & GF2Field.MASK) << 16) + ((read(inputStream) & GF2Field.MASK) << 24);
    }
    ...
    public static long readSwappedUnsignedInteger(InputStream inputStream) throws IOException {
        ...
        return (((long) (read(inputStream) & GF2Field.MASK)) << 24) + (((long) (((read & GF2Field.MASK) << 0) + ((read2 & GF2Field.MASK) << 8) + ((read3 & GF2Field.MASK) << 16))) & 4294967295L);
    }
