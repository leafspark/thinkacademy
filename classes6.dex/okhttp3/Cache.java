...
public final class Cache implements Closeable, Flushable {
    ...
    public final File m81deprecated_directory() {
        return this.cache.getDirectory();
    }
        ...
        private final Set<String> varyFields(Headers headers) {
            ...
            for (int i = 0; i < size; i++) {
                if (StringsKt.equals(HttpHeaders.VARY, headers.name(i), true)) {
                    ...
                    for (String str : StringsKt.split$default(value, new char[]{','}, false, 0, 6, (Object) null)) {
                        Objects.requireNonNull(str, "null cannot be cast to non-null type kotlin.CharSequence");
                        set.add(StringsKt.trim(str).toString());
                    }
                }
            }
