...
public final class MultipartReader implements Closeable {
    ...
    public static final Options afterBoundaryOptions = Options.Companion.of(ByteString.Companion.encodeUtf8(IOUtils.LINE_SEPARATOR_WINDOWS), ByteString.Companion.encodeUtf8("--"), ByteString.Companion.encodeUtf8(" "), ByteString.Companion.encodeUtf8("\t"));
    ...
    public final Part nextPart() throws IOException {
        if (!(!this.closed)) {
            ...
            if (this.partCount != 0 || !this.source.rangeEquals(0, this.dashDashBoundary)) {
                while (true) {
                    long currentPartBytesRemaining = currentPartBytesRemaining(IjkMediaMeta.AV_CH_TOP_FRONT_CENTER);
