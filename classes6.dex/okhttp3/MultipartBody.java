...
public final class MultipartBody extends RequestBody {
    ...
    public static final MediaType FORM = MediaType.Companion.get(FileUploadBase.MULTIPART_FORM_DATA);
    public static final MediaType MIXED = MediaType.Companion.get(FileUploadBase.MULTIPART_MIXED);
    ...
    public MultipartBody(ByteString byteString, MediaType mediaType, List<Part> list) {
        ...
        Intrinsics.checkNotNullParameter(mediaType, IjkMediaMeta.IJKM_KEY_TYPE);
    ...
    public final MediaType m151deprecated_type() {
        return this.type;
    }

    @Deprecated(level = DeprecationLevel.ERROR, message = "moved to val", replaceWith = @ReplaceWith(expression = "boundary", imports = {}))
    /* renamed from: -deprecated_boundary  reason: not valid java name */
    public final String m148deprecated_boundary() {
        return boundary();
    }

    @Deprecated(level = DeprecationLevel.ERROR, message = "moved to val", replaceWith = @ReplaceWith(expression = "size", imports = {}))
    /* renamed from: -deprecated_size  reason: not valid java name */
    public final int m150deprecated_size() {
        return size();
    }

    @Deprecated(level = DeprecationLevel.ERROR, message = "moved to val", replaceWith = @ReplaceWith(expression = "parts", imports = {}))
    /* renamed from: -deprecated_parts  reason: not valid java name */
    public final List<Part> m149deprecated_parts() {
        return this.parts;
    }
    ...
    public static final class Part {
        ...
        public final Headers m153deprecated_headers() {
            return this.headers;
        }

        @Deprecated(level = DeprecationLevel.ERROR, message = "moved to val", replaceWith = @ReplaceWith(expression = "body", imports = {}))
        /* renamed from: -deprecated_body  reason: not valid java name */
        public final RequestBody m152deprecated_body() {
            return this.body;
        }
