...
public final class DiskLruCache implements Closeable, Flushable {
    ...
    private final void readJournal() throws java.io.IOException {
        /*
            ...
            boolean r9 = kotlin.jvm.internal.Intrinsics.areEqual(r9, r4)     // Catch:{ all -> 0x00be }
            r10 = 1
            r9 = r9 ^ r10
            if (r9 != 0) goto L_0x008e
            java.lang.String r9 = VERSION_1     // Catch:{ all -> 0x00be }
            boolean r9 = kotlin.jvm.internal.Intrinsics.areEqual(r9, r5)     // Catch:{ all -> 0x00be }
            r9 = r9 ^ r10
            if (r9 != 0) goto L_0x008e
            int r9 = r11.appVersion     // Catch:{ all -> 0x00be }
            java.lang.String r9 = java.lang.String.valueOf(r9)     // Catch:{ all -> 0x00be }
            boolean r6 = kotlin.jvm.internal.Intrinsics.areEqual(r9, r6)     // Catch:{ all -> 0x00be }
            r6 = r6 ^ r10
            if (r6 != 0) goto L_0x008e
            int r6 = r11.valueCount     // Catch:{ all -> 0x00be }
            java.lang.String r6 = java.lang.String.valueOf(r6)     // Catch:{ all -> 0x00be }
            boolean r6 = kotlin.jvm.internal.Intrinsics.areEqual(r6, r7)     // Catch:{ all -> 0x00be }
            r6 = r6 ^ r10
            if (r6 != 0) goto L_0x008e
            r6 = r8
    ...
    private final void readJournalLine(String str) throws IOException {
        ...
        int indexOf$default = StringsKt.indexOf$default(charSequence, TokenParser.SP, 0, false, 6, (Object) null);
        if (indexOf$default != -1) {
            int i = indexOf$default + 1;
            int indexOf$default2 = StringsKt.indexOf$default(charSequence, TokenParser.SP, i, false, 4, (Object) null);
            ...
            if (indexOf$default2 != -1) {
                ...
                if (indexOf$default == str5.length() && StringsKt.startsWith$default(str3, str5, false, 2, (Object) null)) {
                    ...
                    List split$default = StringsKt.split$default(substring, new char[]{TokenParser.SP}, false, 0, 6, (Object) null);
    ...
    public final synchronized void completeEdit$okhttp(okhttp3.internal.cache.DiskLruCache.Editor r9, boolean r10) throws java.io.IOException {
        /*
            ...
            boolean r1 = kotlin.jvm.internal.Intrinsics.areEqual(r1, r9)     // Catch:{ all -> 0x014b }
    ...
    public final class Editor {
        ...
        public final okio.Source newSource(int r5) {
            /*
                ...
                boolean r1 = kotlin.jvm.internal.Intrinsics.areEqual(r1, r3)     // Catch:{ all -> 0x0054 }
                r1 = r1 ^ 1
                if (r1 != 0) goto L_0x0044
                okhttp3.internal.cache.DiskLruCache$Entry r1 = r4.entry     // Catch:{ all -> 0x0054 }
        ...
        public final okio.Sink newSink(int r5) {
            /*
                ...
                boolean r1 = kotlin.jvm.internal.Intrinsics.areEqual(r1, r3)     // Catch:{ all -> 0x0068 }
                r1 = r1 ^ r2
