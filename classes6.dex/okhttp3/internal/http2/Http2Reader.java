...
public final class Http2Reader implements Closeable {
    ...
    public Http2Reader(BufferedSource bufferedSource, boolean z) {
        ...
        this.hpackReader = new Hpack.Reader(continuationSource, _BufferKt.SEGMENTING_THRESHOLD, 0, 4, (DefaultConstructorMarker) null);
    }
    ...
    private final void readHeaders(Handler handler, int i, int i2, int i3) throws IOException {
        if (i3 != 0) {
            ...
            boolean z = (i2 & 1) != 0;
            if ((i2 & 8) != 0) {
                i4 = Util.and(this.source.readByte(), (int) GF2Field.MASK);
            }
            if ((i2 & 32) != 0) {
    ...
    private final void readPriority(Handler handler, int i) throws IOException {
        ...
        handler.priority(i, readInt & Integer.MAX_VALUE, Util.and(this.source.readByte(), (int) GF2Field.MASK) + 1, (((int) IjkMediaMeta.AV_CH_WIDE_LEFT) & readInt) != 0);
    }
