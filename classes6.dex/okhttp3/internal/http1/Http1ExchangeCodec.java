...
public final class Http1ExchangeCodec implements ExchangeCodec {
    ...
    private final boolean isChunked(Response response) {
        return StringsKt.equals(HTTP.CHUNK_CODING, Response.header$default(response, "Transfer-Encoding", (String) null, 2, (Object) null), true);
    }
        ...
        private final void readChunkSize() {
            ...
            try {
                ...
                if (readUtf8LineStrict != null) {
                    ...
                    throw new ProtocolException("expected chunk size and optional extensions" + " but was \"" + this.bytesRemainingInChunk + obj + TokenParser.DQUOTE);
                }
