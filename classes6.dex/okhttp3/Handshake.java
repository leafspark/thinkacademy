...
public final class Handshake {
    ...
    public final TlsVersion m116deprecated_tlsVersion() {
        return this.tlsVersion;
    }
    ...
    public final CipherSuite m111deprecated_cipherSuite() {
        return this.cipherSuite;
    }
    ...
    public final List<Certificate> m114deprecated_peerCertificates() {
    ...
    public final Principal m115deprecated_peerPrincipal() {
    ...
    public final List<Certificate> m112deprecated_localCertificates() {
        return this.localCertificates;
    }
    ...
    public final Principal m113deprecated_localPrincipal() {
    ...
    private final String getName(Certificate certificate) {
        ...
        Intrinsics.checkNotNullExpressionValue(type, IjkMediaMeta.IJKM_KEY_TYPE);
        return type;
    }
    ...
    public static final class Companion {
        ...
        public final Handshake m117deprecated_get(SSLSession sSLSession) throws IOException {
