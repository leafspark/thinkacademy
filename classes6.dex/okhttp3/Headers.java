...
public final class Headers implements Iterable<Pair<? extends String, ? extends String>>, KMappedMarker {
    ...
    public final int m118deprecated_size() {
        return size();
    }
    ...
    public static final class Builder {
        ...
        public final Builder addLenient$okhttp(String str, String str2) {
            ...
            builder.namesAndValues.add(StringsKt.trim(str2).toString());
            return builder;
        }
    ...
    public static final class Companion {
        ...
        public final Headers m120deprecated_of(String... strArr) {
            Intrinsics.checkNotNullParameter(strArr, "namesAndValues");
        ...
        /* renamed from: -deprecated_of  reason: not valid java name */
        public final Headers m119deprecated_of(Map<String, String> map) {
