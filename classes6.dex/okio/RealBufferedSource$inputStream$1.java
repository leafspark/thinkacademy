...
public final class RealBufferedSource$inputStream$1 extends InputStream {
    ...
    public int read() {
        ...
        } else if (this.this$0.bufferField.size() == 0 && this.this$0.source.read(this.this$0.bufferField, (long) Segment.SIZE) == -1) {
            return -1;
        } else {
    ...
    public int read(byte[] bArr, int i, int i2) {
        ...
        if (!this.this$0.closed) {
            ...
            if (this.this$0.bufferField.size() == 0 && this.this$0.source.read(this.this$0.bufferField, (long) Segment.SIZE) == -1) {
                return -1;
            }
