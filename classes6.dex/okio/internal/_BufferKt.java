...
public final class _BufferKt {
    ...
    public static final int commonReadInt(Buffer buffer) {
        ...
        if (buffer.size() >= 4) {
            ...
            int i2 = segment.limit;
            if (((long) (i2 - i)) < 4) {
                return (buffer.readByte() & 255) | ((buffer.readByte() & 255) << 24) | ((buffer.readByte() & 255) << Tnaf.POW_2_WIDTH) | ((buffer.readByte() & 255) << 8);
            }
            byte[] bArr = segment.data;
            int i3 = i + 1;
            int i4 = i3 + 1;
    ...
    public static final okio.Buffer commonWriteDecimalLong(okio.Buffer r12, long r13) {
        ...
        L_0x010e:
            ...
            return r12
        */
        throw new UnsupportedOperationException("Method not decompiled: okio.internal._BufferKt.commonWriteDecimalLong(okio.Buffer, long):okio.Buffer");
    }
    ...
    public static final long commonReadDecimalLong(okio.Buffer r17) {
        ...
        L_0x0094:
            ...
            r1.append(r2)
            java.lang.String r2 = okio._UtilKt.toHexString((byte) r13)
            r1.append(r2)
    ...
    public static final ByteString commonReadByteString(Buffer buffer, long j) {
        ...
        if (!(j >= 0 && j <= ((long) Integer.MAX_VALUE))) {
            ...
            throw new EOFException();
        } else if (j < ((long) SEGMENTING_THRESHOLD)) {
    ...
    public static final long commonWriteAll(Buffer buffer, Source source) {
        ...
        long j = 0;
        while (true) {
            long read = source.read(buffer, (long) Segment.SIZE);
            if (read == -1) {
                return j;
            }
            j += read;
    ...
    public static final int commonSeek(Buffer.UnsafeCursor unsafeCursor, long j) {
        Intrinsics.checkNotNullParameter(unsafeCursor, "$this$commonSeek");
        Buffer buffer = unsafeCursor.buffer;
        if (buffer == null) {
    ...
    public static final long commonResizeBuffer(Buffer.UnsafeCursor unsafeCursor, long j) {
        ...
        long j2 = j;
        Intrinsics.checkNotNullParameter(unsafeCursor2, "$this$commonResizeBuffer");
