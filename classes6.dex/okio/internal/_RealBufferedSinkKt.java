...
public final class _RealBufferedSinkKt {
    ...
    public static final long commonWriteAll(RealBufferedSink realBufferedSink, Source source) {
        ...
        long j = 0;
        while (true) {
            long read = source.read(realBufferedSink.bufferField, (long) Segment.SIZE);
            if (read == -1) {
                return j;
            }
            j += read;
