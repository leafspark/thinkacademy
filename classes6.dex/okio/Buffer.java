...
public final class Buffer implements BufferedSource, BufferedSink, Cloneable, ByteChannel {
    ...
    public final byte m204deprecated_getByte(long j) {
        return getByte(j);
    }

    @Deprecated(level = DeprecationLevel.ERROR, message = "moved to val", replaceWith = @ReplaceWith(expression = "size", imports = {}))
    /* renamed from: -deprecated_size  reason: not valid java name */
    public final long m205deprecated_size() {
        return this.size;
    }

    @Metadata(bv = {1, 0, 3}, d1 = {"\u0000:\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\b\u0002\n\u0002\u0018\u0002\n\u0000\n\u0002\u0010\u0012\n\u0000\n\u0002\u0010\b\n\u0000\n\u0002\u0010\t\n\u0000\n\u0002\u0010\u000b\n\u0000\n\u0002\u0018\u0002\n\u0002\b\u0006\n\u0002\u0010\u0002\n\u0002\b\u0007\u0018\u00002\u00020\u0001B\u0005¢\u0006\u0002\u0010\u0002J\b\u0010\u0014\u001a\u00020\u0015H\u0016J\u000e\u0010\u0016\u001a\u00020\n2\u0006\u0010\u0017\u001a\u00020\bJ\u0006\u0010\u0018\u001a\u00020\bJ\u000e\u0010\u0019\u001a\u00020\n2\u0006\u0010\u001a\u001a\u00020\nJ\u000e\u0010\u001b\u001a\u00020\b2\u0006\u0010\t\u001a\u00020\nR\u0014\u0010\u0003\u001a\u0004\u0018\u00010\u00048\u0006@\u0006X\u000e¢\u0006\u0002\n\u0000R\u0014\u0010\u0005\u001a\u0004\u0018\u00010\u00068\u0006@\u0006X\u000e¢\u0006\u0002\n\u0000R\u0012\u0010\u0007\u001a\u00020\b8\u0006@\u0006X\u000e¢\u0006\u0002\n\u0000R\u0012\u0010\t\u001a\u00020\n8\u0006@\u0006X\u000e¢\u0006\u0002\n\u0000R\u0012\u0010\u000b\u001a\u00020\f8\u0006@\u0006X\u000e¢\u0006\u0002\n\u0000R\u001c\u0010\r\u001a\u0004\u0018\u00010\u000eX\u000e¢\u0006\u000e\n\u0000\u001a\u0004\b\u000f\u0010\u0010\"\u0004\b\u0011\u0010\u0012R\u0012\u0010\u0013\u001a\u00020\b8\u0006@\u0006X\u000e¢\u0006\u0002\n\u0000¨\u0006\u001c"}, d2 = {"Lokio/Buffer$UnsafeCursor;", "Ljava/io/Closeable;", "()V", "buffer", "Lokio/Buffer;", "data", "", "end", "", "offset", "", "readWrite", "", "segment", "Lokio/Segment;", "getSegment$okio", "()Lokio/Segment;", "setSegment$okio", "(Lokio/Segment;)V", "start", "close", "", "expandBuffer", "minByteCount", "next", "resizeBuffer", "newSize", "seek", "okio"}, k = 1, mv = {1, 4, 1})
    /* compiled from: Buffer.kt */
        ...
        public final int seek(long j) {
            ...
            if (buffer2 == null) {
                ...
                if (getSegment$okio() != null) {
                    ...
                    long j4 = j3 - ((long) (i - segment$okio.pos));
                    if (j4 > j) {
    ...
    public long readDecimalLong() throws java.io.EOFException {
        ...
        L_0x008f:
            ...
            r2.append(r3)
            java.lang.String r3 = okio._UtilKt.toHexString((byte) r13)
            r2.append(r3)
    ...
    public ByteString readByteString(long j) throws EOFException {
        if (!(j >= 0 && j <= ((long) Integer.MAX_VALUE))) {
            ...
            throw new EOFException();
        } else if (j < ((long) _BufferKt.SEGMENTING_THRESHOLD)) {
                    ...
                    while (i < i2) {
                        ...
                        if (charAt < 128) {
                            ...
                            if (charAt < 2048) {
                                ...
                                writableSegment$okio2.data[writableSegment$okio2.limit] = (byte) ((charAt >> 6) | BERTags.PRIVATE);
                                ...
                                if (charAt > 56319 || 56320 > c || 57343 < c) {
                                    ...
                                    int i6 = (((charAt & 1023) << 10) | (c & 1023)) + IOUtils.DIR_SEPARATOR;
    ...
    public Buffer writeUtf8CodePoint(int i) {
        if (i < 128) {
            ...
            writableSegment$okio.data[writableSegment$okio.limit] = (byte) ((i >> 6) | BERTags.PRIVATE);
    ...
    public long writeAll(Source source) throws IOException {
        ...
        long j = 0;
        while (true) {
            long read = source.read(this, (long) Segment.SIZE);
            if (read == -1) {
                return j;
            }
            j += read;
    ...
    public okio.Buffer writeDecimalLong(long r13) {
        ...
        L_0x00ee:
            ...
            int r10 = (int) r10
            int r7 = r7 + -1
            byte[] r11 = okio.internal._BufferKt.getHEX_DIGIT_BYTES()
            byte r10 = r11[r10]
            r6[r7] = r10
            long r13 = r13 / r8
            goto L_0x00ee
            ...
            while (j > 0) {
                ...
                if (j < ((long) (i - segment3.pos))) {
                    ...
                    if (segment != null && segment.owner) {
                        if ((((long) segment.limit) + j) - ((long) (segment.shared ? 0 : segment.pos)) <= ((long) Segment.SIZE)) {
