...
final class ChannelsKt__ChannelsKt$trySendBlocking$2 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super ChannelResult<? extends Unit>>, Object> {
    ...
    public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
        Continuation<Unit> channelsKt__ChannelsKt$trySendBlocking$2 = new ChannelsKt__ChannelsKt$trySendBlocking$2(this.$this_trySendBlocking, this.$element, continuation);
        channelsKt__ChannelsKt$trySendBlocking$2.L$0 = obj;
        return (Continuation) channelsKt__ChannelsKt$trySendBlocking$2;
    }
    ...
    public final Object invokeSuspend(Object obj) {
        ...
        if (Result.isSuccess-impl(obj2)) {
            obj3 = ChannelResult.Companion.m27successJP2dKIU(Unit.INSTANCE);
        } else {
            obj3 = ChannelResult.Companion.m25closedJP2dKIU(Result.exceptionOrNull-impl(obj2));
        }
        return ChannelResult.m12boximpl(obj3);
    }
}
