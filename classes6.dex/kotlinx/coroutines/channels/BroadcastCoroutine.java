...
class BroadcastCoroutine<E> extends AbstractCoroutine<Unit> implements ProducerScope<E>, BroadcastChannel<E> {
    ...
    public Object m4trySendJP2dKIU(E e) {
    ...
    public BroadcastCoroutine(CoroutineContext coroutineContext, BroadcastChannel<E> broadcastChannel, boolean z) {
        ...
        initParentJob(coroutineContext.get(Job.Key));
    }

    public boolean isActive() {
        return BroadcastCoroutine.super.isActive();
    }
    ...
    public final /* synthetic */ boolean cancel(Throwable th) {
        if (th == null) {
            ...
            th = new JobCancellationException(JobSupport.access$cancellationExceptionMessage(job), (Throwable) null, job);
        }
        cancelInternal(th);
        return true;
    }
