...
final class LazyActorCoroutine<E> extends ActorCoroutine<E> implements SelectClause2<E, SendChannel<? super E>> {
    ...
    public LazyActorCoroutine(CoroutineContext coroutineContext, Channel<E> channel, Function2<? super ActorScope<E>, ? super Continuation<? super Unit>, ? extends Object> function2) {
        ...
        this.continuation = IntrinsicsKt.createCoroutineUnintercepted(function2, this, (Continuation) this);
    }

    /* access modifiers changed from: protected */
    public void onStart() {
        CancellableKt.startCoroutineCancellable(this.continuation, (Continuation<?>) (Continuation) this);
    }
    ...
    public Object m29trySendJP2dKIU(E e) {
        start();
        return super.m7trySendJP2dKIU(e);
    }
