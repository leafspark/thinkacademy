...
public class ArrayChannel<E> extends AbstractChannel<E> {
    ...
    private final void ensureCapacity(int i) {
        ...
        if (i >= objArr.length) {
            ...
            ArraysKt.fill(objArr2, AbstractChannelKt.EMPTY, i, min);
            this.buffer = objArr2;
            this.head = 0;
        }
    }
     ...
     */
    /* JADX WARNING: Removed duplicated region for block: B:35:0x008e A[Catch:{ all -> 0x00c9 }] */
    /* JADX WARNING: Removed duplicated region for block: B:36:0x009a A[Catch:{ all -> 0x00c9 }] */
    ...
    public java.lang.Object pollSelectInternal(kotlinx.coroutines.selects.SelectInstance<?> r9) {
        /*
            ...
            r0.lock()
            int r1 = r8.size     // Catch:{ all -> 0x00c9 }
            if (r1 != 0) goto L_0x0017
            kotlinx.coroutines.channels.Closed r9 = r8.getClosedForSend()     // Catch:{ all -> 0x00c9 }
            if (r9 != 0) goto L_0x0013
            kotlinx.coroutines.internal.Symbol r9 = kotlinx.coroutines.channels.AbstractChannelKt.POLL_FAILED     // Catch:{ all -> 0x00c9 }
        L_0x0013:
            r0.unlock()
            return r9
        L_0x0017:
            java.lang.Object[] r2 = r8.buffer     // Catch:{ all -> 0x00c9 }
            int r3 = r8.head     // Catch:{ all -> 0x00c9 }
            r4 = r2[r3]     // Catch:{ all -> 0x00c9 }
            r5 = 0
            r2[r3] = r5     // Catch:{ all -> 0x00c9 }
            int r2 = r1 + -1
            r8.size = r2     // Catch:{ all -> 0x00c9 }
            kotlinx.coroutines.internal.Symbol r2 = kotlinx.coroutines.channels.AbstractChannelKt.POLL_FAILED     // Catch:{ all -> 0x00c9 }
            int r3 = r8.capacity     // Catch:{ all -> 0x00c9 }
            r6 = 1
            if (r1 != r3) goto L_0x0085
        L_0x002b:
            kotlinx.coroutines.channels.AbstractChannel$TryPollDesc r3 = r8.describeTryPoll()     // Catch:{ all -> 0x00c9 }
            r7 = r3
            kotlinx.coroutines.internal.AtomicDesc r7 = (kotlinx.coroutines.internal.AtomicDesc) r7     // Catch:{ all -> 0x00c9 }
            java.lang.Object r7 = r9.performAtomicTrySelect(r7)     // Catch:{ all -> 0x00c9 }
            if (r7 != 0) goto L_0x0048
            java.lang.Object r5 = r3.getResult()     // Catch:{ all -> 0x00c9 }
            kotlin.jvm.internal.Intrinsics.checkNotNull(r5)     // Catch:{ all -> 0x00c9 }
            r2 = r5
            kotlinx.coroutines.channels.Send r2 = (kotlinx.coroutines.channels.Send) r2     // Catch:{ all -> 0x00c9 }
            java.lang.Object r2 = r2.getPollResult()     // Catch:{ all -> 0x00c9 }
            r3 = r6
            goto L_0x0086
        L_0x0048:
            kotlinx.coroutines.internal.Symbol r3 = kotlinx.coroutines.channels.AbstractChannelKt.POLL_FAILED     // Catch:{ all -> 0x00c9 }
            if (r7 == r3) goto L_0x0085
            java.lang.Object r3 = kotlinx.coroutines.internal.AtomicKt.RETRY_ATOMIC     // Catch:{ all -> 0x00c9 }
            if (r7 == r3) goto L_0x002b
            java.lang.Object r2 = kotlinx.coroutines.selects.SelectKt.getALREADY_SELECTED()     // Catch:{ all -> 0x00c9 }
            if (r7 != r2) goto L_0x0062
            r8.size = r1     // Catch:{ all -> 0x00c9 }
            java.lang.Object[] r9 = r8.buffer     // Catch:{ all -> 0x00c9 }
            int r1 = r8.head     // Catch:{ all -> 0x00c9 }
            r9[r1] = r4     // Catch:{ all -> 0x00c9 }
            r0.unlock()
            return r7
        L_0x0062:
            boolean r2 = r7 instanceof kotlinx.coroutines.channels.Closed     // Catch:{ all -> 0x00c9 }
            ...
            goto L_0x0086
        L_0x006a:
            java.lang.IllegalStateException r9 = new java.lang.IllegalStateException     // Catch:{ all -> 0x00c9 }
            ...
            r1.append(r7)     // Catch:{ all -> 0x00c9 }
            java.lang.String r1 = r1.toString()     // Catch:{ all -> 0x00c9 }
            java.lang.String r1 = r1.toString()     // Catch:{ all -> 0x00c9 }
            r9.<init>(r1)     // Catch:{ all -> 0x00c9 }
            throw r9     // Catch:{ all -> 0x00c9 }
        L_0x0085:
            r3 = 0
        L_0x0086:
            kotlinx.coroutines.internal.Symbol r7 = kotlinx.coroutines.channels.AbstractChannelKt.POLL_FAILED     // Catch:{ all -> 0x00c9 }
            if (r2 == r7) goto L_0x009a
            boolean r7 = r2 instanceof kotlinx.coroutines.channels.Closed     // Catch:{ all -> 0x00c9 }
            if (r7 != 0) goto L_0x009a
            r8.size = r1     // Catch:{ all -> 0x00c9 }
            java.lang.Object[] r9 = r8.buffer     // Catch:{ all -> 0x00c9 }
            int r7 = r8.head     // Catch:{ all -> 0x00c9 }
            int r7 = r7 + r1
            int r1 = r9.length     // Catch:{ all -> 0x00c9 }
            int r7 = r7 % r1
            r9[r7] = r2     // Catch:{ all -> 0x00c9 }
            goto L_0x00b0
        L_0x009a:
            boolean r9 = r9.trySelect()     // Catch:{ all -> 0x00c9 }
            if (r9 != 0) goto L_0x00b0
            r8.size = r1     // Catch:{ all -> 0x00c9 }
            java.lang.Object[] r9 = r8.buffer     // Catch:{ all -> 0x00c9 }
            int r1 = r8.head     // Catch:{ all -> 0x00c9 }
            r9[r1] = r4     // Catch:{ all -> 0x00c9 }
            java.lang.Object r9 = kotlinx.coroutines.selects.SelectKt.getALREADY_SELECTED()     // Catch:{ all -> 0x00c9 }
            r0.unlock()
            return r9
        L_0x00b0:
            int r9 = r8.head     // Catch:{ all -> 0x00c9 }
            int r9 = r9 + r6
            java.lang.Object[] r1 = r8.buffer     // Catch:{ all -> 0x00c9 }
            int r1 = r1.length     // Catch:{ all -> 0x00c9 }
            int r9 = r9 % r1
            r8.head = r9     // Catch:{ all -> 0x00c9 }
            kotlin.Unit r9 = kotlin.Unit.INSTANCE     // Catch:{ all -> 0x00c9 }
            r0.unlock()
