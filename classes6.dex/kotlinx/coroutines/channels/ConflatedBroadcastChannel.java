...
public final class ConflatedBroadcastChannel<E> implements BroadcastChannel<E> {
    ...
    private final Subscriber<E>[] removeSubscriber(Subscriber<E>[] subscriberArr, Subscriber<E> subscriber) {
        ...
        ArraysKt.copyInto$default(subscriberArr3, subscriberArr4, 0, 0, indexOf, 6, (Object) null);
        ArraysKt.copyInto$default(subscriberArr3, subscriberArr4, indexOf, indexOf + 1, 0, 8, (Object) null);
        return subscriberArr2;
    }
    ...
    public Object m28trySendJP2dKIU(E e) {
        Closed offerInternal = offerInternal(e);
        if (offerInternal != null) {
            return ChannelResult.Companion.m25closedJP2dKIU(offerInternal.getSendException());
        }
