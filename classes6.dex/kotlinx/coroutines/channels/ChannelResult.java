...
public final class ChannelResult<T> {
    ...
    public static final /* synthetic */ ChannelResult m12boximpl(Object obj) {
    ...
    public static boolean m14equalsimpl(Object obj, Object obj2) {
        return (obj2 instanceof ChannelResult) && Intrinsics.areEqual(obj, ((ChannelResult) obj2).m24unboximpl());
    }
    ...
    public static int m19hashCodeimpl(Object obj) {
        if (obj == null) {
            return 0;
        }
        return obj.hashCode();
    ...
    public boolean equals(Object obj) {
        return m14equalsimpl(this.holder, obj);
    }

    public int hashCode() {
        return m19hashCodeimpl(this.holder);
    }
    ...
    public static final T m17getOrNullimpl(Object obj) {
    ...
    public static final T m18getOrThrowimpl(Object obj) {
        if (!(obj instanceof Failed)) {
            return obj;
        }
    ...
    public static final class Companion {
        ...
        public final <E> Object m27successJP2dKIU(E e) {
            return ChannelResult.m13constructorimpl(e);
        }

        /* renamed from: failure-PtdJZtk  reason: not valid java name */
        public final <E> Object m26failurePtdJZtk() {
            return ChannelResult.m13constructorimpl(ChannelResult.failed);
        }

        /* renamed from: closed-JP2dKIU  reason: not valid java name */
        public final <E> Object m25closedJP2dKIU(Throwable th) {
            return ChannelResult.m13constructorimpl(new Closed(th));
        }
    }

    public String toString() {
        return m23toStringimpl(this.holder);
    }
