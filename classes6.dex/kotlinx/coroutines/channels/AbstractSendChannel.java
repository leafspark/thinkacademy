...
public abstract class AbstractSendChannel<E> implements SendChannel<E> {
    ...
    public final Object m3trySendJP2dKIU(E e) {
        Object offerInternal = offerInternal(e);
        if (offerInternal == AbstractChannelKt.OFFER_SUCCESS) {
            return ChannelResult.Companion.m27successJP2dKIU(Unit.INSTANCE);
        }
        if (offerInternal == AbstractChannelKt.OFFER_FAILED) {
            ...
            return ChannelResult.Companion.m25closedJP2dKIU(helpCloseAndGetSendException(closedForSend));
        } else if (offerInternal instanceof Closed) {
            return ChannelResult.Companion.m25closedJP2dKIU(helpCloseAndGetSendException((Closed) offerInternal));
        } else {
    ...
    public final void helpCloseAndResumeWithSendException(Continuation<?> continuation, E e, Closed<?> closed) {
        ...
        if (function1 == null || (callUndeliveredElementCatchingException$default = OnUndeliveredElementKt.callUndeliveredElementCatchingException$default(function1, e, (UndeliveredElementException) null, 2, (Object) null)) == null) {
            ...
            continuation.resumeWith(Result.constructor-impl(ResultKt.createFailure(sendException)));
            return;
        }
    ...
    private final void helpClose(Closed<?> closed) {
        Object r2 = InlineList.m51constructorimpl$default((Object) null, 1, (DefaultConstructorMarker) null);
        while (true) {
            ...
            if (receive == null) {
                ...
                r2 = InlineList.m56plusFjFbRPM(r2, receive);
            }
        }
        if (r2 != null) {
    ...
    public final <R> void registerSelectSend(SelectInstance<? super R> selectInstance, E e, Function2<? super SendChannel<? super E>, ? super Continuation<? super R>, ? extends Object> function2) {
        while (!selectInstance.isSelected()) {
            if (isFullImpl()) {
                DisposableHandle sendSelect = new SendSelect(e, this, selectInstance, function2);
                Object enqueueSend = enqueueSend((Send) sendSelect);
                if (enqueueSend == null) {
        ...
        while (true) {
            if (isFullImpl()) {
                if (this.onUndeliveredElement == null) {
                    sendElement = new SendElement(e, continuation2);
                } else {
                    sendElement = new SendElementWithUndeliveredHandler(e, continuation2, this.onUndeliveredElement);
                }
                Object enqueueSend = enqueueSend(sendElement);
                if (enqueueSend == null) {
                    CancellableContinuationKt.removeOnCancellation(continuation2, sendElement);
                    break;
                } else if (enqueueSend instanceof Closed) {
                    helpCloseAndResumeWithSendException(continuation2, e, (Closed) enqueueSend);
                    break;
                } else if (enqueueSend != AbstractChannelKt.ENQUEUE_FAILED && !(enqueueSend instanceof Receive)) {
            ...
            if (offerInternal == AbstractChannelKt.OFFER_SUCCESS) {
                ...
                if (offerInternal instanceof Closed) {
                    helpCloseAndResumeWithSendException(continuation2, e, (Closed) offerInternal);
                } else {
