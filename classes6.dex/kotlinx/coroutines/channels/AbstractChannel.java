...
public abstract class AbstractChannel<E> extends AbstractSendChannel<E> implements Channel<E> {
    ...
    public final java.lang.Object m1receiveCatchingJP2dKIU(kotlin.coroutines.Continuation<? super kotlinx.coroutines.channels.ChannelResult<? extends E>> r5) {
        /*
            r4 = this;
        ...
        L_0x0032:
            ...
            java.lang.Object r5 = r0.m25closedJP2dKIU(r5)
            goto L_0x0052
        L_0x004c:
            kotlinx.coroutines.channels.ChannelResult$Companion r0 = kotlinx.coroutines.channels.ChannelResult.Companion
            java.lang.Object r5 = r0.m27successJP2dKIU(r5)
        L_0x0052:
            return r5
        L_0x0053:
            r0.label = r3
        ...
        L_0x005c:
            ...
            java.lang.Object r5 = r5.m24unboximpl()
            return r5
        */
        throw new UnsupportedOperationException("Method not decompiled: kotlinx.coroutines.channels.AbstractChannel.m1receiveCatchingJP2dKIU(kotlin.coroutines.Continuation):java.lang.Object");
    }

    /* renamed from: tryReceive-PtdJZtk  reason: not valid java name */
    public final Object m2tryReceivePtdJZtk() {
        Object pollInternal = pollInternal();
        if (pollInternal == AbstractChannelKt.POLL_FAILED) {
            return ChannelResult.Companion.m26failurePtdJZtk();
        }
        if (pollInternal instanceof Closed) {
            return ChannelResult.Companion.m25closedJP2dKIU(((Closed) pollInternal).closeCause);
        }
        return ChannelResult.Companion.m27successJP2dKIU(pollInternal);
    }
    ...
    public void onCancelIdempotent(boolean z) {
        ...
        if (closedForSend != null) {
            Object r0 = InlineList.m51constructorimpl$default((Object) null, 1, (DefaultConstructorMarker) null);
            while (true) {
                LockFreeLinkedListNode prevNode = closedForSend.getPrevNode();
                if (prevNode instanceof LockFreeLinkedListHead) {
                    m0onCancelIdempotentListww6eGU(r0, closedForSend);
                    return;
                    ...
                    r0 = InlineList.m56plusFjFbRPM(r0, (Send) prevNode);
                }
            }
        } else {
    ...
    private final <R> void tryStartBlockUnintercepted(Function2<Object, ? super Continuation<? super R>, ? extends Object> function2, SelectInstance<? super R> selectInstance, int i, Object obj) {
        ...
        if (z) {
            if (i == 0) {
                ...
                UndispatchedKt.startCoroutineUnintercepted(function2, ChannelResult.m12boximpl(ChannelResult.Companion.m25closedJP2dKIU(((Closed) obj).closeCause)), selectInstance.getCompletion());
            }
        } else if (i == 1) {
            ChannelResult.Companion companion = ChannelResult.Companion;
            UndispatchedKt.startCoroutineUnintercepted(function2, ChannelResult.m12boximpl(z ? companion.m25closedJP2dKIU(((Closed) obj).closeCause) : companion.m27successJP2dKIU(obj)), selectInstance.getCompletion());
        } else {
    ...
    private final <R> boolean enqueueReceiveSelect(SelectInstance<? super R> selectInstance, Function2<Object, ? super Continuation<? super R>, ? extends Object> function2, int i) {
        DisposableHandle receiveSelect = new ReceiveSelect(this, selectInstance, function2, i);
        boolean enqueueReceive = enqueueReceive((Receive) receiveSelect);
        if (enqueueReceive) {
    ...
    public final void removeReceiveOnCancel(CancellableContinuation<?> cancellableContinuation, Receive<?> receive) {
        cancellableContinuation.invokeOnCancellation((CancelHandlerBase) new RemoveReceiveOnCancel(receive));
    }
    ...
    private static final class Itr<E> implements ChannelIterator<E> {
        ...
        public final Object hasNextSuspend(Continuation<? super Boolean> continuation) {
            Continuation orCreateCancellableContinuation = CancellableContinuationKt.getOrCreateCancellableContinuation(IntrinsicsKt.intercepted(continuation));
            Continuation continuation2 = (CancellableContinuation) orCreateCancellableContinuation;
            ReceiveHasNext receiveHasNext = new ReceiveHasNext(this, continuation2);
            while (true) {
                Receive receive = receiveHasNext;
                if (this.channel.enqueueReceive(receive)) {
                    this.channel.removeReceiveOnCancel(continuation2, receive);
                    break;
                }
                Object pollInternal = this.channel.pollInternal();
                ...
                if (pollInternal instanceof Closed) {
                    ...
                    if (closed.closeCause == null) {
                        ...
                        continuation2.resumeWith(Result.constructor-impl(ResultKt.createFailure(closed.getReceiveException())));
                    }
                } else if (pollInternal != AbstractChannelKt.POLL_FAILED) {
                    Boolean boxBoolean = Boxing.boxBoolean(true);
                    Function1 function1 = this.channel.onUndeliveredElement;
                    continuation2.resume(boxBoolean, function1 != null ? OnUndeliveredElementKt.bindCancellationFun(function1, pollInternal, continuation2.getContext()) : null);
                }
            }
    ...
    private static class ReceiveElement<E> extends Receive<E> {
        ...
        public final Object resumeValue(E e) {
            return this.receiveMode == 1 ? ChannelResult.m12boximpl(ChannelResult.Companion.m27successJP2dKIU(e)) : e;
        }
        ...
        public void resumeReceiveClosed(Closed<?> closed) {
            if (this.receiveMode == 1) {
                ChannelResult r3 = ChannelResult.m12boximpl(ChannelResult.Companion.m25closedJP2dKIU(closed.closeCause));
                Result.Companion companion = Result.Companion;
                this.cont.resumeWith(Result.constructor-impl(r3));
                return;
            }
            Result.Companion companion2 = Result.Companion;
            this.cont.resumeWith(Result.constructor-impl(ResultKt.createFailure(closed.getReceiveException())));
        }
    ...
    private static final class ReceiveSelect<R, E> extends Receive<E> implements DisposableHandle {
        ...
        public void completeResumeReceive(E e) {
            CancellableKt.startCoroutineCancellable(this.block, this.receiveMode == 1 ? ChannelResult.m12boximpl(ChannelResult.Companion.m27successJP2dKIU(e)) : e, this.select.getCompletion(), resumeOnCancellationFun(e));
        }
        ...
        public void resumeReceiveClosed(Closed<?> closed) {
            if (this.select.trySelect()) {
                ...
                if (i == 0) {
                    ...
                    CancellableKt.startCoroutineCancellable$default(this.block, ChannelResult.m12boximpl(ChannelResult.Companion.m25closedJP2dKIU(closed.closeCause)), this.select.getCompletion(), (Function1) null, 4, (Object) null);
                }
            }
        }
    ...
    public void m0onCancelIdempotentListww6eGU(Object obj, Closed<?> closed) {
        if (obj == null) {
            return;
        }
