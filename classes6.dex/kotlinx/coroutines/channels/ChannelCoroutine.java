...
public class ChannelCoroutine<E> extends AbstractCoroutine<Unit> implements Channel<E> {
    ...
    public Object m5receiveCatchingJP2dKIU(Continuation<? super ChannelResult<? extends E>> continuation) {
        Object r2 = this._channel.m31receiveCatchingJP2dKIU(continuation);
    ...
    public Object m6tryReceivePtdJZtk() {
        return this._channel.m32tryReceivePtdJZtk();
    }

    /* renamed from: trySend-JP2dKIU  reason: not valid java name */
    public Object m7trySendJP2dKIU(E e) {
        return this._channel.m34trySendJP2dKIU(e);
    }
    ...
    public final void cancel(CancellationException cancellationException) {
        if (!isCancelled()) {
            if (cancellationException == null) {
                Job job = (JobSupport) this;
                cancellationException = new JobCancellationException(JobSupport.access$cancellationExceptionMessage(job), (Throwable) null, job);
            }
    ...
    public void cancelInternal(Throwable th) {
        CancellationException cancellationException$default = JobSupport.toCancellationException$default((JobSupport) this, th, (String) null, 1, (Object) null);
    ...
    public /* synthetic */ void cancel() {
        Job job = (JobSupport) this;
        cancelInternal(new JobCancellationException(JobSupport.access$cancellationExceptionMessage(job), (Throwable) null, job));
    }
