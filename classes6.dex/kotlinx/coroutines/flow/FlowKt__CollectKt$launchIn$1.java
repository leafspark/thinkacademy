...
final class FlowKt__CollectKt$launchIn$1 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
    ...
    public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
        return (Continuation) new FlowKt__CollectKt$launchIn$1(this.$this_launchIn, continuation);
    }
    ...
    public final Object invokeSuspend(Object obj) {
        ...
        if (i == 0) {
            ...
            this.label = 1;
            if (FlowKt.collect(this.$this_launchIn, (Continuation) this) == coroutine_suspended) {
