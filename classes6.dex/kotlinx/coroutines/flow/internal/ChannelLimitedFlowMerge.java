...
public final class ChannelLimitedFlowMerge<T> extends ChannelFlow<T> {
    ...
    public /* synthetic */ ChannelLimitedFlowMerge(Iterable iterable, CoroutineContext coroutineContext, int i, BufferOverflow bufferOverflow, int i2, DefaultConstructorMarker defaultConstructorMarker) {
        this(iterable, (i2 & 2) != 0 ? (CoroutineContext) EmptyCoroutineContext.INSTANCE : coroutineContext, (i2 & 4) != 0 ? -2 : i, (i2 & 8) != 0 ? BufferOverflow.SUSPEND : bufferOverflow);
    }
    ...
    public Object collectTo(ProducerScope<? super T> producerScope, Continuation<? super Unit> continuation) {
        ...
        for (Flow<T> channelLimitedFlowMerge$collectTo$2$1 : this.flows) {
            BuildersKt.launch$default((CoroutineScope) producerScope, (CoroutineContext) null, (CoroutineStart) null, new ChannelLimitedFlowMerge$collectTo$2$1(channelLimitedFlowMerge$collectTo$2$1, sendingCollector, (Continuation<? super ChannelLimitedFlowMerge$collectTo$2$1>) null), 3, (Object) null);
        }
