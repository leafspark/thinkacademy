...
public final class FlowKt {
    ...
    public static final <T> Flow<T> m36catch(Flow<? extends T> flow, Function3<? super FlowCollector<? super T>, ? super Throwable, ? super Continuation<? super Unit>, ? extends Object> function3) {
        return FlowKt__ErrorsKt.m43catch(flow, function3);
    }
    ...
    public static final <T> Flow<T> m37debounceHG0u8IE(Flow<? extends T> flow, long j) {
        return FlowKt__DelayKt.m39debounceHG0u8IE(flow, j);
    }
    ...
    public static final <T> Flow<T> m38sampleHG0u8IE(Flow<? extends T> flow, long j) {
        return FlowKt__DelayKt.m40sampleHG0u8IE(flow, j);
    }
