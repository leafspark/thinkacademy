...
final class StateFlowImpl<T> extends AbstractSharedFlow<StateFlowSlot> implements MutableStateFlow<T>, CancellableFlow<T>, FusibleFlow<T> {
    ...
    private final boolean updateState(java.lang.Object r7, java.lang.Object r8) {
        /*
            ...
            boolean r7 = kotlin.jvm.internal.Intrinsics.areEqual(r0, r7)     // Catch:{ all -> 0x005c }
            if (r7 != 0) goto L_0x0011
            monitor-exit(r6)
            return r1
        L_0x0011:
            boolean r7 = kotlin.jvm.internal.Intrinsics.areEqual(r0, r8)     // Catch:{ all -> 0x005c }
            r0 = 1
    ...
    public java.lang.Object collect(kotlinx.coroutines.flow.FlowCollector<? super T> r11, kotlin.coroutines.Continuation<?> r12) {
        ...
        L_0x00a9:
            ...
            kotlinx.coroutines.JobKt.ensureActive(r2)     // Catch:{ all -> 0x0074 }
        L_0x00b0:
            if (r11 == 0) goto L_0x00b8
            boolean r9 = kotlin.jvm.internal.Intrinsics.areEqual(r11, r12)     // Catch:{ all -> 0x0074 }
