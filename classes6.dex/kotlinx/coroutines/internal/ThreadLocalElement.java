...
public final class ThreadLocalElement<T> implements ThreadContextElement<T> {
    ...
    public ThreadLocalElement(T t, ThreadLocal<T> threadLocal2) {
        ...
        this.key = (CoroutineContext.Key) new ThreadLocalKey(threadLocal2);
    }
    ...
    public CoroutineContext minusKey(CoroutineContext.Key<?> key2) {
        return Intrinsics.areEqual(getKey(), key2) ? EmptyCoroutineContext.INSTANCE : (CoroutineContext) this;
    }
