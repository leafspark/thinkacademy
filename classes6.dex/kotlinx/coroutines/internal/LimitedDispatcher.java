...
public final class LimitedDispatcher extends CoroutineDispatcher implements Runnable, Delay {
    ...
    public CoroutineDispatcher limitedParallelism(int i) {
        ...
        return LimitedDispatcher.super.limitedParallelism(i);
    }
    ...
    public void dispatch(CoroutineContext coroutineContext, Runnable runnable) {
        if (!addAndTryDispatching(runnable) && tryAllocateWorker()) {
            this.dispatcher.dispatch((CoroutineContext) this, this);
        }
    }

    public void dispatchYield(CoroutineContext coroutineContext, Runnable runnable) {
        if (!addAndTryDispatching(runnable) && tryAllocateWorker()) {
            this.dispatcher.dispatchYield((CoroutineContext) this, this);
        }
    }
}
