...
public final class LoadingViewBinding implements ViewBinding {
    ...
    private LoadingViewBinding(ConstraintLayout constraintLayout, ArcLoadingView arcLoadingView, ImageView imageView, ImageView imageView2) {
    ...
    public static LoadingViewBinding bind(View view) {
        ...
        if (arcLoadingView != null) {
            ...
            if (imageView != null) {
                ...
                if (imageView2 != null) {
                    return new LoadingViewBinding((ConstraintLayout) view, arcLoadingView, imageView, imageView2);
                }
            }
        }
