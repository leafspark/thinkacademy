...
public final class CrashUtils {
    ...
    public static void init(String str, OnCrashListener onCrashListener) {
        if (!UtilsBridge.isSpace(str)) {
        ...
        } else if (!UtilsBridge.isSDCardEnableByEnvironment() || Utils.getApp().getExternalFilesDir((String) null) == null) {
            ...
            sb2.append(Utils.getApp().getExternalFilesDir((String) null));
