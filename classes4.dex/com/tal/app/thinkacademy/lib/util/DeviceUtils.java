...
public final class DeviceUtils {
    ...
    private static java.lang.String getMacAddressByFile() {
        /*
            ...
            r1 = 0
            com.tal.app.thinkacademy.lib.util.ShellUtils$CommandResult r0 = com.tal.app.thinkacademy.lib.util.UtilsBridge.execCmd(r0, r1)
            int r2 = r0.result
        ...
        L_0x0038:
            ...
            return r0
        */
        throw new UnsupportedOperationException("Method not decompiled: com.tal.app.thinkacademy.lib.util.DeviceUtils.getMacAddressByFile():java.lang.String");
    }
    ...
    public static String getUniqueDeviceId(String str, boolean z) {
        ...
        if (udid == null) {
            synchronized (DeviceUtils.class) {
                if (udid == null) {
                    String string = UtilsBridge.getSpUtils().getString(KEY_UDID, (String) null, true);
                    if (string != null) {
                        udid = string;
                        String str2 = udid;
                        return str2;
    ...
    private static String saveUdid(String str, String str2) {
        ...
        UtilsBridge.getSpUtils().putString(KEY_UDID, udid, true);
        return udid;
    }
