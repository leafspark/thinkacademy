...
public class ArrayUtils {
    ...
    public static <T> T[] subArray(T[] tArr, int i, int i2) {
        return (Object[]) realSubArray(tArr, i, i2);
    }
    ...
    public static <T> T[] add(T[] tArr, T t) {
        return (Object[]) realAddOne(tArr, t, tArr != null ? tArr.getClass() : t != null ? t.getClass() : Object.class);
    }
    ...
    public static <T> T[] add(T[] tArr, int i, T[] tArr2) {
        ...
        return (Object[]) realAddArr(tArr, i, tArr2, cls);
    }
    ...
    public static <T> T[] add(T[] tArr, int i, T t) {
        ...
        return (Object[]) realAdd(tArr, i, t, cls);
    }
