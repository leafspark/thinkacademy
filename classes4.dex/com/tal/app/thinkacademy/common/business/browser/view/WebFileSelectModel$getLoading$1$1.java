...
final class WebFileSelectModel$getLoading$1$1 extends Lambda implements Function0<Unit> {
    final /* synthetic */ WebFileSelectModel this$0;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    WebFileSelectModel$getLoading$1$1(WebFileSelectModel webFileSelectModel) {
        super(0);
