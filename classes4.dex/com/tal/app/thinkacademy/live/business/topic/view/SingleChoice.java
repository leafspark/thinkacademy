...
public class SingleChoice implements IQuestion, RadioGroup.OnCheckedChangeListener {
    private List<String> answer = new ArrayList();
    private Context context;
    private ISelected listener;
    private List<List<String>> userAnswers = new ArrayList();

    public SingleChoice(Context context2, ISelected iSelected) {
    ...
    public void onCheckedChanged(RadioGroup radioGroup, int i) {
        ...
        this.answer.add(((RadioButton) radioGroup.findViewById(i)).getText().toString());
