...
public final class LiveBusinessViewMediaControllerLiveTopPhoneBinding implements ViewBinding {
    ...
    private LiveBusinessViewMediaControllerLiveTopPhoneBinding(LinearLayout linearLayout, ImageView imageView, ImageView imageView2, ImageView imageView3, ImageView imageView4, ImageView imageView5, ImageView imageView6, ImageView imageView7, ImageView imageView8, RelativeLayout relativeLayout, LinearLayout linearLayout2, RoundTextView roundTextView, TextView textView) {
    ...
    public static LiveBusinessViewMediaControllerLiveTopPhoneBinding inflate(LayoutInflater layoutInflater) {
        return inflate(layoutInflater, (ViewGroup) null, false);
    }

    public static LiveBusinessViewMediaControllerLiveTopPhoneBinding inflate(LayoutInflater layoutInflater, ViewGroup viewGroup, boolean z) {
        int i = R.layout.live_business_view_media_controller_live_top_phone;
    ...
    public static LiveBusinessViewMediaControllerLiveTopPhoneBinding bind(View view) {
        View view2 = view;
                                    ...
                                    if (imageView8 != null) {
                                        ...
                                        if (relativeLayout != null) {
                                            ...
                                            if (findChildViewById != null) {
                                                ...
                                                if (textView != null) {
                                                    return new LiveBusinessViewMediaControllerLiveTopPhoneBinding(linearLayout, imageView, imageView2, imageView3, imageView4, imageView5, imageView6, imageView7, imageView8, relativeLayout, linearLayout, findChildViewById, textView);
                                                }
                                            }
                                        }
                                    }
