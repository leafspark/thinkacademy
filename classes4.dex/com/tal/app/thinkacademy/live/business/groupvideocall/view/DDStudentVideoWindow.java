...
import com.tal.app.thinkacademy.live.business.databinding.LiveBusinessDdstudentVideoBinding;
...
@Metadata(d1 = {"\u0000V\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0010\b\n\u0002\b\u0007\n\u0002\u0010\u0015\n\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0010\u0002\n\u0000\n\u0002\u0018\u0002\n\u0002\b\u0002\n\u0002\u0010\u000b\n\u0002\b\u0006\n\u0002\u0018\u0002\n\u0002\b\u0002\n\u0002\u0010\u000e\n\u0002\b\u0005\u0018\u00002\u00020\u0001B%\b\u0007\u0012\u0006\u0010\u0002\u001a\u00020\u0003\u0012\n\b\u0002\u0010\u0004\u001a\u0004\u0018\u00010\u0005\u0012\b\b\u0002\u0010\u0006\u001a\u00020\u0007¢\u0006\u0002\u0010\bJ\u0010\u0010\u0014\u001a\u00020\u00152\u0006\u0010\u0016\u001a\u00020\u0017H\u0016J\u0010\u0010\u0018\u001a\u00020\u00152\u0006\u0010\u0019\u001a\u00020\u001aH\u0016J\b\u0010\u001b\u001a\u00020\u0015H\u0016J\u0010\u0010\u001c\u001a\u00020\u00152\u0006\u0010\u001d\u001a\u00020\u001aH\u0016J\u0010\u0010\u001e\u001a\u00020\u00152\u0006\u0010\u0016\u001a\u00020\u0017H\u0016J\u0012\u0010\u001f\u001a\u00020\u00152\b\u0010 \u001a\u0004\u0018\u00010!H\u0016J\u0010\u0010\"\u001a\u00020\u00152\u0006\u0010#\u001a\u00020$H\u0016J\u0010\u0010%\u001a\u00020\u00152\u0006\u0010&\u001a\u00020\u0007H\u0016J\u0010\u0010'\u001a\u00020\u00152\u0006\u0010(\u001a\u00020\u0007H\u0016R\u000e\u0010\t\u001a\u00020\u0007XD¢\u0006\u0002\n\u0000R\u000e\u0010\n\u001a\u00020\u0007XD¢\u0006\u0002\n\u0000R\u000e\u0010\u000b\u001a\u00020\u0007XD¢\u0006\u0002\n\u0000R\u000e\u0010\f\u001a\u00020\u0007XD¢\u0006\u0002\n\u0000R\u000e\u0010\r\u001a\u00020\u0007XD¢\u0006\u0002\n\u0000R\u000e\u0010\u000e\u001a\u00020\u000fX\u000e¢\u0006\u0002\n\u0000R\u0014\u0010\u0010\u001a\u0004\u0018\u00010\u00118\u0002@\u0002X\u000e¢\u0006\u0002\n\u0000R\u000e\u0010\u0012\u001a\u00020\u0013X\u000e¢\u0006\u0002\n\u0000¨\u0006)"}, d2 = {"Lcom/tal/app/thinkacademy/live/business/groupvideocall/view/DDStudentVideoWindow;", "Lcom/tal/app/thinkacademy/live/business/groupvideocall/view/BaseVideoWindow;", "context", "Landroid/content/Context;", "attrs", "Landroid/util/AttributeSet;", "defStyleAttr", "", "(Landroid/content/Context;Landroid/util/AttributeSet;I)V", "KCloseFace", "KCloseMic", "KUpdateMic", "KVideoGone", "KVideoShow", "levelIcons", "", "mHandler", "Landroid/os/Handler;", "mViewBinding", "Lcom/tal/app/thinkacademy/live/business/databinding/LiveBusinessDdstudentVideoBinding;", "addCoin", "", "student", "Lcom/tal/app/thinkacademy/live/business/groupvideocall/VideoCallBean;", "authPen", "show", "", "release", "remotefirstVideoRecvWithUid", "isShow", "setStudentInform", "setSurfaceView", "surfaceView", "Landroid/view/TextureView;", "showFace", "emojiString", "", "updateLevel", "level", "updateMic", "volume", "bus_livebusiness_release"}, k = 1, mv = {1, 6, 0}, xi = 48)
/* compiled from: DDStudentVideoWindow.kt */
public final class DDStudentVideoWindow extends BaseVideoWindow {
    ...
    /* access modifiers changed from: private */
    public LiveBusinessDdstudentVideoBinding mViewBinding;

    /* JADX INFO: this call moved to the top of the method (can break code semantics) */
    public DDStudentVideoWindow(Context context) {
        this(context, (AttributeSet) null, 0, 6, (DefaultConstructorMarker) null);
        Intrinsics.checkNotNullParameter(context, "context");
    }

    /* JADX INFO: this call moved to the top of the method (can break code semantics) */
    public DDStudentVideoWindow(Context context, AttributeSet attributeSet) {
        this(context, attributeSet, 0, 4, (DefaultConstructorMarker) null);
        Intrinsics.checkNotNullParameter(context, "context");
    }

    /* JADX INFO: this call moved to the top of the method (can break code semantics) */
    public /* synthetic */ DDStudentVideoWindow(Context context, AttributeSet attributeSet, int i, int i2, DefaultConstructorMarker defaultConstructorMarker) {
        this(context, (i2 & 2) != 0 ? null : attributeSet, (i2 & 4) != 0 ? 0 : i);
    }

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    public DDStudentVideoWindow(Context context, AttributeSet attributeSet, int i) {
        ...
        LiveBusinessDdstudentVideoBinding inflate = LiveBusinessDdstudentVideoBinding.inflate(LayoutInflater.from(context), this, true);
        Intrinsics.checkNotNullExpressionValue(inflate, "inflate(LayoutInflater.from(context), this, true)");
        this.mViewBinding = inflate;
        this.mHandler = new DDStudentVideoWindow$mHandler$1(this, Looper.getMainLooper());
    }
    ...
    public void setStudentInform(VideoCallBean videoCallBean) {
        ...
        RoundTextView roundTextView = this.mViewBinding.tvNickName;
        if (roundTextView != null) {
            roundTextView.setText(videoCallBean.getNickName());
        }
        ...
        if (addCoin != null) {
            ...
            if (intValue == 5) {
                ...
                if (lottieAnimationView6 != null) {
                    lottieAnimationView6.addAnimatorListener(new DDStudentVideoWindow$addCoin$1$1(this));
                }
            } else if (intValue == 10) {
                ...
                if (lottieAnimationView12 != null) {
                    lottieAnimationView12.addAnimatorListener(new DDStudentVideoWindow$addCoin$1$2(this));
                }
            }
        }
    }
    ...
    public void showFace(String str) {
        ...
        EmojiView emojiView = this.mViewBinding.emojiView;
        if (emojiView != null) {
            EmojiView.setData$default(emojiView, str, (Boolean) null, new DDStudentVideoWindow$showFace$1(this), 2, (Object) null);
        }
        EmojiView emojiView2 = this.mViewBinding.emojiView;
        if (emojiView2 != null) {
