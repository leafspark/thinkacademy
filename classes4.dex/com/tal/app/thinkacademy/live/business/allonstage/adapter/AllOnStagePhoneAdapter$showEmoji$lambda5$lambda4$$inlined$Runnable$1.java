...
/* renamed from: com.tal.app.thinkacademy.live.business.allonstage.adapter.AllOnStagePhoneAdapter$showEmoji$lambda-5$lambda-4$$inlined$Runnable$1  reason: invalid class name */
/* compiled from: Runnable.kt */
public final class AllOnStagePhoneAdapter$showEmoji$lambda5$lambda4$$inlined$Runnable$1 implements Runnable {
    ...
    public AllOnStagePhoneAdapter$showEmoji$lambda5$lambda4$$inlined$Runnable$1(StudentVideoBean.ListBean listBean, AllOnStagePhoneAdapter allOnStagePhoneAdapter, Integer num) {
    ...
    public final void run() {
        this.$item$inlined.setShowEmoji(false);
        ...
        this.this$0.mEmojiRunnableMap.remove(this.$pos$inlined);
    }
}
