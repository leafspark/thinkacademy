...
final class AllOnStagePluginViewPhone$showMicControlView$1$1 extends Lambda implements Function1<Type, Unit> {
    final /* synthetic */ AllOnStagePluginViewPhone this$0;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    AllOnStagePluginViewPhone$showMicControlView$1$1(AllOnStagePluginViewPhone allOnStagePluginViewPhone) {
        super(1);
    ...
    public final void invoke(Type type) {
        ...
        if (mRtcViewModel != null) {
            mRtcViewModel.enableLocalAudio(true);
        }
    }
}
