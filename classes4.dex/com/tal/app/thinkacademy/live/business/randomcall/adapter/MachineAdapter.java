package com.tal.app.thinkacademy.live.business.randomcall.adapter;
...
public class MachineAdapter extends RecyclerView.Adapter<UserViewHolder> {
    ...
    public MachineAdapter(Context context2, List<RandomCallBean.Student> list) {
    ...
    public UserViewHolder onCreateViewHolder(ViewGroup viewGroup, int i) {
        ...
        if (PadUtils.isPad(this.context)) {
            ...
            int i2 = R.layout.live_business_random_call_item_pad;
            ...
            int i3 = R.layout.live_business_random_call_item_phone;
    ...
    public void onBindViewHolder(UserViewHolder userViewHolder, int i) {
        ...
        userViewHolder.tv_item_name.setText(this.students.get(size).getName());
