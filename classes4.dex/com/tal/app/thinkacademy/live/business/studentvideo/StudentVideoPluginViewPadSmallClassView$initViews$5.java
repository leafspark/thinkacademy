...
final class StudentVideoPluginViewPadSmallClassView$initViews$5 extends Lambda implements Function0<Unit> {
    final /* synthetic */ StudentVideoPluginViewPadSmallClassView this$0;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    StudentVideoPluginViewPadSmallClassView$initViews$5(StudentVideoPluginViewPadSmallClassView studentVideoPluginViewPadSmallClassView) {
        super(0);
        this.this$0 = studentVideoPluginViewPadSmallClassView;
    }

    public final void invoke() {
        StudentVideoBean.ListBean access$getBean3$p = this.this$0.bean3;
        if (access$getBean3$p != null) {
            StudentVideoPluginViewPadSmallClassView studentVideoPluginViewPadSmallClassView = this.this$0;
            access$getBean3$p.setOtherShowHeadBg(!access$getBean3$p.isOtherShowHeadBg());
            access$getBean3$p.setHerselfOff(!access$getBean3$p.isHerselfOff());
            ...
            if (studentVideoPluginDriver != null) {
                studentVideoPluginDriver.updateSmallClassStudent(access$getBean3$p);
            }
        }
    }
}
