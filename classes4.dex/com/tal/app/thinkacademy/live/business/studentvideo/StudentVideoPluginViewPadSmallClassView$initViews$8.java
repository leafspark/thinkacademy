...
final class StudentVideoPluginViewPadSmallClassView$initViews$8 extends Lambda implements Function0<Unit> {
    final /* synthetic */ StudentVideoPluginViewPadSmallClassView this$0;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    StudentVideoPluginViewPadSmallClassView$initViews$8(StudentVideoPluginViewPadSmallClassView studentVideoPluginViewPadSmallClassView) {
        super(0);
        this.this$0 = studentVideoPluginViewPadSmallClassView;
    }

    public final void invoke() {
        StudentVideoBean.ListBean access$getBean6$p = this.this$0.bean6;
        if (access$getBean6$p != null) {
            StudentVideoPluginViewPadSmallClassView studentVideoPluginViewPadSmallClassView = this.this$0;
            access$getBean6$p.setOtherShowHeadBg(!access$getBean6$p.isOtherShowHeadBg());
            access$getBean6$p.setHerselfOff(!access$getBean6$p.isHerselfOff());
            ...
            if (studentVideoPluginDriver != null) {
                studentVideoPluginDriver.updateSmallClassStudent(access$getBean6$p);
            }
        }
    }
}
