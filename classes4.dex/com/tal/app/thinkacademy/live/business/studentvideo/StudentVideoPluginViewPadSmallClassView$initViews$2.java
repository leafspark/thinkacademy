...
final class StudentVideoPluginViewPadSmallClassView$initViews$2 extends Lambda implements Function0<Unit> {
    final /* synthetic */ StudentVideoPluginViewPadSmallClassView this$0;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    StudentVideoPluginViewPadSmallClassView$initViews$2(StudentVideoPluginViewPadSmallClassView studentVideoPluginViewPadSmallClassView) {
        super(0);
    ...
    public final void invoke() {
        ...
        if (this.this$0.mCurrentPage > this.this$0.mMaxPage) {
            StudentVideoPluginViewPadSmallClassView studentVideoPluginViewPadSmallClassView2 = this.this$0;
            studentVideoPluginViewPadSmallClassView2.mCurrentPage = studentVideoPluginViewPadSmallClassView2.mMaxPage;
            return;
        }
