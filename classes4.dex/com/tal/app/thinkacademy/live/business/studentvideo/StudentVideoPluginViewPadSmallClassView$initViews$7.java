...
final class StudentVideoPluginViewPadSmallClassView$initViews$7 extends Lambda implements Function0<Unit> {
    final /* synthetic */ StudentVideoPluginViewPadSmallClassView this$0;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    StudentVideoPluginViewPadSmallClassView$initViews$7(StudentVideoPluginViewPadSmallClassView studentVideoPluginViewPadSmallClassView) {
        super(0);
        this.this$0 = studentVideoPluginViewPadSmallClassView;
    }

    public final void invoke() {
        StudentVideoBean.ListBean access$getBean5$p = this.this$0.bean5;
        if (access$getBean5$p != null) {
            StudentVideoPluginViewPadSmallClassView studentVideoPluginViewPadSmallClassView = this.this$0;
            access$getBean5$p.setOtherShowHeadBg(!access$getBean5$p.isOtherShowHeadBg());
            access$getBean5$p.setHerselfOff(!access$getBean5$p.isHerselfOff());
            ...
            if (studentVideoPluginDriver != null) {
                studentVideoPluginDriver.updateSmallClassStudent(access$getBean5$p);
            }
        }
    }
}
