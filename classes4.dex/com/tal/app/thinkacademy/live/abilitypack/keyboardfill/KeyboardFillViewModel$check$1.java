...
final class KeyboardFillViewModel$check$1 extends Lambda implements Function2<Integer, String, Unit> {
    final /* synthetic */ CheckScene $scene;
    final /* synthetic */ KeyboardFillViewModel this$0;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    KeyboardFillViewModel$check$1(KeyboardFillViewModel keyboardFillViewModel, CheckScene checkScene) {
        super(2);
    ...
    public final void invoke(int i, String str) {
        ...
        mListenerData.postStickyData(new KeyboardFillListenerBody.CheckError(i, str, this.$scene));
    }
}
