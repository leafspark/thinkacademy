...
public final class RtcViewModel$requestCheckStudentUpdate$1 extends OmyCallback<HiResponse<List<? extends StudentVideoBean.ListBean>>> {
    ...
    public void onSuccess(HiResponse<List<StudentVideoBean.ListBean>> hiResponse) {
        ...
        XesLog.i(RtcViewModel.TAG, "RtcViewModel 检测学生是否更新，请求列表成功！！！");
        if (hiResponse.successful()) {
            this.this$0.updateStudentsData(hiResponse);
        }
