...
public final class Logger {
    ...
    public static class LoggerTags {
        public static final String SdkTag = "CoreSdk";
    }
    ...
    public static StringBuffer getMemoryLogData() {
        for (LogAdapter next : printer.getLogAdapters()) {
            if (next instanceof MemoryLogAdapter) {
                return ((MemoryLogAdapter) next).getData();
            }
        }
