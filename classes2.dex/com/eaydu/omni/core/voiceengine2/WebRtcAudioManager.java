package com.eaydu.omni.core.voiceengine2;
...
public class WebRtcAudioManager {
    ...
    private static class VolumeLogger {
        ...
        public void start() {
            ...
            this.timer = timer2;
            timer2.schedule(new LogVolumeTask(this.audioManager.getStreamMaxVolume(2), this.audioManager.getStreamMaxVolume(0)), 0, GTJobService.WAIT_TIME);
        }
    ...
    WebRtcAudioManager(long j) {
        ...
        AudioManager audioManager2 = (AudioManager) ContextUtils.getApplicationContext().getSystemService(PictureMimeType.MIME_TYPE_PREFIX_AUDIO);
        this.audioManager = audioManager2;
