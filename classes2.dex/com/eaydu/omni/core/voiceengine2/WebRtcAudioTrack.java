...
import com.eaydu.omni.core.utils.ThreadUtils;
...
public class WebRtcAudioTrack {
    ...
    private final AudioManager audioManager = ((AudioManager) ContextUtils.getApplicationContext().getSystemService(PictureMimeType.MIME_TYPE_PREFIX_AUDIO));
