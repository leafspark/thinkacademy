...
public final class EglCore {
    ...
    public EglCore(EGLContext eGLContext, int i) {
        ...
        if (this.mEGLDisplay == EGL14.EGL_NO_DISPLAY) {
            LogD("Receive sharedContext obj : " + eGLContext);
            eGLContext = eGLContext == null ? EGL14.EGL_NO_CONTEXT : eGLContext;
            EGLDisplay eglGetDisplay = EGL14.eglGetDisplay(0);
            this.mEGLDisplay = eglGetDisplay;
            if (eglGetDisplay != EGL14.EGL_NO_DISPLAY) {
                LogD("Get EGLDisplay obj : " + this.mEGLDisplay);
                int[] iArr = new int[2];
                if (EGL14.eglInitialize(this.mEGLDisplay, iArr, 0, iArr, 1)) {
                    if (i == 2 && (config = getConfig(i, 3)) != null) {
                    ...
                    OmniLog.d("OPEN_GL", "EGLContext created, client version " + iArr2[0]);
                    return;
                }
    ...
    private EGLConfig getConfig(int i, int i2) {
        ...
        OmniLog.w("OPEN_GL", "unable to find RGB8888 / " + i2 + " EGLConfig");
        return null;
    }
    ...
    public void finalize() throws Throwable {
        try {
            if (this.mEGLDisplay != EGL14.EGL_NO_DISPLAY) {
                OmniLog.w("OPEN_GL", "WARNING: EglCore was not explicitly released -- state may be leaked");
                release();
            }
        } finally {
            super.finalize();
    ...
    public void makeCurrent(EGLSurface eGLSurface) {
        if (this.mEGLDisplay == EGL14.EGL_NO_DISPLAY) {
            OmniLog.d("OPEN_GL", "NOTE: makeCurrent w/o display");
        }
    ...
    public static void logCurrent(String str) {
        ...
        OmniLog.i("OPEN_GL", "Current EGL (" + str + "): display=" + eglGetCurrentDisplay + ", context=" + eglGetCurrentContext + ", surface=" + eglGetCurrentSurface);
    }
    ...
    private void LogD(String str) {
        OmniLog.d("OPEN_GL", "EglCore -> " + str);
    }

    private void LogE(String str) {
        OmniLog.e("OPEN_GL", "EglCore -> " + str);
    }
}
