...
import com.eaydu.omni.net.okhttp3.internal.cache.CacheRequest;
import com.eaydu.omni.net.okhttp3.internal.cache.CacheStrategy;
import com.eaydu.omni.net.okhttp3.internal.cache.DiskLruCache;
...
public final class Cache implements Closeable, Flushable {
    ...
    public CacheRequest put(Response response) {
        ...
        if (HttpMethod.invalidatesCache(response.request().method())) {
            ...
            return null;
        } else if (!method.equals(IHttpAdapter.METHOD_GET) || HttpHeaders.hasVaryAll(response)) {
            return null;
        } else {
