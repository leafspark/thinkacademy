...
class Huffman {
    ...
    static {
        ...
        iArr[255] = 67108846;
        CODES = iArr;
        byte[] bArr = new byte[WebViewRouteChangeEvent.ROUTE_CHANGE_String_LIMIT];
        // fill-array-data instruction
        bArr[0] = 13;
        bArr[1] = 23;
        bArr[2] = 28;
    ...
    public void encode(com.eaydu.omni.net.okio.ByteString r8, com.eaydu.omni.net.okio.BufferedSink r9) throws java.io.IOException {
        /*
            r7 = this;
            r0 = 0
            r1 = 0
        ...
        L_0x003b:
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: com.eaydu.omni.net.okhttp3.internal.http2.Huffman.encode(com.eaydu.omni.net.okio.ByteString, com.eaydu.omni.net.okio.BufferedSink):void");
    }
    ...
    private static final class Node {
        ...
        Node() {
            this.children = new Node[WebViewRouteChangeEvent.ROUTE_CHANGE_String_LIMIT];
            this.symbol = 0;
            this.terminalBits = 0;
        }
