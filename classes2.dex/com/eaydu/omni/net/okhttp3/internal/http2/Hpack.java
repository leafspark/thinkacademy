...
final class Hpack {
    ...
    static final Header[] STATIC_HEADER_TABLE = {new Header(Header.TARGET_AUTHORITY, ""), new Header(Header.TARGET_METHOD, (String) IHttpAdapter.METHOD_GET), new Header(Header.TARGET_METHOD, (String) IHttpAdapter.METHOD_POST), new Header(Header.TARGET_PATH, "/"), new Header(Header.TARGET_PATH, "/index.html"), new Header(Header.TARGET_SCHEME, "http"), new Header(Header.TARGET_SCHEME, (String) DefaultNavigatorAdapter.SCHEME_HTTPS), new Header(Header.RESPONSE_STATUS, "200"), new Header(Header.RESPONSE_STATUS, "204"), new Header(Header.RESPONSE_STATUS, "206"), new Header(Header.RESPONSE_STATUS, "304"), new Header(Header.RESPONSE_STATUS, "400"), new Header(Header.RESPONSE_STATUS, "404"), new Header(Header.RESPONSE_STATUS, "500"), new Header("accept-charset", ""), new Header("accept-encoding", "gzip, deflate"), new Header("accept-language", ""), new Header("accept-ranges", ""), new Header("accept", ""), new Header("access-control-allow-origin", ""), new Header("age", ""), new Header("allow", ""), new Header("authorization", ""), new Header("cache-control", ""), new Header("content-disposition", ""), new Header("content-encoding", ""), new Header("content-language", ""), new Header("content-length", ""), new Header("content-location", ""), new Header("content-range", ""), new Header((String) DefaultHttpAdapter.CONTENT_TYPE, ""), new Header("cookie", ""), new Header("date", ""), new Header("etag", ""), new Header("expect", ""), new Header("expires", ""), new Header((String) Constants.MessagePayloadKeys.FROM, ""), new Header("host", ""), new Header("if-match", ""), new Header("if-modified-since", ""), new Header("if-none-match", ""), new Header("if-range", ""), new Header("if-unmodified-since", ""), new Header("last-modified", ""), new Header("link", ""), new Header((String) FirebaseAnalytics.Param.LOCATION, ""), new Header("max-forwards", ""), new Header("proxy-authenticate", ""), new Header("proxy-authorization", ""), new Header("range", ""), new Header("referer", ""), new Header("refresh", ""), new Header("retry-after", ""), new Header("server", ""), new Header("set-cookie", ""), new Header("strict-transport-security", ""), new Header("transfer-encoding", ""), new Header("user-agent", ""), new Header("vary", ""), new Header("via", ""), new Header("www-authenticate", "")};
    ...
    static final class Writer {
        ...
        public void writeHeaders(java.util.List<com.eaydu.omni.net.okhttp3.internal.http2.Header> r14) throws java.io.IOException {
            /*
                r13 = this;
            ...
            L_0x0023:
                ...
                com.eaydu.omni.net.okhttp3.internal.http2.Header r3 = (com.eaydu.omni.net.okhttp3.internal.http2.Header) r3
                com.eaydu.omni.net.okio.ByteString r4 = r3.name
                com.eaydu.omni.net.okio.ByteString r4 = r4.toAsciiLowercase()
                com.eaydu.omni.net.okio.ByteString r5 = r3.value
                java.util.Map<com.eaydu.omni.net.okio.ByteString, java.lang.Integer> r6 = com.eaydu.omni.net.okhttp3.internal.http2.Hpack.NAME_TO_FIRST_INDEX
                ...
                com.eaydu.omni.net.okhttp3.internal.http2.Header[] r9 = com.eaydu.omni.net.okhttp3.internal.http2.Hpack.STATIC_HEADER_TABLE
                int r10 = r6 + -1
                r9 = r9[r10]
                com.eaydu.omni.net.okio.ByteString r9 = r9.value
                boolean r9 = com.eaydu.omni.net.okhttp3.internal.Util.equal(r9, r5)
            ...
            L_0x0070:
                ...
                int r10 = r10 + r8
                com.eaydu.omni.net.okhttp3.internal.http2.Header[] r8 = r13.dynamicTable
                int r8 = r8.length
            L_0x0078:
                if (r10 >= r8) goto L_0x00a7
                com.eaydu.omni.net.okhttp3.internal.http2.Header[] r11 = r13.dynamicTable
                r11 = r11[r10]
                com.eaydu.omni.net.okio.ByteString r11 = r11.name
                boolean r11 = com.eaydu.omni.net.okhttp3.internal.Util.equal(r11, r4)
                if (r11 == 0) goto L_0x00a4
                com.eaydu.omni.net.okhttp3.internal.http2.Header[] r11 = r13.dynamicTable
                r11 = r11[r10]
                com.eaydu.omni.net.okio.ByteString r11 = r11.value
                boolean r11 = com.eaydu.omni.net.okhttp3.internal.Util.equal(r11, r5)
                if (r11 == 0) goto L_0x009a
                int r6 = r13.nextHeaderIndex
                int r10 = r10 - r6
                com.eaydu.omni.net.okhttp3.internal.http2.Header[] r6 = com.eaydu.omni.net.okhttp3.internal.http2.Hpack.STATIC_HEADER_TABLE
                int r6 = r6.length
                int r6 = r6 + r10
                goto L_0x00a7
            L_0x009a:
                ...
                int r9 = r10 - r9
                com.eaydu.omni.net.okhttp3.internal.http2.Header[] r11 = com.eaydu.omni.net.okhttp3.internal.http2.Hpack.STATIC_HEADER_TABLE
                int r11 = r11.length
                int r9 = r9 + r11
            L_0x00a4:
                int r10 = r10 + 1
            ...
            L_0x00b1:
                ...
                com.eaydu.omni.net.okio.Buffer r7 = r13.out
                r7.writeByte((int) r6)
                ...
                goto L_0x00e8
            L_0x00c4:
                com.eaydu.omni.net.okio.ByteString r7 = com.eaydu.omni.net.okhttp3.internal.http2.Header.PSEUDO_PREFIX
                boolean r7 = r4.startsWith((com.eaydu.omni.net.okio.ByteString) r7)
                if (r7 == 0) goto L_0x00dd
                com.eaydu.omni.net.okio.ByteString r7 = com.eaydu.omni.net.okhttp3.internal.http2.Header.TARGET_AUTHORITY
            ...
            L_0x00ec:
                return
            */
            throw new UnsupportedOperationException("Method not decompiled: com.eaydu.omni.net.okhttp3.internal.http2.Hpack.Writer.writeHeaders(java.util.List):void");
        }
