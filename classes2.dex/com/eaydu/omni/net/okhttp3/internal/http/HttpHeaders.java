...
import com.eaydu.omni.net.okhttp3.Challenge;
import com.eaydu.omni.net.okhttp3.Cookie;
import com.eaydu.omni.net.okhttp3.CookieJar;
...
public final class HttpHeaders {
    ...
    public static boolean hasBody(Response response) {
        if (response.request().method().equals(IHttpAdapter.METHOD_HEAD)) {
            return false;
        }
