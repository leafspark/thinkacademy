...
import com.eaydu.omni.net.okhttp3.CertificatePinner;
...
import com.eaydu.omni.net.okhttp3.internal.connection.RouteException;
import com.eaydu.omni.net.okhttp3.internal.connection.StreamAllocation;
import com.eaydu.omni.net.okhttp3.internal.http2.ConnectionShutdownException;
    ...
    private Request followUpRequest(Response response, Route route) throws IOException {
        ...
        if (response != null) {
            ...
            if (code == 307 || code == 308) {
                if (!method.equals(IHttpAdapter.METHOD_GET) && !method.equals(IHttpAdapter.METHOD_HEAD)) {
                    return null;
                }
            } else if (code == 401) {
            ...
            if (HttpMethod.permitsRequestBody(method)) {
                ...
                if (HttpMethod.redirectsToGet(method)) {
                    newBuilder.method(IHttpAdapter.METHOD_GET, (RequestBody) null);
                } else {
