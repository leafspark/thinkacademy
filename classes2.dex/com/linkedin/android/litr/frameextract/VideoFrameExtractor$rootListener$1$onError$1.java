...
final class VideoFrameExtractor$rootListener$1$onError$1 extends Lambda implements Function1<FrameExtractListener, Unit> {
    ...
    VideoFrameExtractor$rootListener$1$onError$1(VideoFrameExtractor$rootListener$1 videoFrameExtractor$rootListener$1, String str, long j, Throwable th) {
        super(1);
    ...
    public final void invoke(FrameExtractListener frameExtractListener) {
        ...
        frameExtractListener.onError(this.$id, this.$timestampUs, this.$cause);
    }
}
