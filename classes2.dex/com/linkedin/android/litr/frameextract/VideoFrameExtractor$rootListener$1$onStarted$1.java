...
final class VideoFrameExtractor$rootListener$1$onStarted$1 extends Lambda implements Function1<FrameExtractListener, Unit> {
    final /* synthetic */ String $id;
    final /* synthetic */ long $timestampUs;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    VideoFrameExtractor$rootListener$1$onStarted$1(String str, long j) {
        super(1);
        this.$id = str;
        this.$timestampUs = j;
    }
    ...
    public final void invoke(FrameExtractListener frameExtractListener) {
        ...
        frameExtractListener.onStarted(this.$id, this.$timestampUs);
    }
}
