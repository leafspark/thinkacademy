...
public class Uniform4fv extends ShaderParameter {
    ...
    public Uniform4fv(String str, int i, float[] fArr) {
        this(str, i, FloatBuffer.wrap(fArr));
    }

    public Uniform4fv(String str, int i, FloatBuffer floatBuffer) {
        super(0, str);
        this.count = i;
    ...
    public void apply(int i) {
        GLES20.glUniform4fv(getLocation(i), this.count, this.buffer);
    }
}
