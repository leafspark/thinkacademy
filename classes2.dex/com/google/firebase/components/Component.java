...
public final class Component<T> {
    ...
    public static <T> Component<T> of(Class<T> cls, T t) {
        return builder(cls).factory(new Component$$ExternalSyntheticLambda1(t)).build();
    }

    @SafeVarargs
    public static <T> Component<T> of(T t, Class<T> cls, Class<? super T>... clsArr) {
        return builder(cls, clsArr).factory(new Component$$ExternalSyntheticLambda2(t)).build();
    }
