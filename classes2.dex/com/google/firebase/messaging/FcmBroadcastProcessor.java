...
public class FcmBroadcastProcessor {
    ...
    static /* synthetic */ Task lambda$startMessagingService$2(Context context2, Intent intent, Task task) throws Exception {
        return (!PlatformVersion.isAtLeastO() || ((Integer) task.getResult()).intValue() != 402) ? task : bindToMessagingService(context2, intent).continueWith(FcmBroadcastProcessor$$ExternalSyntheticLambda4.INSTANCE, FcmBroadcastProcessor$$ExternalSyntheticLambda2.INSTANCE);
    }
