...
public class FirebaseMessaging {
    ...
    private class AutoInit {
        ...
        public /* synthetic */ void m15lambda$initialize$0$comgooglefirebasemessagingFirebaseMessaging$AutoInit(Event event) {
            if (isEnabled()) {
    ...
    public /* synthetic */ Task m7lambda$blockingGetToken$8$comgooglefirebasemessagingFirebaseMessaging(String str, Store.Token token, String str2) throws Exception {
    ...
    public /* synthetic */ Task m8lambda$blockingGetToken$9$comgooglefirebasemessagingFirebaseMessaging(String str, Store.Token token) {
    ...
    public /* synthetic */ void m9lambda$deleteToken$4$comgooglefirebasemessagingFirebaseMessaging(TaskCompletionSource taskCompletionSource) {
        try {
    ...
    public /* synthetic */ void m10lambda$deleteToken$5$comgooglefirebasemessagingFirebaseMessaging(TaskCompletionSource taskCompletionSource) {
        try {
    ...
    public /* synthetic */ void m11lambda$getToken$3$comgooglefirebasemessagingFirebaseMessaging(TaskCompletionSource taskCompletionSource) {
        try {
    ...
    public /* synthetic */ void m13lambda$new$1$comgooglefirebasemessagingFirebaseMessaging(TopicsSubscriber topicsSubscriber) {
        if (isAutoInitEnabled()) {
    ...
    public /* synthetic */ void m14lambda$new$2$comgooglefirebasemessagingFirebaseMessaging() {
    ...
    public void send(RemoteMessage remoteMessage) {
        if (!TextUtils.isEmpty(remoteMessage.getTo())) {
            ...
            PushAutoTrackHelper.hookIntentGetBroadcast(context2, 0, intent2, i);
            PendingIntent broadcast = PendingIntent.getBroadcast(context2, 0, intent2, i);
            PushAutoTrackHelper.hookPendingIntentGetBroadcast(broadcast, context2, 0, intent2, i);
    ...
    public Task<Void> subscribeToTopic(String str) {
        return this.topicsSubscriberTask.onSuccessTask(new FirebaseMessaging$$ExternalSyntheticLambda2(str));
    }
    ...
    public Task<Void> unsubscribeFromTopic(String str) {
        return this.topicsSubscriberTask.onSuccessTask(new FirebaseMessaging$$ExternalSyntheticLambda3(str));
    }
