...
final class zzt {
    ...
    public final zzfk zza(int i) {
        ...
        zzgc zzf2 = zzgd.zzf();
        zzf2.zzb(zzkr.zzr(this.zze));
        zzf2.zzd(zzkr.zzr(this.zzf));
        Map map = this.zzg;
        if (map == null) {
            arrayList = null;
        } else {
    ...
    public final void zzc(zzx zzx) {
        ...
        if (zzx.zzg != null) {
            ...
            zzoa.zzc();
            if (this.zza.zzs.zzf().zzs(this.zzb, zzdu.zzW) && zzx.zzb()) {
                list.clear();
            }
            zzoa.zzc();
            if (this.zza.zzs.zzf().zzs(this.zzb, zzdu.zzW)) {
