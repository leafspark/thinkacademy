...
final class zzfn extends Thread {
        ...
        synchronized (this.zza.zzh) {
            if (!this.zzd) {
                ...
                if (this == zzfo.zzb) {
                    ...
                    zzfo.zzs.zzay().zzd().zza("Current scheduler thread is neither worker nor network");
                }
                this.zzd = true;
            }
        }
    ...
    public final void run() {
        ...
        L_0x0002:
            ...
            com.google.android.gms.measurement.internal.zzfo r2 = r6.zza     // Catch:{ InterruptedException -> 0x000f }
        ...
        L_0x001c:
            java.util.concurrent.BlockingQueue r2 = r6.zzc     // Catch:{ all -> 0x0082 }
            java.lang.Object r2 = r2.poll()     // Catch:{ all -> 0x0082 }
            com.google.android.gms.measurement.internal.zzfm r2 = (com.google.android.gms.measurement.internal.zzfm) r2     // Catch:{ all -> 0x0082 }
        ...
        L_0x0035:
            ...
            java.util.concurrent.BlockingQueue r3 = r6.zzc     // Catch:{ all -> 0x007f }
            java.lang.Object r3 = r3.peek()     // Catch:{ all -> 0x007f }
            if (r3 != 0) goto L_0x0051
            com.google.android.gms.measurement.internal.zzfo r3 = r6.zza     // Catch:{ all -> 0x007f }
        ...
        L_0x0051:
            ...
            com.google.android.gms.measurement.internal.zzfo r2 = r6.zza     // Catch:{ all -> 0x0082 }
            java.lang.Object r2 = r2.zzh     // Catch:{ all -> 0x0082 }
            monitor-enter(r2)     // Catch:{ all -> 0x0082 }
            java.util.concurrent.BlockingQueue r3 = r6.zzc     // Catch:{ all -> 0x007c }
            java.lang.Object r3 = r3.peek()     // Catch:{ all -> 0x007c }
            if (r3 != 0) goto L_0x007a
            com.google.android.gms.measurement.internal.zzfo r0 = r6.zza     // Catch:{ all -> 0x007c }
            com.google.android.gms.measurement.internal.zzfr r0 = r0.zzs     // Catch:{ all -> 0x007c }
            com.google.android.gms.measurement.internal.zzaf r0 = r0.zzf()     // Catch:{ all -> 0x007c }
            com.google.android.gms.measurement.internal.zzdt r1 = com.google.android.gms.measurement.internal.zzdu.zzae     // Catch:{ all -> 0x007c }
            r3 = 0
        ...
        L_0x0082:
            ...
            throw r0
        */
        throw new UnsupportedOperationException("Method not decompiled: com.google.android.gms.measurement.internal.zzfn.run():void");
    }
