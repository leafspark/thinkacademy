...
public final class zzkw extends zzgl {
    ...
    public static ArrayList zzG(List list) {
        ...
        while (it.hasNext()) {
            ...
            zzgn.zzb(bundle, Preconditions.checkNotNull(zzab.zzc.zza()));
    ...
    public static void zzJ(zzid zzid, Bundle bundle, boolean z) {
        if (!(bundle == null || zzid == null)) {
    ...
    private final int zzaq(String str) {
        if ("_ldl".equals(str)) {
            ...
            this.zzs.zzf();
            return WebViewRouteChangeEvent.ROUTE_CHANGE_String_LIMIT;
    ...
    public final Object zzA(String str, Object obj) {
        ...
        int i = WebViewRouteChangeEvent.ROUTE_CHANGE_String_LIMIT;
        if (equals) {
            this.zzs.zzf();
            return zzar(WebViewRouteChangeEvent.ROUTE_CHANGE_String_LIMIT, obj, true, true);
        }
        if (zzag(str)) {
            this.zzs.zzf();
        } else {
    ...
    public final URL zzD(long j, String str, String str2, long j2) {
        try {
            ...
            Preconditions.checkNotEmpty(str);
            String format = String.format("https://www.googleadservices.com/pagead/conversion/app/deeplink?id_type=adid&sdk_version=%s&rdid=%s&bundleid=%s&retry=%s", new Object[]{String.format("v%s.%s", new Object[]{55005L, Integer.valueOf(zzm())}), str2, str, Long.valueOf(j2)});
    ...
    /* access modifiers changed from: package-private */
    public final void zzL(zzei zzei, int i) {
        int i2 = 0;
        for (String str : new TreeSet(zzei.zzd.keySet())) {
            if (zzah(str) && (i2 = i2 + 1) > i) {
                ...
                sb.append(i);
                sb.append(" params");
                this.zzs.zzay().zze().zzc(sb.toString(), this.zzs.zzj().zzd(zzei.zza), this.zzs.zzj().zzb(zzei.zzd));
                zzao(zzei.zzd, 5);
                zzei.zzd.remove(str);
            }
        }
    ...
    /* access modifiers changed from: package-private */
    public final void zzM(zzkv zzkv, String str, int i, String str2, String str3, int i2) {
        Bundle bundle = new Bundle();
        zzao(bundle, i);
    ...
    public final void zzP(zzcf zzcf, ArrayList arrayList) {
        Bundle bundle = new Bundle();
    ...
    /* access modifiers changed from: package-private */
    public final void zzV(String str, String str2, String str3, Bundle bundle, List list, boolean z) {
        int i;
        String str4;
        int i2;
        String str5 = str2;
            ...
            for (String str6 : new TreeSet(bundle.keySet())) {
                ...
                if (i != 0) {
                    ...
                    if (i2 != 0 && !"_ev".equals(str4)) {
                        ...
                        bundle2.remove(str4);
                    } else if (zzah(str4) && !zzas(str4, zzgp.zzd) && (i3 = i3 + 1) > 0) {
    ...
    public final int zza(java.lang.String r15, java.lang.String r16, java.lang.String r17, java.lang.Object r18, android.os.Bundle r19, java.util.List r20, boolean r21, boolean r22) {
        ...
        L_0x0022:
            ...
            com.google.android.gms.measurement.internal.zzjk r2 = r2.zzt()
            r2.zzg()
            r2.zza()
            boolean r6 = r2.zzN()
        ...
        L_0x0060:
            ...
            com.google.android.gms.measurement.internal.zzfr r10 = r7.zzs
            ...
            com.google.android.gms.measurement.internal.zzfr r6 = r7.zzs
            r6.zzf()
        ...
        L_0x00ad:
            ...
            com.google.android.gms.measurement.internal.zzdt r2 = com.google.android.gms.measurement.internal.zzdu.zzR
            r10 = r15
    ...
    public final int zzl(String str) {
        ...
        if (!zzY("user property", zzgq.zza, (String[]) null, str)) {
            return 15;
        }
        this.zzs.zzf();
    ...
    public final int zzm() {
        if (this.zzg == null) {
            this.zzg = Integer.valueOf(GoogleApiAvailabilityLight.getInstance().getApkVersion(this.zzs.zzau()) / ResultCode.KARAOKE_SUCCESS);
        }
    ...
    public final android.os.Bundle zzs(android.net.Uri r11, boolean r12) {
        ...
        L_0x0128:
            ...
            com.google.android.gms.measurement.internal.zzef r12 = r12.zzk()
    ...
    /* JADX WARNING: Removed duplicated region for block: B:47:0x010c A[SYNTHETIC] */
    /* Code decompiled incorrectly, please refer to instructions dump. */
    public final android.os.Bundle zzy(java.lang.String r21, java.lang.String r22, android.os.Bundle r23, java.util.List r24, boolean r25) {
        ...
        L_0x00c0:
            ...
            r1.append(r2)
            com.google.android.gms.measurement.internal.zzfr r2 = r9.zzs
            ...
            com.google.android.gms.measurement.internal.zzfr r3 = r9.zzs
            com.google.android.gms.measurement.internal.zzec r3 = r3.zzj()
            java.lang.String r3 = r3.zzd(r10)
            com.google.android.gms.measurement.internal.zzfr r4 = r9.zzs
    ...
    public final zzau zzz(String str, String str2, Bundle bundle, String str3, long j, boolean z, boolean z2) {
        ...
        if (zzh(str2) == 0) {
            ...
            return new zzau(str2, new zzas(zzy), str3, j);
        }
