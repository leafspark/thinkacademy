...
class zzlx extends AbstractMap {
    ...
    private final int zzk(Comparable comparable) {
        ...
        while (i <= size) {
            int i2 = (i + size) / 2;
            int compareTo2 = comparable.compareTo(((zzlu) this.zzb.get(i2)).zza());
            if (compareTo2 < 0) {
                size = i2 - 1;
    ...
    public final Object get(Object obj) {
        ...
        if (zzk >= 0) {
            return ((zzlu) this.zzb.get(zzk)).getValue();
        }
    ...
    public final Object put(Comparable comparable, Object obj) {
        ...
        int i2 = this.zza;
        if (size == i2) {
            zzlu zzlu = (zzlu) this.zzb.remove(i2 - 1);
            zzm().put(zzlu.zza(), zzlu.getValue());
        }
