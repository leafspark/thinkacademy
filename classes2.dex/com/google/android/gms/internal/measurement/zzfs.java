...
public final class zzfs extends zzjx implements zzld {
    ...
    static /* synthetic */ void zzs(zzfs zzfs, Iterable iterable) {
        zzfs.zzz();
        zzih.zzbo(iterable, zzfs.zzk);
    }

    private final void zzz() {
        zzke zzke = this.zzk;
        if (!zzke.zzc()) {
            this.zzk = zzjx.zzbz(zzke);
        }
    }
    ...
    public final Object zzl(int i, Object obj, Object obj2) {
        ...
        if (i2 == 2) {
            return zzbD(zza, "\u0001\u0006\u0000\u0001\u0001\u0006\u0006\u0000\u0001\u0000\u0001ဈ\u0000\u0002ဈ\u0001\u0003ဂ\u0002\u0004ခ\u0003\u0005က\u0004\u0006\u001b", new Object[]{"zze", "zzf", "zzg", "zzh", "zzi", "zzj", "zzk", zzfs.class});
        } else if (i2 == 3) {
            return new zzfs();
        } else {
            if (i2 == 4) {
