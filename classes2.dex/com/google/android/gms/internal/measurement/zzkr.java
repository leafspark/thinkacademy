...
final class zzkr extends zzii implements RandomAccess, zzkd, zzlj {
    private static final zzkr zza;
    private long[] zzb;
    private int zzc;

    static {
        zzkr zzkr = new zzkr(new long[0], 0);
        zza = zzkr;
        zzkr.zzb();
    }
    ...
    public final boolean addAll(Collection collection) {
        ...
        if (Integer.MAX_VALUE - i2 >= i) {
            ...
            System.arraycopy(zzkr.zzb, 0, this.zzb, this.zzc, zzkr.zzc);
            this.zzc = i3;
            this.modCount++;
            return true;
        }
