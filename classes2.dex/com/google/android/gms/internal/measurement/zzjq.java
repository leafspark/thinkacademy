...
final class zzjq extends zzii implements RandomAccess, zzke, zzlj {
    private static final zzjq zza;
    private float[] zzb;
    private int zzc;

    static {
        zzjq zzjq = new zzjq(new float[0], 0);
        zza = zzjq;
        zzjq.zzb();
    }
    ...
    public final boolean addAll(Collection collection) {
        ...
        if (Integer.MAX_VALUE - i2 >= i) {
            ...
            System.arraycopy(zzjq.zzb, 0, this.zzb, this.zzc, zzjq.zzc);
            this.zzc = i3;
            this.modCount++;
            return true;
        }
