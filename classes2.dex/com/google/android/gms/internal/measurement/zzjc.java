...
final class zzjc extends zzje {
    ...
    public final void zze(int i, zzix zzix) throws IOException {
        zzq((i << 3) | 2);
        zzq(zzix.zzd());
        zzix.zzh(this);
    }
    ...
    public final void zzg(int i) throws IOException {
        try {
            ...
            throw new zzjd(String.format("Pos: %d, limit: %d, len: %d", new Object[]{Integer.valueOf(this.zzd), Integer.valueOf(this.zzc), 1}), e);
        }
    }
    ...
    public final void zzn(String str) throws IOException {
        ...
        try {
            ...
            if (zzA2 == zzA) {
                int i2 = i + zzA2;
                this.zzd = i2;
                int zzb2 = zzmq.zzb(str, this.zzb, i2, this.zzc - i2);
                this.zzd = i;
                zzq((zzb2 - i) - zzA2);
                this.zzd = zzb2;
                return;
    ...
    public final void zzc(byte[] bArr, int i, int i2) throws IOException {
        try {
            ...
            throw new zzjd(String.format("Pos: %d, limit: %d, len: %d", new Object[]{Integer.valueOf(this.zzd), Integer.valueOf(this.zzc), Integer.valueOf(i2)}), e);
        }
    }
    ...
    public final void zzs(long j) throws IOException {
        if (!zzje.zzc || this.zzc - this.zzd < 10) {
            ...
            while ((j & -128) != 0) {
                ...
                int i3 = this.zzd;
                this.zzd = i3 + 1;
                zzml.zzn(bArr3, (long) i3, (byte) ((((int) j) & 127) | 128));
                j >>>= 7;
            }
            byte[] bArr4 = this.zzb;
            int i4 = this.zzd;
            this.zzd = i4 + 1;
            zzml.zzn(bArr4, (long) i4, (byte) ((int) j));
        }
    }
}
