...
final class zzjo {
    ...
    private static final void zzd(zzjn zzjn, Object obj) {
        boolean z;
        zzmr zzb2 = zzjn.zzb();
        zzkf.zze(obj);
        ...
        throw new IllegalArgumentException(String.format("Wrong object type used with protocol message reflection.\nField number: %d, field java type: %s, value type: %s\n", new Object[]{Integer.valueOf(zzjn.zza()), zzjn.zzb().zza(), obj.getClass().getName()}));
    }
    ...
    public final /* bridge */ /* synthetic */ Object clone() throws CloneNotSupportedException {
        ...
        for (Map.Entry entry : this.zza.zzc()) {
            zzjo.zzc((zzjn) entry.getKey(), entry.getValue());
        }
        zzjo.zzd = this.zzd;
        return zzjo;
    }
    ...
    public final void zzc(zzjn zzjn, Object obj) {
        if (!zzjn.zzc()) {
            zzd(zzjn, obj);
