...
public final class zzd extends Fragment implements LifecycleFragment {
    ...
    public static zzd zzc(FragmentActivity fragmentActivity) {
        ...
        try {
            zzd findFragmentByTag = fragmentActivity.getSupportFragmentManager().findFragmentByTag("SupportLifecycleFragmentImpl");
            if (findFragmentByTag == null || findFragmentByTag.isRemoving()) {
                findFragmentByTag = new zzd();
            ...
            weakHashMap.put(fragmentActivity, new WeakReference(findFragmentByTag));
