...
public class SQLiteEventStore implements EventStore, SynchronizationGuard {
    ...
    public PersistedEvent persist(TransportContext transportContext, EventInternal eventInternal) {
        ...
        long longValue = ((Long) inTransaction(new SQLiteEventStore$$ExternalSyntheticLambda13(this, transportContext, eventInternal))).longValue();
        if (longValue < 1) {
            return null;
        }
    ...
    public /* synthetic */ Long lambda$persist$1$SQLiteEventStore(TransportContext transportContext, EventInternal eventInternal, SQLiteDatabase sQLiteDatabase) {
        ...
        contentValues.put(AssistPushConsts.MSG_TYPE_PAYLOAD, z ? bytes : new byte[0]);
    ...
    private Long getTransportContextId(SQLiteDatabase sQLiteDatabase, TransportContext transportContext) {
        ...
        return (Long) tryWithCursor(sQLiteDatabase.query("transport_contexts", new String[]{"_id"}, sb.toString(), (String[]) arrayList.toArray(new String[0]), (String) null, (String) null, (String) null), SQLiteEventStore$$ExternalSyntheticLambda18.INSTANCE);
    }
    ...
    public void recordFailure(Iterable<PersistedEvent> iterable) {
        if (iterable.iterator().hasNext()) {
            inTransaction(new SQLiteEventStore$$ExternalSyntheticLambda15("UPDATE events SET num_attempts = num_attempts + 1 WHERE _id in " + toIdList(iterable)));
        }
    }
    ...
    public /* synthetic */ Boolean lambda$hasPendingEventsFor$5$SQLiteEventStore(TransportContext transportContext, SQLiteDatabase sQLiteDatabase) {
        ...
        return (Boolean) tryWithCursor(getDb().rawQuery("SELECT 1 FROM events WHERE context_id = ? LIMIT 1", new String[]{transportContextId.toString()}), SQLiteEventStore$$ExternalSyntheticLambda3.INSTANCE);
    }

    public void recordNextCallTime(TransportContext transportContext, long j) {
        inTransaction(new SQLiteEventStore$$ExternalSyntheticLambda10(j, transportContext));
    }
    ...
    static /* synthetic */ List lambda$loadActiveContexts$9(SQLiteDatabase sQLiteDatabase) {
        return (List) tryWithCursor(sQLiteDatabase.rawQuery("SELECT distinct t._id, t.backend_name, t.priority, t.extras FROM transport_contexts AS t, events AS e WHERE e.context_id = t._id", new String[0]), SQLiteEventStore$$ExternalSyntheticLambda1.INSTANCE);
    }
    ...
    private List<PersistedEvent> loadEvents(SQLiteDatabase sQLiteDatabase, TransportContext transportContext) {
        ...
        tryWithCursor(sQLiteDatabase2.query("events", new String[]{"_id", "transport_name", "timestamp_ms", "uptime_ms", "payload_encoding", AssistPushConsts.MSG_TYPE_PAYLOAD, "code", "inline"}, "context_id = ?", new String[]{transportContextId.toString()}, (String) null, (String) null, (String) null, String.valueOf(this.config.getLoadBatchSize())), new SQLiteEventStore$$ExternalSyntheticLambda14(this, arrayList, transportContext));
        return arrayList;
    }
    ...
    private byte[] readPayload(long j) {
        return (byte[]) tryWithCursor(getDb().query("event_payloads", new String[]{"bytes"}, "event_id = ?", new String[]{String.valueOf(j)}, (String) null, (String) null, "sequence_num"), SQLiteEventStore$$ExternalSyntheticLambda2.INSTANCE);
    }
    ...
    private Map<Long, Set<Metadata>> loadMetadata(SQLiteDatabase sQLiteDatabase, List<PersistedEvent> list) {
        ...
        sb.append(')');
        tryWithCursor(sQLiteDatabase.query("event_metadata", new String[]{"event_id", AppMeasurementSdk.ConditionalUserProperty.NAME, "value"}, sb.toString(), (String[]) null, (String) null, (String) null, (String) null), new SQLiteEventStore$$ExternalSyntheticLambda16(hashMap));
        return hashMap;
    }
    ...
    private void ensureBeginTransaction(SQLiteDatabase sQLiteDatabase) {
        retryIfDbLocked(new SQLiteEventStore$$ExternalSyntheticLambda8(sQLiteDatabase), SQLiteEventStore$$ExternalSyntheticLambda6.INSTANCE);
    }
