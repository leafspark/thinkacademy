...
public class Uploader {
    ...
    public void upload(TransportContext transportContext, int i, Runnable runnable) {
        this.executor.execute(new Uploader$$ExternalSyntheticLambda4(this, transportContext, i, runnable));
    }
    ...
    public void logAndUpdateState(TransportContext transportContext, int i) {
        ...
        Iterable<PersistedEvent> iterable = (Iterable) this.guard.runCriticalSection(new Uploader$$ExternalSyntheticLambda0(this, transportContext));
        if (iterable.iterator().hasNext()) {
            ...
            this.guard.runCriticalSection(new Uploader$$ExternalSyntheticLambda2(this, send, iterable, transportContext, i));
        }
    }
