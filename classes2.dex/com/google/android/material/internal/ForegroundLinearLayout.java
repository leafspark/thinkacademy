...
public class ForegroundLinearLayout extends LinearLayoutCompat {
    ...
    public boolean verifyDrawable(Drawable drawable) {
        return ForegroundLinearLayout.super.verifyDrawable(drawable) || drawable == this.foreground;
    }
    ...
    public void onLayout(boolean z, int i, int i2, int i3, int i4) {
        ForegroundLinearLayout.super.onLayout(z, i, i2, i3, i4);
        this.foregroundBoundsChanged = z | this.foregroundBoundsChanged;
    }

    /* access modifiers changed from: protected */
    public void onSizeChanged(int i, int i2, int i3, int i4) {
        ForegroundLinearLayout.super.onSizeChanged(i, i2, i3, i4);
    ...
    public void drawableHotspotChanged(float f, float f2) {
        ForegroundLinearLayout.super.drawableHotspotChanged(f, f2);
        Drawable drawable = this.foreground;
        if (drawable != null) {
