...
public class MaterialButton extends AppCompatButton implements Checkable, Shapeable {
    ...
    public void onInitializeAccessibilityNodeInfo(AccessibilityNodeInfo accessibilityNodeInfo) {
        MaterialButton.super.onInitializeAccessibilityNodeInfo(accessibilityNodeInfo);
    ...
    public void onInitializeAccessibilityEvent(AccessibilityEvent accessibilityEvent) {
        MaterialButton.super.onInitializeAccessibilityEvent(accessibilityEvent);
        accessibilityEvent.setClassName(getA11yClassName());
        accessibilityEvent.setChecked(isChecked());
    }

    /* JADX WARNING: type inference failed for: r1v0, types: [android.os.Parcelable, com.google.android.material.button.MaterialButton$SavedState] */
    public Parcelable onSaveInstanceState() {
        ? savedState = new SavedState(MaterialButton.super.onSaveInstanceState());
    ...
    public void onRestoreInstanceState(Parcelable parcelable) {
        if (!(parcelable instanceof SavedState)) {
            MaterialButton.super.onRestoreInstanceState(parcelable);
            return;
        }
        SavedState savedState = (SavedState) parcelable;
        MaterialButton.super.onRestoreInstanceState(savedState.getSuperState());
    ...
    public void setSupportBackgroundTintList(ColorStateList colorStateList) {
        if (isUsingOriginalBackground()) {
            ...
            MaterialButton.super.setSupportBackgroundTintList(colorStateList);
        }
    }
    ...
    public ColorStateList getSupportBackgroundTintList() {
        ...
        return MaterialButton.super.getSupportBackgroundTintList();
    }
    ...
    public void setSupportBackgroundTintMode(PorterDuff.Mode mode) {
        if (isUsingOriginalBackground()) {
            ...
            MaterialButton.super.setSupportBackgroundTintMode(mode);
        }
    }
    ...
    public PorterDuff.Mode getSupportBackgroundTintMode() {
        ...
        return MaterialButton.super.getSupportBackgroundTintMode();
    }
    ...
    public void setBackgroundColor(int i) {
        if (isUsingOriginalBackground()) {
            ...
            MaterialButton.super.setBackgroundColor(i);
        }
    }
    ...
    public void setBackgroundDrawable(Drawable drawable) {
        if (!isUsingOriginalBackground()) {
            MaterialButton.super.setBackgroundDrawable(drawable);
    ...
    public void onLayout(boolean z, int i, int i2, int i3, int i4) {
        ...
        MaterialButton.super.onLayout(z, i, i2, i3, i4);
    ...
    public void onSizeChanged(int i, int i2, int i3, int i4) {
        MaterialButton.super.onSizeChanged(i, i2, i3, i4);
        updateIconPosition(i, i2);
    }

    /* access modifiers changed from: protected */
    public void onTextChanged(CharSequence charSequence, int i, int i2, int i3) {
        MaterialButton.super.onTextChanged(charSequence, i, i2, i3);
        updateIconPosition(getMeasuredWidth(), getMeasuredHeight());
    }

    /* JADX WARNING: type inference failed for: r1v0, types: [com.google.android.material.button.MaterialButton, android.view.View, androidx.appcompat.widget.AppCompatButton] */
    /* access modifiers changed from: protected */
    public void onAttachedToWindow() {
        MaterialButton.super.onAttachedToWindow();
        if (isUsingOriginalBackground()) {
    ...
    public void setElevation(float f) {
        MaterialButton.super.setElevation(f);
        if (isUsingOriginalBackground()) {
            this.materialButtonHelper.getMaterialShapeDrawable().setElevation(f);
        }
    }

    /* JADX WARNING: type inference failed for: r4v0, types: [com.google.android.material.button.MaterialButton, android.view.View] */
    ...
    /* JADX WARNING: type inference failed for: r3v0, types: [com.google.android.material.button.MaterialButton, android.view.View] */
    ...
    /* JADX WARNING: type inference failed for: r5v0, types: [com.google.android.material.button.MaterialButton, android.view.View] */
    ...
    /* JADX WARNING: type inference failed for: r2v0, types: [com.google.android.material.button.MaterialButton, android.view.View] */
    ...
    /* JADX WARNING: type inference failed for: r5v0, types: [android.widget.TextView, com.google.android.material.button.MaterialButton] */
    ...
    /* JADX WARNING: type inference failed for: r2v0, types: [android.widget.TextView, com.google.android.material.button.MaterialButton] */
    ...
    public int[] onCreateDrawableState(int i) {
        int[] onCreateDrawableState = MaterialButton.super.onCreateDrawableState(i + 2);
        if (isCheckable()) {
    ...
    public boolean performClick() {
        toggle();
        return MaterialButton.super.performClick();
    }
    ...
    public void setPressed(boolean z) {
        ...
        MaterialButton.super.setPressed(z);
    }
