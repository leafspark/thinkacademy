...
class TimePickerView extends ConstraintLayout implements TimePickerControls {
    ...
    /* JADX WARNING: type inference failed for: r0v0, types: [com.google.android.material.timepicker.TimePickerView, android.view.ViewGroup] */
    ...
    public void onVisibilityChanged(View view, int i) {
        TimePickerView.super.onVisibilityChanged(view, i);
        if (view == this && i == 0) {
    ...
    /* JADX WARNING: type inference failed for: r3v0, types: [androidx.constraintlayout.widget.ConstraintLayout, com.google.android.material.timepicker.TimePickerView, android.view.View] */
