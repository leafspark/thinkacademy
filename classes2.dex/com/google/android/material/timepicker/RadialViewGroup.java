...
class RadialViewGroup extends ConstraintLayout {
    ...
    /* JADX WARNING: type inference failed for: r2v0, types: [com.google.android.material.timepicker.RadialViewGroup, android.view.View, android.view.ViewGroup] */
    ...
    public void addView(View view, int i, ViewGroup.LayoutParams layoutParams) {
        RadialViewGroup.super.addView(view, i, layoutParams);
        if (view.getId() == -1) {
    ...
    public void onViewRemoved(View view) {
        RadialViewGroup.super.onViewRemoved(view);
        updateLayoutParamsAsync();
    }
    ...
    public void onFinishInflate() {
        RadialViewGroup.super.onFinishInflate();
        updateLayoutParams();
    }
