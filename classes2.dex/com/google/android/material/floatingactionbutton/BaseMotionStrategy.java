...
abstract class BaseMotionStrategy implements MotionStrategy {
    ...
    public AnimatorSet createAnimator(MotionSpec motionSpec2) {
        ...
        if (motionSpec2.hasPropertyValues(HummerStyleUtils.Hummer.OPACITY)) {
            arrayList.add(motionSpec2.getAnimator(HummerStyleUtils.Hummer.OPACITY, this.fab, View.ALPHA));
        }
