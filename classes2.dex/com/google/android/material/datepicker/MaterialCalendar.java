...
public final class MaterialCalendar<S> extends PickerFragment<S> {
    ...
    public View onCreateView(LayoutInflater layoutInflater, ViewGroup viewGroup, Bundle bundle) {
        ...
        ViewCompat.setAccessibilityDelegate(gridView, new AccessibilityDelegateCompat() {
            public void onInitializeAccessibilityNodeInfo(View view, AccessibilityNodeInfoCompat accessibilityNodeInfoCompat) {
                MaterialCalendar.super.onInitializeAccessibilityNodeInfo(view, accessibilityNodeInfoCompat);
        ...
        this.recyclerView = inflate.findViewById(R.id.mtrl_calendar_months);
        ...
        return new RecyclerView.ItemDecoration() {
            ...
            public void onDraw(Canvas canvas, RecyclerView recyclerView, RecyclerView.State state) {
                ...
                if ((recyclerView.getAdapter() instanceof YearGridAdapter) && (recyclerView.getLayoutManager() instanceof GridLayoutManager)) {
                    YearGridAdapter adapter = recyclerView.getAdapter();
                    ...
                    while (it.hasNext()) {
                        ...
                        if (!(pair.first == null || pair.second == null)) {
                            ...
                            int positionForYear = adapter.getPositionForYear(this.startItem.get(1));
                            int positionForYear2 = adapter.getPositionForYear(this.endItem.get(1));
    ...
    public void setCurrentMonth(Month month) {
        MonthsPagerAdapter adapter = this.recyclerView.getAdapter();
        int position = adapter.getPosition(month);
        int position2 = position - adapter.getPosition(this.current);
        boolean z = true;
    ...
    public void setSelector(CalendarSelector calendarSelector2) {
        ...
        if (calendarSelector2 == CalendarSelector.YEAR) {
            this.yearSelector.getLayoutManager().scrollToPosition(this.yearSelector.getAdapter().getPositionForYear(this.current.year));
    ...
    /* JADX WARNING: type inference failed for: r0v2, types: [com.google.android.material.button.MaterialButton, android.view.View] */
    private void addActionsToMonthNavigation(View view, final MonthsPagerAdapter monthsPagerAdapter) {
        final ? r0 = (MaterialButton) view.findViewById(R.id.month_navigation_fragment_toggle);
        r0.setTag(SELECTOR_TOGGLE_TAG);
        ViewCompat.setAccessibilityDelegate(r0, new AccessibilityDelegateCompat() {
            public void onInitializeAccessibilityNodeInfo(View view, AccessibilityNodeInfoCompat accessibilityNodeInfoCompat) {
                String str;
                MaterialCalendar.super.onInitializeAccessibilityNodeInfo(view, accessibilityNodeInfoCompat);
        ...
        MaterialButton materialButton = (MaterialButton) view.findViewById(R.id.month_navigation_previous);
        materialButton.setTag(NAVIGATION_PREV_TAG);
        MaterialButton materialButton2 = (MaterialButton) view.findViewById(R.id.month_navigation_next);
        ...
        this.recyclerView.addOnScrollListener(new RecyclerView.OnScrollListener() {
            public void onScrolled(RecyclerView recyclerView, int i, int i2) {
                ...
                r0.setText(monthsPagerAdapter.getPageTitle(i3));
            }
