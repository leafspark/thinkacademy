...
public class MaterialToolbar extends Toolbar {
    ...
    public void onLayout(boolean z, int i, int i2, int i3, int i4) {
        MaterialToolbar.super.onLayout(z, i, i2, i3, i4);
    ...
    /* JADX WARNING: type inference failed for: r0v0, types: [androidx.appcompat.widget.Toolbar, android.view.View, com.google.android.material.appbar.MaterialToolbar] */
    /* access modifiers changed from: protected */
    public void onAttachedToWindow() {
        MaterialToolbar.super.onAttachedToWindow();
        MaterialShapeUtils.setParentAbsoluteElevation(this);
    }

    /* JADX WARNING: type inference failed for: r0v0, types: [androidx.appcompat.widget.Toolbar, android.view.View, com.google.android.material.appbar.MaterialToolbar] */
    public void setElevation(float f) {
        MaterialToolbar.super.setElevation(f);
        MaterialShapeUtils.setElevation(this, f);
    }

    public void setNavigationIcon(Drawable drawable) {
        MaterialToolbar.super.setNavigationIcon(maybeTintNavigationIcon(drawable));
    }
    ...
    /* JADX WARNING: type inference failed for: r2v0, types: [android.view.View, com.google.android.material.appbar.MaterialToolbar] */
