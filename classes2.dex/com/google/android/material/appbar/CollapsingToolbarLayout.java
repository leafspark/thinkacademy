...
public class CollapsingToolbarLayout extends FrameLayout {
    ...
    public void onMeasure(int i, int i2) {
        ...
        if ((mode == 0 || this.forceApplySystemWindowInsetTop) && systemWindowInsetTop > 0) {
            ...
            super.onMeasure(i, View.MeasureSpec.makeMeasureSpec(getMeasuredHeight() + systemWindowInsetTop, PictureFileUtils.GB));
        }
        if (this.extraMultilineHeightEnabled && this.collapsingTextHelper.getMaxLines() > 1) {
            ...
            if (lineCount > 1) {
                ...
                super.onMeasure(i, View.MeasureSpec.makeMeasureSpec(getMeasuredHeight() + this.extraMultilineHeight, PictureFileUtils.GB));
            }
        }
        ...
        if (toolbar2 instanceof Toolbar) {
            ...
            if (Build.VERSION.SDK_INT >= 24) {
                ...
                if (viewGroup instanceof android.widget.Toolbar) {
                    android.widget.Toolbar toolbar4 = (android.widget.Toolbar) viewGroup;
                    i4 = toolbar4.getTitleMarginStart();
                    i2 = toolbar4.getTitleMarginEnd();
                    i = toolbar4.getTitleMarginTop();
                    i3 = toolbar4.getTitleMarginBottom();
                }
            }
            i3 = 0;
            i2 = 0;
