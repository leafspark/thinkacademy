...
public class AppBarLayout extends LinearLayout implements CoordinatorLayout.AttachedBehavior {
    ...
    protected static class BaseBehavior<T extends AppBarLayout> extends HeaderBehavior<T> {
        ...
        private boolean shouldJumpElevationState(CoordinatorLayout coordinatorLayout, T t) {
            ...
            int i = 0;
            while (i < size) {
                ScrollingViewBehavior behavior = ((View) dependents.get(i)).getLayoutParams().getBehavior();
                if (!(behavior instanceof ScrollingViewBehavior)) {
                    i++;
                } else if (behavior.getOverlayTop() != 0) {
                    return true;
                } else {
                    return false;
                }
        ...
        /* JADX WARNING: type inference failed for: r0v1, types: [android.os.Parcelable, com.google.android.material.appbar.AppBarLayout$BaseBehavior$SavedState] */
    ...
    public static class ScrollingViewBehavior extends HeaderScrollingViewBehavior {
        ...
        private void offsetChildAsNeeded(View view, View view2) {
            BaseBehavior behavior = view2.getLayoutParams().getBehavior();
            if (behavior instanceof BaseBehavior) {
                ViewCompat.offsetTopAndBottom(view, (((view2.getBottom() - view.getTop()) + behavior.offsetDelta) + getVerticalLayoutGap()) - getOverlapPixelsForOffset(view2));
            }
        }
        ...
        private static int getAppBarLayoutOffset(AppBarLayout appBarLayout) {
            BaseBehavior behavior = appBarLayout.getLayoutParams().getBehavior();
            if (behavior instanceof BaseBehavior) {
                return behavior.getTopBottomOffsetForScrollingSibling();
            }
            return 0;
        }
