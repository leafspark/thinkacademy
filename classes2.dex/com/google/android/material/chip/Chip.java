...
public class Chip extends AppCompatCheckBox implements ChipDrawable.Delegate, Shapeable {
    ...
    /* JADX WARNING: type inference failed for: r7v0, types: [com.google.android.material.chip.Chip, android.view.View] */
    ...
    /* JADX WARNING: type inference failed for: r1v0, types: [com.google.android.material.chip.Chip, android.view.View, androidx.appcompat.widget.AppCompatCheckBox] */
    /* access modifiers changed from: protected */
    public void onAttachedToWindow() {
        Chip.super.onAttachedToWindow();
        MaterialShapeUtils.setParentAbsoluteElevation(this, this.chipDrawable);
    }

    public void setElevation(float f) {
        Chip.super.setElevation(f);
    ...
    /* JADX WARNING: type inference failed for: r8v0, types: [com.google.android.material.chip.Chip, android.view.View, androidx.appcompat.widget.AppCompatCheckBox] */
    public void onInitializeAccessibilityNodeInfo(AccessibilityNodeInfo accessibilityNodeInfo) {
        Chip.super.onInitializeAccessibilityNodeInfo(accessibilityNodeInfo);
    ...
    /* JADX WARNING: type inference failed for: r1v0, types: [com.google.android.material.chip.Chip, android.view.View] */
    ...
    /* JADX WARNING: type inference failed for: r4v0, types: [com.google.android.material.chip.Chip, android.view.View] */
    ...
    public void onRtlPropertiesChanged(int i) {
        Chip.super.onRtlPropertiesChanged(i);
    ...
    public int[] onCreateDrawableState(int i) {
        int[] onCreateDrawableState = Chip.super.onCreateDrawableState(i + 2);
        if (isChecked()) {
    ...
    public void setBackground(Drawable drawable) {
        if (drawable == getBackgroundDrawable() || drawable == this.ripple) {
            Chip.super.setBackground(drawable);
        } else {
            Log.w(TAG, "Do not set the background; Chip manages its own background drawable.");
        }
    }
    ...
    public void setBackgroundDrawable(Drawable drawable) {
        if (drawable == getBackgroundDrawable() || drawable == this.ripple) {
            Chip.super.setBackgroundDrawable(drawable);
        } else {
    ...
    public void setCompoundDrawables(Drawable drawable, Drawable drawable2, Drawable drawable3, Drawable drawable4) {
        if (drawable != null) {
            ...
            Chip.super.setCompoundDrawables(drawable, drawable2, drawable3, drawable4);
        } else {
            throw new UnsupportedOperationException("Please set end drawable using R.attr#closeIcon.");
        }
    }
    ...
    public void setCompoundDrawablesWithIntrinsicBounds(int i, int i2, int i3, int i4) {
        if (i != 0) {
            ...
            Chip.super.setCompoundDrawablesWithIntrinsicBounds(i, i2, i3, i4);
        } else {
            throw new UnsupportedOperationException("Please set end drawable using R.attr#closeIcon.");
        }
    }
    ...
    public void setCompoundDrawablesWithIntrinsicBounds(Drawable drawable, Drawable drawable2, Drawable drawable3, Drawable drawable4) {
        if (drawable != null) {
            ...
            Chip.super.setCompoundDrawablesWithIntrinsicBounds(drawable, drawable2, drawable3, drawable4);
        } else {
    ...
    public void setCompoundDrawablesRelative(Drawable drawable, Drawable drawable2, Drawable drawable3, Drawable drawable4) {
        if (drawable != null) {
            ...
            Chip.super.setCompoundDrawablesRelative(drawable, drawable2, drawable3, drawable4);
        } else {
            throw new UnsupportedOperationException("Please set end drawable using R.attr#closeIcon.");
        }
    }
    ...
    public void setCompoundDrawablesRelativeWithIntrinsicBounds(int i, int i2, int i3, int i4) {
        if (i != 0) {
            ...
            Chip.super.setCompoundDrawablesRelativeWithIntrinsicBounds(i, i2, i3, i4);
        } else {
            throw new UnsupportedOperationException("Please set end drawable using R.attr#closeIcon.");
        }
    }
    ...
    public void setCompoundDrawablesRelativeWithIntrinsicBounds(Drawable drawable, Drawable drawable2, Drawable drawable3, Drawable drawable4) {
        if (drawable != null) {
            ...
            Chip.super.setCompoundDrawablesRelativeWithIntrinsicBounds(drawable, drawable2, drawable3, drawable4);
        } else {
            throw new UnsupportedOperationException("Please set end drawable using R.attr#closeIcon.");
        }
    }
    ...
    public void setEllipsize(TextUtils.TruncateAt truncateAt) {
        if (this.chipDrawable != null) {
            if (truncateAt != TextUtils.TruncateAt.MARQUEE) {
                Chip.super.setEllipsize(truncateAt);
                ChipDrawable chipDrawable2 = this.chipDrawable;
                if (chipDrawable2 != null) {
    ...
    /* JADX WARNING: type inference failed for: r1v0, types: [com.google.android.material.chip.Chip, android.widget.CompoundButton, androidx.appcompat.widget.AppCompatCheckBox] */
    ...
    /* JADX WARNING: type inference failed for: r3v0, types: [com.google.android.material.chip.Chip, android.view.View] */
    ...
    public boolean onTouchEvent(android.view.MotionEvent r6) {
        ...
        L_0x0041:
            ...
            boolean r6 = com.google.android.material.chip.Chip.super.onTouchEvent(r6)
    ...
    public boolean onHoverEvent(MotionEvent motionEvent) {
        ...
        return Chip.super.onHoverEvent(motionEvent);
    }
        ...
        if (motionEvent.getAction() == 10) {
            try {
                ...
                if (((Integer) declaredField.get(this.touchHelper)).intValue() != Integer.MIN_VALUE) {
                    ...
                    declaredMethod.invoke(this.touchHelper, new Object[]{Integer.valueOf(Target.SIZE_ORIGINAL)});
                    return true;
                }
    ...
    public boolean dispatchHoverEvent(MotionEvent motionEvent) {
        return handleAccessibilityExit(motionEvent) || this.touchHelper.dispatchHoverEvent(motionEvent) || Chip.super.dispatchHoverEvent(motionEvent);
    }

    public boolean dispatchKeyEvent(KeyEvent keyEvent) {
        if (!this.touchHelper.dispatchKeyEvent(keyEvent) || this.touchHelper.getKeyboardFocusedVirtualViewId() == Integer.MIN_VALUE) {
            return Chip.super.dispatchKeyEvent(keyEvent);
        }
        return true;
    }
    ...
    public void onFocusChanged(boolean z, int i, Rect rect2) {
        Chip.super.onFocusChanged(z, i, rect2);
    ...
    public void getFocusedRect(Rect rect2) {
        if (this.touchHelper.getKeyboardFocusedVirtualViewId() == 1 || this.touchHelper.getAccessibilityFocusedVirtualViewId() == 1) {
            ...
            Chip.super.getFocusedRect(rect2);
        }
    }
    ...
    public void drawableStateChanged() {
        Chip.super.drawableStateChanged();
        ChipDrawable chipDrawable2 = this.chipDrawable;
    ...
    private class ChipTouchHelper extends ExploreByTouchHelper {
        ...
        /* Code decompiled incorrectly, please refer to instructions dump. */
        ChipTouchHelper(com.google.android.material.chip.Chip r2) {
            /*
                r0 = this;
                com.google.android.material.chip.Chip.this = r1
                r0.<init>(r2)
                return
            */
            throw new UnsupportedOperationException("Method not decompiled: com.google.android.material.chip.Chip.ChipTouchHelper.<init>(com.google.android.material.chip.Chip, com.google.android.material.chip.Chip):void");
        }
    ...
    public void setLayoutDirection(int i) {
        if (this.chipDrawable != null && Build.VERSION.SDK_INT >= 17) {
            Chip.super.setLayoutDirection(i);
        }
    }
    ...
    public void setText(CharSequence charSequence, TextView.BufferType bufferType) {
        ...
        if (chipDrawable2 != null) {
            ...
            Chip.super.setText(chipDrawable2.shouldDrawText() ? null : charSequence, bufferType);
            ChipDrawable chipDrawable3 = this.chipDrawable;
    ...
    public void setTextAppearance(Context context, int i) {
        Chip.super.setTextAppearance(context, i);
        ChipDrawable chipDrawable2 = this.chipDrawable;
        if (chipDrawable2 != null) {
    ...
    public void setTextAppearance(int i) {
        Chip.super.setTextAppearance(i);
        ChipDrawable chipDrawable2 = this.chipDrawable;
        if (chipDrawable2 != null) {
            chipDrawable2.setTextAppearanceResource(i);
        }
