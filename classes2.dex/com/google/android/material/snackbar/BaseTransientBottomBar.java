        ...
        if (viewGroup == null) {
            ...
            ViewCompat.setAccessibilityDelegate(snackbarBaseLayout, new AccessibilityDelegateCompat() {
                public void onInitializeAccessibilityNodeInfo(View view, AccessibilityNodeInfoCompat accessibilityNodeInfoCompat) {
                    BaseTransientBottomBar.super.onInitializeAccessibilityNodeInfo(view, accessibilityNodeInfoCompat);
                ...
                public boolean performAccessibilityAction(View view, int i, Bundle bundle) {
                    if (i != 1048576) {
                        return BaseTransientBottomBar.super.performAccessibilityAction(view, i, bundle);
                    }
