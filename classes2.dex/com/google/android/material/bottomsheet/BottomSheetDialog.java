...
public class BottomSheetDialog extends AppCompatDialog {
    ...
    public void setContentView(int i) {
        BottomSheetDialog.super.setContentView(wrapInBottomSheet(i, (View) null, (ViewGroup.LayoutParams) null));
    }

    /* access modifiers changed from: protected */
    public void onCreate(Bundle bundle) {
        BottomSheetDialog.super.onCreate(bundle);
    ...
    public void setContentView(View view) {
        BottomSheetDialog.super.setContentView(wrapInBottomSheet(0, view, (ViewGroup.LayoutParams) null));
    }

    public void setContentView(View view, ViewGroup.LayoutParams layoutParams) {
        BottomSheetDialog.super.setContentView(wrapInBottomSheet(0, view, layoutParams));
    }

    public void setCancelable(boolean z) {
        BottomSheetDialog.super.setCancelable(z);
    ...
    /* access modifiers changed from: protected */
    public void onStart() {
        BottomSheetDialog.super.onStart();
        BottomSheetBehavior<FrameLayout> bottomSheetBehavior = this.behavior;
    ...
    public void onAttachedToWindow() {
        BottomSheetDialog.super.onAttachedToWindow();
        Window window = getWindow();
    ...
    public void setCanceledOnTouchOutside(boolean z) {
        BottomSheetDialog.super.setCanceledOnTouchOutside(z);
    ...
    private View wrapInBottomSheet(int i, View view, ViewGroup.LayoutParams layoutParams) {
        ...
        if (i != 0 && view == null) {
            view = getLayoutInflater().inflate(i, findViewById, false);
        }
        ...
        findViewById.findViewById(R.id.touch_outside).setOnClickListener(new View.OnClickListener() {
        ...
        ViewCompat.setAccessibilityDelegate(this.bottomSheet, new AccessibilityDelegateCompat() {
            public void onInitializeAccessibilityNodeInfo(View view, AccessibilityNodeInfoCompat accessibilityNodeInfoCompat) {
                BottomSheetDialog.super.onInitializeAccessibilityNodeInfo(view, accessibilityNodeInfoCompat);
                if (BottomSheetDialog.this.cancelable) {
                    accessibilityNodeInfoCompat.addAction(PictureFileUtils.MB);
            ...
            public boolean performAccessibilityAction(View view, int i, Bundle bundle) {
                if (i != 1048576 || !BottomSheetDialog.this.cancelable) {
                    return BottomSheetDialog.super.performAccessibilityAction(view, i, bundle);
                }
                BottomSheetDialog.this.cancel();
                return true;
            }
