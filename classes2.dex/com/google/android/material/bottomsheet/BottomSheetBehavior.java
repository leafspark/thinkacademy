...
public class BottomSheetBehavior<V extends View> extends CoordinatorLayout.Behavior<V> {
    ...
    public Parcelable onSaveInstanceState(CoordinatorLayout coordinatorLayout, V v) {
        return new SavedState(BottomSheetBehavior.super.onSaveInstanceState(coordinatorLayout, v), (BottomSheetBehavior<?>) this);
    }

    public void onRestoreInstanceState(CoordinatorLayout coordinatorLayout, V v, Parcelable parcelable) {
        SavedState savedState = (SavedState) parcelable;
        BottomSheetBehavior.super.onRestoreInstanceState(coordinatorLayout, v, savedState.getSuperState());
    ...
    public void onAttachedToLayoutParams(CoordinatorLayout.LayoutParams layoutParams) {
        BottomSheetBehavior.super.onAttachedToLayoutParams(layoutParams);
        this.viewRef = null;
        this.viewDragHelper = null;
    }

    public void onDetachedFromLayoutParams() {
        BottomSheetBehavior.super.onDetachedFromLayoutParams();
        this.viewRef = null;
        this.viewDragHelper = null;
    }
    ...
    public boolean onNestedPreFling(CoordinatorLayout coordinatorLayout, V v, View view, float f, float f2) {
        ...
        if (this.state != 3 || BottomSheetBehavior.super.onNestedPreFling(coordinatorLayout, v, view, f, f2)) {
            return true;
        }
        return false;
    }
    ...
    private float getYVelocity() {
        ...
        velocityTracker2.computeCurrentVelocity(ResultCode.KARAOKE_SUCCESS, this.maximumVelocity);
    ...
    public static <V extends View> BottomSheetBehavior<V> from(V v) {
        ...
        if (layoutParams instanceof CoordinatorLayout.LayoutParams) {
            BottomSheetBehavior<V> behavior = layoutParams.getBehavior();
    ...
    private void updateAccessibilityActions() {
        ...
        if (weakReference != null && (view = (View) weakReference.get()) != null) {
            ...
            ViewCompat.removeAccessibilityAction(view, PictureFileUtils.MB);
