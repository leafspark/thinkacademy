...
public class NavigationRailView extends NavigationBarView {
    ...
    public void onMeasure(int i, int i2) {
        ...
        if (isHeaderViewVisible()) {
            measureChild(getNavigationRailMenuView(), makeMinWidthSpec, View.MeasureSpec.makeMeasureSpec((getMeasuredHeight() - this.headerView.getMeasuredHeight()) - this.topMargin, Target.SIZE_ORIGINAL));
        }
    }
    ...
    private int makeMinWidthSpec(int i) {
        ...
        return View.MeasureSpec.makeMeasureSpec(Math.min(View.MeasureSpec.getSize(i), suggestedMinimumWidth + getPaddingLeft() + getPaddingRight()), PictureFileUtils.GB);
    }
