...
public class ShapeableImageView extends AppCompatImageView implements Shapeable {
    ...
    public void onDetachedFromWindow() {
        ...
        ShapeableImageView.super.onDetachedFromWindow();
    }

    /* access modifiers changed from: protected */
    public void onAttachedToWindow() {
        ShapeableImageView.super.onAttachedToWindow();
        setLayerType(2, (Paint) null);
    }

    /* access modifiers changed from: protected */
    public void onMeasure(int i, int i2) {
        ShapeableImageView.super.onMeasure(i, i2);
        if (!this.hasAdjustedPaddingAfterLayoutDirectionResolved) {
            if (Build.VERSION.SDK_INT <= 19 || isLayoutDirectionResolved()) {
                ...
                if (Build.VERSION.SDK_INT < 21 || (!isPaddingRelative() && !isContentPaddingRelative())) {
                    setPadding(ShapeableImageView.super.getPaddingLeft(), ShapeableImageView.super.getPaddingTop(), ShapeableImageView.super.getPaddingRight(), ShapeableImageView.super.getPaddingBottom());
                } else {
                    setPaddingRelative(ShapeableImageView.super.getPaddingStart(), ShapeableImageView.super.getPaddingTop(), ShapeableImageView.super.getPaddingEnd(), ShapeableImageView.super.getPaddingBottom());
                }
            }
        }
    }
    ...
    public void onDraw(Canvas canvas) {
        ShapeableImageView.super.onDraw(canvas);
    ...
    public void onSizeChanged(int i, int i2, int i3, int i4) {
        ShapeableImageView.super.onSizeChanged(i, i2, i3, i4);
    ...
    public void setContentPadding(int i, int i2, int i3, int i4) {
        ...
        ShapeableImageView.super.setPadding((ShapeableImageView.super.getPaddingLeft() - this.leftContentPadding) + i, (ShapeableImageView.super.getPaddingTop() - this.topContentPadding) + i2, (ShapeableImageView.super.getPaddingRight() - this.rightContentPadding) + i3, (ShapeableImageView.super.getPaddingBottom() - this.bottomContentPadding) + i4);
    ...
    public void setContentPaddingRelative(int i, int i2, int i3, int i4) {
        ShapeableImageView.super.setPaddingRelative((ShapeableImageView.super.getPaddingStart() - getContentPaddingStart()) + i, (ShapeableImageView.super.getPaddingTop() - this.topContentPadding) + i2, (ShapeableImageView.super.getPaddingEnd() - getContentPaddingEnd()) + i3, (ShapeableImageView.super.getPaddingBottom() - this.bottomContentPadding) + i4);
    ...
    public void setPadding(int i, int i2, int i3, int i4) {
        ShapeableImageView.super.setPadding(i + getContentPaddingLeft(), i2 + getContentPaddingTop(), i3 + getContentPaddingRight(), i4 + getContentPaddingBottom());
    }

    public void setPaddingRelative(int i, int i2, int i3, int i4) {
        ShapeableImageView.super.setPaddingRelative(i + getContentPaddingStart(), i2 + getContentPaddingTop(), i3 + getContentPaddingEnd(), i4 + getContentPaddingBottom());
    }

    public int getPaddingBottom() {
        return ShapeableImageView.super.getPaddingBottom() - getContentPaddingBottom();
    }

    public int getPaddingEnd() {
        return ShapeableImageView.super.getPaddingEnd() - getContentPaddingEnd();
    }

    public int getPaddingLeft() {
        return ShapeableImageView.super.getPaddingLeft() - getContentPaddingLeft();
    }

    public int getPaddingRight() {
        return ShapeableImageView.super.getPaddingRight() - getContentPaddingRight();
    }

    public int getPaddingStart() {
        return ShapeableImageView.super.getPaddingStart() - getContentPaddingStart();
    }

    public int getPaddingTop() {
        return ShapeableImageView.super.getPaddingTop() - getContentPaddingTop();
    }
