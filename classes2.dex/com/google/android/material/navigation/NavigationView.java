...
public class NavigationView extends ScrimInsetsFrameLayout {
    ...
    /* JADX WARNING: type inference failed for: r1v0, types: [android.os.Parcelable, com.google.android.material.navigation.NavigationView$SavedState] */
    /* access modifiers changed from: protected */
    ...
    public void onMeasure(int i, int i2) {
        ...
        if (mode == Integer.MIN_VALUE) {
            i = View.MeasureSpec.makeMeasureSpec(Math.min(View.MeasureSpec.getSize(i), this.maxWidth), PictureFileUtils.GB);
        } else if (mode == 0) {
            i = View.MeasureSpec.makeMeasureSpec(this.maxWidth, PictureFileUtils.GB);
        }
    ...
    /* JADX WARNING: type inference failed for: r1v1, types: [com.google.android.material.internal.NavigationMenu, android.view.Menu] */
    ...
    /* JADX WARNING: type inference failed for: r0v0, types: [com.google.android.material.internal.NavigationMenu, android.view.Menu] */
    public Menu getMenu() {
        return this.menu;
    }
    ...
    public static class SavedState extends AbsSavedState {
        ...
        public void writeToParcel(Parcel parcel, int i) {
            NavigationView.super.writeToParcel(parcel, i);
