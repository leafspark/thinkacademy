...
public class TextInputEditText extends AppCompatEditText {
    ...
    public void onAttachedToWindow() {
        TextInputEditText.super.onAttachedToWindow();
        TextInputLayout textInputLayout = getTextInputLayout();
        if (textInputLayout != null && textInputLayout.isProvidingHint() && TextInputEditText.super.getHint() == null && ManufacturerUtils.isMeizuDevice()) {
            setHint("");
        }
    }
    ...
    public CharSequence getHint() {
        ...
        if (textInputLayout == null || !textInputLayout.isProvidingHint()) {
            return TextInputEditText.super.getHint();
        }
        return textInputLayout.getHint();
    }

    public InputConnection onCreateInputConnection(EditorInfo editorInfo) {
        InputConnection onCreateInputConnection = TextInputEditText.super.onCreateInputConnection(editorInfo);
    ...
    public void getFocusedRect(Rect rect) {
        TextInputEditText.super.getFocusedRect(rect);
        TextInputLayout textInputLayout = getTextInputLayout();
    ...
    public boolean getGlobalVisibleRect(Rect rect, Point point) {
        boolean globalVisibleRect = TextInputEditText.super.getGlobalVisibleRect(rect, point);
        TextInputLayout textInputLayout = getTextInputLayout();
        if (!(textInputLayout == null || !this.textInputLayoutFocusedRectEnabled || rect == null)) {
    ...
    public boolean requestRectangleOnScreen(Rect rect) {
        boolean requestRectangleOnScreen = TextInputEditText.super.requestRectangleOnScreen(rect);
        TextInputLayout textInputLayout = getTextInputLayout();
    ...
    public void onInitializeAccessibilityNodeInfo(AccessibilityNodeInfo accessibilityNodeInfo) {
        TextInputEditText.super.onInitializeAccessibilityNodeInfo(accessibilityNodeInfo);
        TextInputLayout textInputLayout = getTextInputLayout();
