...
public class MaterialAutoCompleteTextView extends AppCompatAutoCompleteTextView {
    ...
    /* JADX WARNING: type inference failed for: r7v0, types: [com.google.android.material.textfield.MaterialAutoCompleteTextView, android.view.View] */
    ...
    public void showDropDown() {
        ...
        if (accessibilityManager2 == null || !accessibilityManager2.isTouchExplorationEnabled()) {
            MaterialAutoCompleteTextView.super.showDropDown();
        } else {
    ...
    public <T extends ListAdapter & Filterable> void setAdapter(T t) {
        MaterialAutoCompleteTextView.super.setAdapter(t);
        this.modalListPopup.setAdapter(getAdapter());
    }

    /* access modifiers changed from: protected */
    public void onAttachedToWindow() {
        MaterialAutoCompleteTextView.super.onAttachedToWindow();
        TextInputLayout findTextInputLayoutAncestor = findTextInputLayoutAncestor();
        if (findTextInputLayoutAncestor != null && findTextInputLayoutAncestor.isProvidingHint() && MaterialAutoCompleteTextView.super.getHint() == null && ManufacturerUtils.isMeizuDevice()) {
            setHint("");
        }
    }
    ...
    public CharSequence getHint() {
        ...
        if (findTextInputLayoutAncestor == null || !findTextInputLayoutAncestor.isProvidingHint()) {
            return MaterialAutoCompleteTextView.super.getHint();
        }
    ...
    public void onMeasure(int i, int i2) {
        MaterialAutoCompleteTextView.super.onMeasure(i, i2);
