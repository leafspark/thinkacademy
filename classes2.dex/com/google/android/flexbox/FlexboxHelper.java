...
class FlexboxHelper {
        ...
        while (true) {
            ...
            if (reorderedFlexItemAt == null) {
                if (isLastFlexItem(i6, flexItemCount, flexLine)) {
                    addFlexLine(arrayList, flexLine, i6, i24);
                }
                ...
                if (isMainAxisDirectionHorizontal) {
                    ...
                    i9 = size;
                    i8 = mode;
                    int childHeightMeasureSpec = this.mFlexContainer.getChildHeightMeasureSpec(i19, paddingStartCross + paddingEndCross + getFlexItemMarginStartCross(flexItem, true) + getFlexItemMarginEndCross(flexItem, true) + i24, getFlexItemSizeCross(flexItem, true));
                    ...
                    i9 = size;
                    i8 = mode;
                    int childWidthMeasureSpec2 = this.mFlexContainer.getChildWidthMeasureSpec(i19, paddingStartCross + paddingEndCross + getFlexItemMarginStartCross(flexItem, false) + getFlexItemMarginEndCross(flexItem, false) + i24, getFlexItemSizeCross(flexItem, false));
                ...
                int i32 = i31;
                int i33 = i14;
                if (isWrapRequired(reorderedFlexItemAt, i8, i9, flexLine.mMainSize, getFlexItemMarginEndMain(flexItem, isMainAxisDirectionHorizontal) + getViewMeasuredSizeMain(reorderedFlexItemAt, isMainAxisDirectionHorizontal) + getFlexItemMarginStartMain(flexItem, isMainAxisDirectionHorizontal), flexItem, i31, i26, arrayList.size())) {
                    if (flexLine2.getItemCountNotGone() > 0) {
                        FlexLine flexLine3 = flexLine2;
                        addFlexLine(list2, flexLine3, i32 > 0 ? i32 - 1 : 0, i28);
                        i24 = flexLine3.mCrossSize + i28;
                    } else {
                        i24 = i28;
                    }
                    if (!isMainAxisDirectionHorizontal) {
                        ...
                        if (flexItem.getWidth() == -1) {
                            ...
                            view.measure(flexContainer.getChildWidthMeasureSpec(i12, flexContainer.getPaddingLeft() + this.mFlexContainer.getPaddingRight() + flexItem.getMarginLeft() + flexItem.getMarginRight() + i24, flexItem.getWidth()), i34);
                        ...
                        i6 = i32;
                        view = view2;
                        view.measure(i33, flexContainer2.getChildHeightMeasureSpec(i12, flexContainer2.getPaddingTop() + this.mFlexContainer.getPaddingBottom() + flexItem.getMarginTop() + flexItem.getMarginBottom() + i24, flexItem.getHeight()));
                        checkSizeConstraints(view, i6);
                    } else {
                        i12 = i2;
                        view = view2;
                ...
                this.mFlexContainer.onNewFlexItemAdded(view, i6, i16, flexLine);
    ...
    private void expandFlexItems(int i, int i2, FlexLine flexLine, int i3, int i4, boolean z) {
        ...
        if (flexLine2.mTotalFlexGrow > 0.0f && i8 >= flexLine2.mMainSize) {
            ...
            if (!z) {
                flexLine2.mCrossSize = Target.SIZE_ORIGINAL;
            }
            int i10 = 0;
            float f3 = 0.0f;
            boolean z2 = false;
    ...
    private void stretchViewVertically(View view, int i, int i2) {
        ...
        int makeMeasureSpec = View.MeasureSpec.makeMeasureSpec(i3, PictureFileUtils.GB);
