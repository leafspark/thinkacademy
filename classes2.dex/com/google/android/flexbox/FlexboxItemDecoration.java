    ...
    public void getItemOffsets(Rect rect, View view, RecyclerView recyclerView, RecyclerView.State state) {
        ...
        if (childAdapterPosition != 0) {
            if (needsHorizontalDecoration() || needsVerticalDecoration()) {
                ...
                setOffsetAlongMainAxis(rect, childAdapterPosition, layoutManager, flexLines, layoutManager.getFlexDirection());
                setOffsetAlongCrossAxis(rect, childAdapterPosition, layoutManager, flexLines);
                return;
            }
            rect.set(0, 0, 0, 0);
        }
        ...
        if (needsHorizontalDecoration()) {
            ...
            for (int i8 = 0; i8 < childCount; i8++) {
                ...
                if (!layoutManager.isMainAxisDirectionHorizontal()) {
                    ...
                    i3 = Math.min(childAt.getRight() + layoutParams.rightMargin + this.mDrawable.getIntrinsicWidth(), right);
                    i4 = childAt.getLeft() - layoutParams.leftMargin;
                    this.mDrawable.setBounds(i4, i2, i3, i);
                    this.mDrawable.draw(canvas);
                } else {
                    i5 = Math.max((childAt.getLeft() - layoutParams.leftMargin) - this.mDrawable.getIntrinsicWidth(), left);
                    i7 = childAt.getRight();
                    i6 = layoutParams.rightMargin;
                }
                int i9 = i5;
