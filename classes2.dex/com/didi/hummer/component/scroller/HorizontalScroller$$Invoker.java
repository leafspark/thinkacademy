...
public class HorizontalScroller$$Invoker extends BaseInvoker<HorizontalScroller> {
    ...
    public HorizontalScroller createInstance(JSValue jSValue, Object[] objArr) {
        return new HorizontalScroller(this.mHummerContext, jSValue, (objArr.length <= 0 || objArr[0] == null) ? null : String.valueOf(objArr[0]));
    }
    ...
    public Object invoke(HorizontalScroller horizontalScroller, String str, Object[] objArr) {
        ...
        switch (c) {
            case 0:
                ...
                horizontalScroller.appendChild((HMBase) this.mInstanceManager.get(j));
                return null;
            case 1:
            ...
            case 3:
                ...
                return null;
            case 4:
                horizontalScroller.setOnScrollToBottomListener((objArr.length <= 0 || objArr[0] == null) ? null : objArr[0]);
                return null;
            case 5:
            ...
            case 7:
                horizontalScroller.scrollBy(objArr.length > 0 ? (!(objArr[0] instanceof String) || (!HMGsonUtil.isJsonObject(objArr[0]) && !HMGsonUtil.isJsonArray(objArr[0]))) ? objArr[0] : HMGsonUtil.fromJson(objArr[0], new TypeToken<Object>() {
                ...
                return null;
            case 8:
                horizontalScroller.scrollTo(objArr.length > 0 ? (!(objArr[0] instanceof String) || (!HMGsonUtil.isJsonObject(objArr[0]) && !HMGsonUtil.isJsonArray(objArr[0]))) ? objArr[0] : HMGsonUtil.fromJson(objArr[0], new TypeToken<Object>() {
                }.getType()) : null, objArr.length > 1 ? (!(objArr[1] instanceof String) || (!HMGsonUtil.isJsonObject(objArr[1]) && !HMGsonUtil.isJsonArray(objArr[1]))) ? objArr[1] : HMGsonUtil.fromJson(objArr[1], new TypeToken<Object>() {
                }.getType()) : null);
                return null;
            case 9:
                ...
                horizontalScroller.removeChild((HMBase) this.mInstanceManager.get(j));
                return null;
            case 10:
                horizontalScroller.setOnScrollToTopListener((objArr.length <= 0 || objArr[0] == null) ? null : objArr[0]);
                return null;
            case 11:
                ...
                horizontalScroller.insertBefore(hMBase, (HMBase) this.mInstanceManager.get(j));
                return null;
            case 12:
                ...
                horizontalScroller.replaceChild(hMBase2, (HMBase) this.mInstanceManager.get(j));
                return null;
            case 13:
                if (objArr.length > 0 && objArr[0] != null) {
                    z = objArr[0].booleanValue();
