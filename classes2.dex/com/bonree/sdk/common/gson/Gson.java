...
public final class Gson {
    ...
    public final <T> TypeAdapter<T> getAdapter(TypeToken<T> typeToken) {
        ...
        try {
            ...
            throw new IllegalArgumentException("GSON (v:11e) cannot handle " + typeToken);
        } finally {
    ...
    public final <T> T fromJson(JsonReader jsonReader, Type type) throws JsonIOException, JsonSyntaxException {
        ...
        try {
            ...
            AssertionError assertionError = new AssertionError("AssertionError (GSON v:11e): " + e4.getMessage());
