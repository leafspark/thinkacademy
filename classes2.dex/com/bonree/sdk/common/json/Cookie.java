...
public class Cookie {
    ...
    public static JSONObject toJSONObject(String str) throws JSONException {
        ...
        jSONObject.put(AppMeasurementSdk.ConditionalUserProperty.NAME, (Object) jSONTokener.nextTo('='));
        jSONTokener.next('=');
        ...
        while (jSONTokener.more()) {
            ...
            if (jSONTokener.next() == '=') {
                ...
                jSONTokener.next();
            } else if ("secure".equals(unescape)) {
                obj = Boolean.TRUE;
            } else {
        ...
        while (i2 < length) {
            ...
            if (charAt == '+') {
                ...
                if (dehexchar >= 0 && dehexchar2 >= 0) {
                    charAt = (char) ((dehexchar << 4) + dehexchar2);
                    i2 = i;
                }
            }
            stringBuffer.append(charAt);
