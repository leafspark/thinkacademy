...
class FilesKt__FileReadWriteKt extends FilesKt__FilePathComponentsKt {
    ...
    public static final byte[] readBytes(java.io.File r11) {
        /*
            ...
            int r2 = (int) r2
            byte[] r3 = new byte[r2]     // Catch:{ all -> 0x00af }
            r4 = 0
            r6 = r2
            r7 = r4
        L_0x0022:
            if (r6 <= 0) goto L_0x002d
            int r8 = r1.read(r3, r7, r6)     // Catch:{ all -> 0x00af }
        ...
        L_0x002d:
            ...
            byte[] r3 = java.util.Arrays.copyOf(r3, r7)     // Catch:{ all -> 0x00af }
            kotlin.jvm.internal.Intrinsics.checkNotNullExpressionValue(r3, r8)     // Catch:{ all -> 0x00af }
            goto L_0x006f
        L_0x003a:
            int r6 = r1.read()     // Catch:{ all -> 0x00af }
            r7 = -1
        ...
        L_0x0042:
            ...
            r7.write(r6)     // Catch:{ all -> 0x00af }
            java.io.InputStream r1 = (java.io.InputStream) r1     // Catch:{ all -> 0x00af }
            r6 = r7
            java.io.OutputStream r6 = (java.io.OutputStream) r6     // Catch:{ all -> 0x00af }
            r10 = 2
            kotlin.io.ByteStreamsKt.copyTo$default(r1, r6, r4, r10, r9)     // Catch:{ all -> 0x00af }
            int r1 = r7.size()     // Catch:{ all -> 0x00af }
            int r1 = r1 + r2
            if (r1 < 0) goto L_0x0073
            byte[] r11 = r7.getBuffer()     // Catch:{ all -> 0x00af }
            byte[] r1 = java.util.Arrays.copyOf(r3, r1)     // Catch:{ all -> 0x00af }
            kotlin.jvm.internal.Intrinsics.checkNotNullExpressionValue(r1, r8)     // Catch:{ all -> 0x00af }
            int r3 = r7.size()     // Catch:{ all -> 0x00af }
            byte[] r3 = kotlin.collections.ArraysKt.copyInto((byte[]) r11, (byte[]) r1, (int) r2, (int) r4, (int) r3)     // Catch:{ all -> 0x00af }
        L_0x006f:
