...
final class RecordedCalendarAdapter$convert$1$2 extends Lambda implements Function0<Unit> {
    final /* synthetic */ BaseViewHolder $holder;
    final /* synthetic */ RecordedSchedule $item;
    final /* synthetic */ RecordedCalendarAdapter this$0;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    RecordedCalendarAdapter$convert$1$2(RecordedCalendarAdapter recordedCalendarAdapter, RecordedSchedule recordedSchedule, BaseViewHolder baseViewHolder) {
        super(0);
    ...
    public final void invoke() {
        ...
        if (access$getListener$p != null) {
            access$getListener$p.invoke(RecordedClickType.RecordedCourseType, this.$item, Integer.valueOf(this.$holder.getLayoutPosition()));
        }
    }
}
