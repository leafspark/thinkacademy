...
final class CalendarAdapter$showLessonItem$1$4 extends Lambda implements Function0<Unit> {
    final /* synthetic */ CalendarItem $item;
    final /* synthetic */ CalendarAdapter this$0;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    CalendarAdapter$showLessonItem$1$4(CalendarAdapter calendarAdapter, CalendarItem calendarItem) {
        super(0);
    ...
    public final void invoke() {
        ...
        if (access$getListener$p != null) {
            access$getListener$p.invoke(ClickType.Common, this.$item);
        }
    }
}
