...
public final class RecordedExamNoteActivity$startObserve$$inlined$observe$1<T> implements Observer<T> {
    final /* synthetic */ RecordedExamNoteActivity this$0;

    public RecordedExamNoteActivity$startObserve$$inlined$observe$1(RecordedExamNoteActivity recordedExamNoteActivity) {
        this.this$0 = recordedExamNoteActivity;
    }

    public final void onChanged(T t) {
        StateData stateData = (StateData) t;
        if (RecordedExamNoteActivity.WhenMappings.$EnumSwitchMapping$0[stateData.getStatus().ordinal()] == 1) {
            this.this$0.getBinding().loadStatusView.restoreView();
            this.this$0.updateValues((RecordedPaperDetailEntity) stateData.getData());
            return;
        }
        ...
        LoadStatusView.showErrorView$default(loadStatusView, 0, msg, (String) null, (String) null, new RecordedExamNoteActivity$startObserve$1$1(this.this$0), 13, (Object) null);
