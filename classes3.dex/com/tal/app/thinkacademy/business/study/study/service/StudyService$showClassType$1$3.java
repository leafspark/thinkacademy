...
final class StudyService$showClassType$1$3 extends Lambda implements Function2<OutsideOfClassType, TheOutsideEntity, Unit> {
    final /* synthetic */ Activity $currentActivity;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    StudyService$showClassType$1$3(Activity activity) {
        super(2);
