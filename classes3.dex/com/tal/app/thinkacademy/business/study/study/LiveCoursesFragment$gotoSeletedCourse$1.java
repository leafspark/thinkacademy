...
final class LiveCoursesFragment$gotoSeletedCourse$1 extends Lambda implements Function0<Unit> {
    final /* synthetic */ LiveCoursesFragment this$0;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    LiveCoursesFragment$gotoSeletedCourse$1(LiveCoursesFragment liveCoursesFragment) {
        super(0);
    ...
    public final void invoke() {
        if (!PadUtils.isPad(this.this$0.getContext())) {
            ...
            StudyTrack.INSTANCE.hw_buy_class_click(ShowTab.Live.getAliasName());
        }
    }
}
