...
public final class StudyPageFragment$onViewCreated$$inlined$observe$3<T> implements Observer<T> {
    final /* synthetic */ StudyPageFragment this$0;

    public StudyPageFragment$onViewCreated$$inlined$observe$3(StudyPageFragment studyPageFragment) {
        this.this$0 = studyPageFragment;
    }

    public final void onChanged(T t) {
        String str = (String) t;
        this.this$0.mSchoolCode = "";
