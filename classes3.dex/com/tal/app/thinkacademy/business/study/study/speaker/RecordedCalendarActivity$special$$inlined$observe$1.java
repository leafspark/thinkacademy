...
public final class RecordedCalendarActivity$special$$inlined$observe$1<T> implements Observer<T> {
    final /* synthetic */ RecordedCalendarActivity this$0;

    public RecordedCalendarActivity$special$$inlined$observe$1(RecordedCalendarActivity recordedCalendarActivity) {
        this.this$0 = recordedCalendarActivity;
    }

    public final void onChanged(T t) {
        SycHomeWork sycHomeWork = (SycHomeWork) t;
