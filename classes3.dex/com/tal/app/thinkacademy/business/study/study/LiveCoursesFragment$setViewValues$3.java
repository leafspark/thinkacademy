...
final class LiveCoursesFragment$setViewValues$3 extends Lambda implements Function0<Unit> {
    ...
    LiveCoursesFragment$setViewValues$3(LiveCoursesFragment liveCoursesFragment) {
        super(0);
    ...
    public final void invoke() {
        ...
        int i = 1;
        XesLog.i(Tag.LiveCoursesFragment, new Object[]{Intrinsics.stringPlus("直播切换数据点击：", GsonUtil.getInstance().objToJson(this.this$0.mSwitchOptions))});
        ...
        studyTrack.hw_user_switcher_tips_click(aliasName, i, "无班级", ShowTab.Live.getAliasName());
        ISwitchAccount access$getSwitchListener$p = this.this$0.switchListener;
        if (access$getSwitchListener$p != null) {
            ISwitchAccount.DefaultImpls.showSwitchDialog$default(access$getSwitchListener$p, this.this$0.mSwitchOptions, this.this$0.mSwitchType, ShowTab.Live, this.this$0.mHaveCourse, false, 16, (Object) null);
        }
    }
}
