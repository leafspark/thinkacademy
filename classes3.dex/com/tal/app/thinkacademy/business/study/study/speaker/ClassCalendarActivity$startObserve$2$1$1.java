...
final class ClassCalendarActivity$startObserve$2$1$1 extends Lambda implements Function2<OutsideOfClassType, TheOutsideEntity, Unit> {
    final /* synthetic */ ClassCalendarActivity this$0;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    ClassCalendarActivity$startObserve$2$1$1(ClassCalendarActivity classCalendarActivity) {
        super(2);
    ...
    public final void invoke(OutsideOfClassType outsideOfClassType, TheOutsideEntity theOutsideEntity) {
        ...
        classCalendarActivity.callPhone(phone);
    }
