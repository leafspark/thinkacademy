...
public final class RecordedCalendarActivity$special$$inlined$observe$2<T> implements Observer<T> {
    final /* synthetic */ RecordedCalendarActivity this$0;

    public RecordedCalendarActivity$special$$inlined$observe$2(RecordedCalendarActivity recordedCalendarActivity) {
        this.this$0 = recordedCalendarActivity;
    }

    public final void onChanged(T t) {
        String str = (String) t;
        this.this$0.requestNewListData();
    }
}
