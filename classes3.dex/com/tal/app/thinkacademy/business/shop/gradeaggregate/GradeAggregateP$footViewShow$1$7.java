...
final class GradeAggregateP$footViewShow$1$7 extends Lambda implements Function0<Unit> {
    final /* synthetic */ TextView $timePrompt;
    final /* synthetic */ GradeAggregateP this$0;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    GradeAggregateP$footViewShow$1$7(TextView textView, GradeAggregateP gradeAggregateP) {
        super(0);
        this.$timePrompt = textView;
        this.this$0 = gradeAggregateP;
    }

    public final void invoke() {
        this.$timePrompt.setVisibility(8);
