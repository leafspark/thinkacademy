...
final class GradeAggregateLeaveInfoItemSelect$showDialog$dialog$1 extends Lambda implements Function2<Integer, String, Unit> {
    final /* synthetic */ BaseViewHolder $helper;
    final /* synthetic */ UserLeaveComponentData $item;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    GradeAggregateLeaveInfoItemSelect$showDialog$dialog$1(UserLeaveComponentData userLeaveComponentData, BaseViewHolder baseViewHolder) {
        super(2);
