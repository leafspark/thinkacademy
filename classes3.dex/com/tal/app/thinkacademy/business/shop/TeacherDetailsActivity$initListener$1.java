...
final class TeacherDetailsActivity$initListener$1 extends Lambda implements Function0<Unit> {
    final /* synthetic */ TeacherDetailsActivity this$0;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    TeacherDetailsActivity$initListener$1(TeacherDetailsActivity teacherDetailsActivity) {
        super(0);
        this.this$0 = teacherDetailsActivity;
    }

    public final void invoke() {
        this.this$0.setSeleted(true);
        ...
        if (access$getMLinearLayoutManager$p != null) {
            access$getMLinearLayoutManager$p.scrollToPositionWithOffset(0, 0);
        }
    }
}
