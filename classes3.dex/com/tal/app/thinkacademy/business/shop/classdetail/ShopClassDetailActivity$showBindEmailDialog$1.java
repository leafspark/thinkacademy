...
final class ShopClassDetailActivity$showBindEmailDialog$1 extends Lambda implements Function1<PhoneEmailBindState, Unit> {
    ...
    ShopClassDetailActivity$showBindEmailDialog$1(ShopClassDetailActivity shopClassDetailActivity) {
        super(1);
    ...
    public final void invoke(PhoneEmailBindState phoneEmailBindState) {
        ...
        if (WhenMappings.$EnumSwitchMapping$0[phoneEmailBindState.ordinal()] == 1) {
            this.this$0.showLinkEmailDialog();
