...
public final class MainActivity$registerFlutterEvent$$inlined$observe$1<T> implements Observer<T> {
    public final void onChanged(T t) {
        String str = (String) t;
        HwFlutterUtil.INSTANCE.sendEventToFlutterLogin(EventToFlutter.LOGIN_SUCCESS);
    }
}
