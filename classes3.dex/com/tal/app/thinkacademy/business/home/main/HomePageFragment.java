...
public final class HomePageFragment extends BaseBindFragment<LayoutHomeFragmentBinding> {
    ...
    public void onViewCreated(View view, Bundle bundle) {
        ...
        HomePageFragment.super.onViewCreated(view, bundle);
        ...
        with.observe(lifecycleOwner, new HomePageFragment$$ExternalSyntheticLambda0(this));
    }

    /* access modifiers changed from: private */
    /* renamed from: onViewCreated$lambda-0  reason: not valid java name */
    public static final void m17onViewCreated$lambda0(HomePageFragment homePageFragment, Object obj) {
        Intrinsics.checkNotNullParameter(homePageFragment, "this$0");
        WebAgent webAgent = homePageFragment.mWebAgent;
        Intrinsics.checkNotNull(webAgent);
        webAgent.loadUrl(homePageFragment.getLinkUrl());
    }

    private final String getLinkUrl() {
        String str = UrlUtils.INSTANCE.getTouchHost() + "/app";
        Intrinsics.checkNotNullExpressionValue(str, "url.toString()");
        return str;
    }

    public void onDestroy() {
        HomePageFragment.super.onDestroy();
        WebAgent webAgent = this.mWebAgent;
        if (webAgent != null) {
            webAgent.onDestroy();
        }
