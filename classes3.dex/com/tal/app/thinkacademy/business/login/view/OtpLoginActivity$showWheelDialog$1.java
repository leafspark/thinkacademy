...
final class OtpLoginActivity$showWheelDialog$1 extends Lambda implements Function1<Integer, Unit> {
    final /* synthetic */ List<ConfigInfo.Country> $list;
    final /* synthetic */ OtpLoginActivity this$0;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    OtpLoginActivity$showWheelDialog$1(OtpLoginActivity otpLoginActivity, List<ConfigInfo.Country> list) {
        super(1);
    ...
    public final void invoke(int i) {
        ...
        ConfigInfo.Country country = list.get(this.this$0.mChosenCountryIndex);
