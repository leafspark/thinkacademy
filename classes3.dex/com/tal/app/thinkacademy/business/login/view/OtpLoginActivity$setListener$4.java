...
final class OtpLoginActivity$setListener$4 extends Lambda implements Function0<Unit> {
    final /* synthetic */ OtpLoginActivity this$0;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    OtpLoginActivity$setListener$4(OtpLoginActivity otpLoginActivity) {
        super(0);
    ...
    public final void invoke() {
        ...
        this.this$0.getBinding().etSmsCode.clearFocus();
