...
final class AccountVerificationActivity$setListener$2 extends Lambda implements Function0<Unit> {
    final /* synthetic */ AccountVerificationActivity this$0;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    AccountVerificationActivity$setListener$2(AccountVerificationActivity accountVerificationActivity) {
        super(0);
    ...
    public final void invoke() {
        ...
        this.this$0.getBinding().etVerificationCode.clearFocus();
